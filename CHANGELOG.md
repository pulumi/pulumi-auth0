...
*As of this notice, using CHANGELOG.md is DEPRECATED. We will be using [GitHub Releases](https://github.com/pulumi/pulumi-auth0/releases) for this repository*
...
## 2.4.0 (2021-12-31)
* Upgrade terraform-provider-auth0 to v0.25.0

## 2.3.2 (2021-12-10)
* Upgrade to v0.24.3 of the Auth0 Terraform Provider
