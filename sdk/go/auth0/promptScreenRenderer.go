...
type PromptScreenRenderer struct {
	...
	Filters PromptScreenRendererFiltersPtrOutput `pulumi:"filters"`
	...
	UsePageTemplate pulumi.BoolPtrOutput `pulumi:"usePageTemplate"`
}
...
type promptScreenRendererState struct {
	...
	// Optional filters to apply rendering rules to specific entities. `matchType` and at least one of the entity arrays are required.
	Filters *PromptScreenRendererFilters `pulumi:"filters"`
	// An array of head tags
...
type PromptScreenRendererState struct {
	...
	// Optional filters to apply rendering rules to specific entities. `matchType` and at least one of the entity arrays are required.
	Filters PromptScreenRendererFiltersPtrInput
	// An array of head tags
	...
	// Use page template with ACUL
	UsePageTemplate pulumi.BoolPtrInput
}
...
// Optional filters to apply rendering rules to specific entities. `matchType` and at least one of the entity arrays are required.
func (o PromptScreenRendererOutput) Filters() PromptScreenRendererFiltersPtrOutput {
	return o.ApplyT(func(v *PromptScreenRenderer) PromptScreenRendererFiltersPtrOutput { return v.Filters }).(PromptScreenRendererFiltersPtrOutput)
}
...
// Use page template with ACUL
func (o PromptScreenRendererOutput) UsePageTemplate() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *PromptScreenRenderer) pulumi.BoolPtrOutput { return v.UsePageTemplate }).(pulumi.BoolPtrOutput)
}
