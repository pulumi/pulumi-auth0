...
//			_, err := auth0.GetResourceServer(ctx, &auth0.LookupResourceServerArgs{
...
type LookupResourceServerResult struct {
	...
	AuthorizationPolicies []GetResourceServerAuthorizationPolicy `pulumi:"authorizationPolicies"`
...
func LookupResourceServerOutput(ctx *pulumi.Context, args LookupResourceServerOutputArgs, opts ...pulumi.InvokeOption) LookupResourceServerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupResourceServerResultOutput, error) {
			...
			return ctx.InvokeOutput("auth0:index/getResourceServer:getResourceServer", args, LookupResourceServerResultOutput{}, options).(LookupResourceServerResultOutput), nil
...
// Indicates whether Online Refresh Tokens can be issued for this resource server. (EA Only)
func (o LookupResourceServerResultOutput) AllowOnlineAccess() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupResourceServerResult) bool { return v.AllowOnlineAccess }).(pulumi.BoolOutput)
}

// Indicates whether Online Refresh Tokens can be issued even when sessions are configured as ephemeral. (EA Only)
func (o LookupResourceServerResultOutput) AllowOnlineAccessWithEphemeralSessions() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupResourceServerResult) bool { return v.AllowOnlineAccessWithEphemeralSessions }).(pulumi.BoolOutput)
}
...
// Authorization policy for the resource server.(EA Only)
func (o LookupResourceServerResultOutput) AuthorizationPolicies() GetResourceServerAuthorizationPolicyArrayOutput {
	return o.ApplyT(func(v LookupResourceServerResult) []GetResourceServerAuthorizationPolicy {
		return v.AuthorizationPolicies
	}).(GetResourceServerAuthorizationPolicyArrayOutput)
}
