...
public class TriggerAction extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return The ID of the trigger to bind with. Available options: `post-login`, `credentials-exchange`, `pre-user-registration`, `post-user-registration`, `post-change-password`, `send-phone-message`, `password-reset-post-challenge`, `custom-email-provider`, `custom-phone-provider`, `login-post-identifier` and `signup-post-identifier`.
     * 
     */
     ...
     */
    public TriggerAction(java.lang.String name) {
     ...
     */
    public TriggerAction(java.lang.String name, TriggerActionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TriggerAction(java.lang.String name, TriggerActionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("auth0:index/triggerAction:TriggerAction", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TriggerAction(java.lang.String name, Output<java.lang.String> id, @Nullable TriggerActionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("auth0:index/triggerAction:TriggerAction", name, state, makeResourceOptions(options, id), false);
    }

    private static TriggerActionArgs makeArgs(TriggerActionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TriggerActionArgs.Empty : args;
    }
     ...
     */
    public static TriggerAction get(java.lang.String name, Output<java.lang.String> id, @Nullable TriggerActionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
