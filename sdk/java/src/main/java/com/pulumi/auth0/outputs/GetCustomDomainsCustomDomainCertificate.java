...
@CustomType
public final class GetCustomDomainsCustomDomainCertificate {
    /**
    ...
    private GetCustomDomainsCustomDomainCertificate() {}
    /**
     * @return Name of the certificate authority that issued the certificate.
     * 
     */
    ...
    public static Builder builder(GetCustomDomainsCustomDomainCertificate defaults) {
    ...
    public static final class Builder {
        ...
        private String status;
        public Builder() {}
        public Builder(GetCustomDomainsCustomDomainCertificate defaults) {
        ...
        public Builder certificateAuthority(String certificateAuthority) {
            if (certificateAuthority == null) {
              throw new MissingRequiredPropertyException("GetCustomDomainsCustomDomainCertificate", "certificateAuthority");
            }
        ...
        public Builder errorMsg(String errorMsg) {
            if (errorMsg == null) {
              throw new MissingRequiredPropertyException("GetCustomDomainsCustomDomainCertificate", "errorMsg");
            }
        ...
        public Builder renewsBefore(String renewsBefore) {
            if (renewsBefore == null) {
              throw new MissingRequiredPropertyException("GetCustomDomainsCustomDomainCertificate", "renewsBefore");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetCustomDomainsCustomDomainCertificate", "status");
            }
            this.status = status;
            return this;
        }
        public GetCustomDomainsCustomDomainCertificate build() {
            final var _resultValue = new GetCustomDomainsCustomDomainCertificate();
