...
public final class EmailSettingsHeadersArgs extends com.pulumi.resources.ResourceArgs {

    public static final EmailSettingsHeadersArgs Empty = new EmailSettingsHeadersArgs();
    ...
    private EmailSettingsHeadersArgs() {}

    private EmailSettingsHeadersArgs(EmailSettingsHeadersArgs $) {
    ...
    public static Builder builder(EmailSettingsHeadersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EmailSettingsHeadersArgs();
        }

        public Builder(EmailSettingsHeadersArgs defaults) {
            $ = new EmailSettingsHeadersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EmailSettingsHeadersArgs build() {
            return $;
        }
    }
