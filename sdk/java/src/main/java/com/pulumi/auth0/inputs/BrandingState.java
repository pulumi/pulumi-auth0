...
public final class BrandingState extends com.pulumi.resources.ResourceArgs {

    public static final BrandingState Empty = new BrandingState();
    ...
    private BrandingState() {}

    private BrandingState(BrandingState $) {
        this.colors = $.colors;
    ...
    public static Builder builder(BrandingState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BrandingState defaults) {
            $ = new BrandingState(Objects.requireNonNull(defaults));
        }
