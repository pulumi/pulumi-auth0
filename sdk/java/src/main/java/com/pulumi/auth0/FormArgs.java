...
public final class FormArgs extends com.pulumi.resources.ResourceArgs {

    public static final FormArgs Empty = new FormArgs();
    ...
    public static Builder builder(FormArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FormArgs defaults) {
            $ = new FormArgs(Objects.requireNonNull(defaults));
        }
