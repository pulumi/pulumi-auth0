...
public final class CustomDomainVerificationState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param cnameApiKey The value of the `cname-api-key` header to send when forwarding requests. Only present if the type of the custom domain is `selfManagedCerts` and Terraform originally managed the domain&#39;s verification.
         * 
         * @return builder
         * 
         */
