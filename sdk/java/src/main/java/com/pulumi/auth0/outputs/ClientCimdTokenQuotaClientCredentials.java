...
@CustomType
public final class ClientCimdTokenQuotaClientCredentials {
    /**
    ...
    private ClientCimdTokenQuotaClientCredentials() {}
    /**
     * @return If enabled, the quota will be enforced and requests in excess of the quota will fail. If disabled, the quota will not be enforced, but notifications for requests exceeding the quota will be available in logs.
     * 
     */
    ...
    public static Builder builder(ClientCimdTokenQuotaClientCredentials defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer perHour;
        public Builder() {}
        public Builder(ClientCimdTokenQuotaClientCredentials defaults) {
        ...
        public ClientCimdTokenQuotaClientCredentials build() {
            final var _resultValue = new ClientCimdTokenQuotaClientCredentials();
