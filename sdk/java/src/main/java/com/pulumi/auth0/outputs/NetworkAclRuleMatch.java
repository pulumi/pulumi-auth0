...
@CustomType
public final class NetworkAclRuleMatch {
    /**
    ...
    public static Builder builder(NetworkAclRuleMatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> userAgents;
        public Builder() {}
        public Builder(NetworkAclRuleMatch defaults) {
        ...
        public NetworkAclRuleMatch build() {
            final var _resultValue = new NetworkAclRuleMatch();
