...
public final class PromptScreenPartialInsertionPointsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(PromptScreenPartialInsertionPointsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PromptScreenPartialInsertionPointsArgs();
        }
        ...
        public PromptScreenPartialInsertionPointsArgs build() {
            return $;
        }
    }
