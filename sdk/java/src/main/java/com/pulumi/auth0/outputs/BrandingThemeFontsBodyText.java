...
@CustomType
public final class BrandingThemeFontsBodyText {
    /**
    ...
    private BrandingThemeFontsBodyText() {}
    /**
     * @return Body text bold. Defaults to `false`.
     * 
     */
    ...
    public static Builder builder(BrandingThemeFontsBodyText defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double size;
        public Builder() {}
        public Builder(BrandingThemeFontsBodyText defaults) {
        ...
        public BrandingThemeFontsBodyText build() {
            final var _resultValue = new BrandingThemeFontsBodyText();
