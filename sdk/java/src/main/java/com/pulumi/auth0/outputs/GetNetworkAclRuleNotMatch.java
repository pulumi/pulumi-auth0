    ...
    public static final class Builder {
        ...
        public Builder connectingIpv4Cidrs(List<String> connectingIpv4Cidrs) {
            if (connectingIpv4Cidrs == null) {
              throw new MissingRequiredPropertyException("GetNetworkAclRuleNotMatch", "connectingIpv4Cidrs");
            }
        ...
        public Builder connectingIpv6Cidrs(List<String> connectingIpv6Cidrs) {
            if (connectingIpv6Cidrs == null) {
              throw new MissingRequiredPropertyException("GetNetworkAclRuleNotMatch", "connectingIpv6Cidrs");
            }
        ...
        public Builder hostnames(List<String> hostnames) {
            if (hostnames == null) {
              throw new MissingRequiredPropertyException("GetNetworkAclRuleNotMatch", "hostnames");
            }
