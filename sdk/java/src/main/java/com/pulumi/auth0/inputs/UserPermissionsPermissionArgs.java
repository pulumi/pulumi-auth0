...
public final class UserPermissionsPermissionArgs extends com.pulumi.resources.ResourceArgs {

    public static final UserPermissionsPermissionArgs Empty = new UserPermissionsPermissionArgs();
    ...
    private UserPermissionsPermissionArgs() {}

    private UserPermissionsPermissionArgs(UserPermissionsPermissionArgs $) {
    ...
    public static Builder builder(UserPermissionsPermissionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserPermissionsPermissionArgs();
        }

        public Builder(UserPermissionsPermissionArgs defaults) {
            $ = new UserPermissionsPermissionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public UserPermissionsPermissionArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("UserPermissionsPermissionArgs", "name");
            }
            if ($.resourceServerIdentifier == null) {
                throw new MissingRequiredPropertyException("UserPermissionsPermissionArgs", "resourceServerIdentifier");
            }
            return $;
        }
    }
