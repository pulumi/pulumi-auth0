...
public final class ClientRefreshTokenPolicy {
    ...
    public static Builder builder(ClientRefreshTokenPolicy defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> scopes;
        public Builder() {}
        public Builder(ClientRefreshTokenPolicy defaults) {
        ...
        public Builder audience(String audience) {
            if (audience == null) {
              throw new MissingRequiredPropertyException("ClientRefreshTokenPolicy", "audience");
            }
        ...
        public Builder scopes(List<String> scopes) {
            if (scopes == null) {
              throw new MissingRequiredPropertyException("ClientRefreshTokenPolicy", "scopes");
            }
            this.scopes = scopes;
            return this;
        }
        ...
        public ClientRefreshTokenPolicy build() {
            final var _resultValue = new ClientRefreshTokenPolicy();
