...
public final class ClientAddonsSalesforceSandboxApi {
    ...
    public static Builder builder(ClientAddonsSalesforceSandboxApi defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String principal;
        public Builder() {}
        public Builder(ClientAddonsSalesforceSandboxApi defaults) {
        ...
        public ClientAddonsSalesforceSandboxApi build() {
            final var _resultValue = new ClientAddonsSalesforceSandboxApi();
