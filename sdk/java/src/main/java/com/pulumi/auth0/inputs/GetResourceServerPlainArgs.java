...
public final class GetResourceServerPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param identifier Unique identifier for the resource server. Used as the audience parameter for authorization calls. If not provided, `resourceServerId` must be set.
         * 
         * @return builder
         * 
         */
