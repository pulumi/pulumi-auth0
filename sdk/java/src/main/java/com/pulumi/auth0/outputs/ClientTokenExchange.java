...
public final class ClientTokenExchange {
    ...
    public static Builder builder(ClientTokenExchange defaults) {
    ...
    public static final class Builder {
        private List<String> allowAnyProfileOfTypes;
        public Builder() {}
        public Builder(ClientTokenExchange defaults) {
        ...
        public Builder allowAnyProfileOfTypes(List<String> allowAnyProfileOfTypes) {
            if (allowAnyProfileOfTypes == null) {
              throw new MissingRequiredPropertyException("ClientTokenExchange", "allowAnyProfileOfTypes");
            }
        ...
        public ClientTokenExchange build() {
            final var _resultValue = new ClientTokenExchange();
