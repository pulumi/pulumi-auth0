...
public final class ConnectionOptionsSigningKey {
    ...
    public static final class Builder {
        ...
        public Builder cert(String cert) {
            if (cert == null) {
              throw new MissingRequiredPropertyException("ConnectionOptionsSigningKey", "cert");
            }
            this.cert = cert;
            return this;
        }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("ConnectionOptionsSigningKey", "key");
            }
            this.key = key;
            return this;
        }
        public ConnectionOptionsSigningKey build() {
            final var _resultValue = new ConnectionOptionsSigningKey();
