...
public final class PromptState extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(PromptState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PromptState defaults) {
            $ = new PromptState(Objects.requireNonNull(defaults));
        }
