...
import com.pulumi.auth0.outputs.UserAttributeProfileUserAttributeStrategyOverrideOidcMapping;
...
@CustomType
public final class UserAttributeProfileUserAttributeStrategyOverride {
    /**
     * @return OIDC mapping override for this strategy.
     * 
     */
    private @Nullable UserAttributeProfileUserAttributeStrategyOverrideOidcMapping oidcMapping;
    /**
    ...
    private UserAttributeProfileUserAttributeStrategyOverride() {}
    /**
     * @return OIDC mapping override for this strategy.
     * 
     */
    public Optional<UserAttributeProfileUserAttributeStrategyOverrideOidcMapping> oidcMapping() {
    ...
    public static Builder builder(UserAttributeProfileUserAttributeStrategyOverride defaults) {
    ...
    public static final class Builder {
        ...
        private String strategy;
        public Builder() {}
        public Builder(UserAttributeProfileUserAttributeStrategyOverride defaults) {
        ...
        @CustomType.Setter
        public Builder oidcMapping(@Nullable UserAttributeProfileUserAttributeStrategyOverrideOidcMapping oidcMapping) {
        ...
        public Builder strategy(String strategy) {
            if (strategy == null) {
              throw new MissingRequiredPropertyException("UserAttributeProfileUserAttributeStrategyOverride", "strategy");
            }
            this.strategy = strategy;
            return this;
        }
        public UserAttributeProfileUserAttributeStrategyOverride build() {
            final var _resultValue = new UserAttributeProfileUserAttributeStrategyOverride();
