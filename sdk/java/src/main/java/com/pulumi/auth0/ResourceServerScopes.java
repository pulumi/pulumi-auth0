...
public class ResourceServerScopes extends com.pulumi.resources.CustomResource {
     ...
     */
    public ResourceServerScopes(String name) {
     ...
     */
    public ResourceServerScopes(String name, ResourceServerScopesArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("auth0:index/resourceServerScopes:ResourceServerScopes", name, args == null ? ResourceServerScopesArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ResourceServerScopes(String name, Output<String> id, @Nullable ResourceServerScopesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("auth0:index/resourceServerScopes:ResourceServerScopes", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static ResourceServerScopes get(String name, Output<String> id, @Nullable ResourceServerScopesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
