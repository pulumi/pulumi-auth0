...
import com.pulumi.auth0.inputs.UserAttributeProfileUserAttributeStrategyOverrideOidcMappingArgs;
...
public final class UserAttributeProfileUserAttributeStrategyOverrideArgs extends com.pulumi.resources.ResourceArgs {

    public static final UserAttributeProfileUserAttributeStrategyOverrideArgs Empty = new UserAttributeProfileUserAttributeStrategyOverrideArgs();
    ...
    private @Nullable Output<UserAttributeProfileUserAttributeStrategyOverrideOidcMappingArgs> oidcMapping;

    /**
     * @return OIDC mapping override for this strategy.
     * 
     */
    public Optional<Output<UserAttributeProfileUserAttributeStrategyOverrideOidcMappingArgs>> oidcMapping() {
    ...
    private UserAttributeProfileUserAttributeStrategyOverrideArgs() {}

    private UserAttributeProfileUserAttributeStrategyOverrideArgs(UserAttributeProfileUserAttributeStrategyOverrideArgs $) {
    ...
    public static Builder builder(UserAttributeProfileUserAttributeStrategyOverrideArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserAttributeProfileUserAttributeStrategyOverrideArgs();
        }

        public Builder(UserAttributeProfileUserAttributeStrategyOverrideArgs defaults) {
            $ = new UserAttributeProfileUserAttributeStrategyOverrideArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder oidcMapping(@Nullable Output<UserAttributeProfileUserAttributeStrategyOverrideOidcMappingArgs> oidcMapping) {
         ...
         * 
         */
        public Builder oidcMapping(UserAttributeProfileUserAttributeStrategyOverrideOidcMappingArgs oidcMapping) {
        ...
        public UserAttributeProfileUserAttributeStrategyOverrideArgs build() {
            if ($.strategy == null) {
                throw new MissingRequiredPropertyException("UserAttributeProfileUserAttributeStrategyOverrideArgs", "strategy");
            }
            return $;
        }
    }
