...
@CustomType
public final class TenantDefaultTokenQuotaOrganizationsClientCredentials {
    /**
    ...
    private TenantDefaultTokenQuotaOrganizationsClientCredentials() {}
    /**
     * @return If enabled, the quota will be enforced and requests in excess of the quota will fail. If disabled, the quota will not be enforced, but notifications for requests exceeding the quota will be available in logs.
     * 
     */
    ...
    public static Builder builder(TenantDefaultTokenQuotaOrganizationsClientCredentials defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer perHour;
        public Builder() {}
        public Builder(TenantDefaultTokenQuotaOrganizationsClientCredentials defaults) {
        ...
        public TenantDefaultTokenQuotaOrganizationsClientCredentials build() {
            final var _resultValue = new TenantDefaultTokenQuotaOrganizationsClientCredentials();
