...
@CustomType
public final class UserPermissionsPermission {
    /**
    ...
    public static Builder builder(UserPermissionsPermission defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String resourceServerName;
        public Builder() {}
        public Builder(UserPermissionsPermission defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("UserPermissionsPermission", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder resourceServerIdentifier(String resourceServerIdentifier) {
            if (resourceServerIdentifier == null) {
              throw new MissingRequiredPropertyException("UserPermissionsPermission", "resourceServerIdentifier");
            }
