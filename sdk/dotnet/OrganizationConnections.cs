...
namespace Pulumi.Auth0
{
    ...
    /// {
    ///     var myConnection_1 = new Auth0.Index.Connection("my_connection-1", new()
    ///     {
    ///         Name = "My Connection 1",
    ///         Strategy = "auth0",
    ///     });
    /// 
    ///     var myConnection_2 = new Auth0.Index.Connection("my_connection-2", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var one_to_many = new Auth0.Index.OrganizationConnections("one-to-many", new()
    ///     {
