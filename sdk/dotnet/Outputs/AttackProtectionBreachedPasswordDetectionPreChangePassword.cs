...
namespace Pulumi.Auth0.Outputs
{
    ...
    [OutputType]
    public sealed class AttackProtectionBreachedPasswordDetectionPreChangePassword
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AttackProtectionBreachedPasswordDetectionPreChangePassword(ImmutableArray<string> shields)
        {
            Shields = shields;
        }
    }
