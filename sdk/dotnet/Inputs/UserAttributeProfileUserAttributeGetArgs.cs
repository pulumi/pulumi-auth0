...
namespace Pulumi.Auth0.Inputs
{
    ...
    public sealed class UserAttributeProfileUserAttributeGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("oidcMapping")]
        public Input<Inputs.UserAttributeProfileUserAttributeOidcMappingGetArgs>? OidcMapping { get; set; }
        ...
        private InputList<Inputs.UserAttributeProfileUserAttributeStrategyOverrideGetArgs>? _strategyOverrides;

        /// <summary>
        /// Strategy-specific overrides for user attribute mapping.
        /// </summary>
        public InputList<Inputs.UserAttributeProfileUserAttributeStrategyOverrideGetArgs> StrategyOverrides
        {
            get => _strategyOverrides ?? (_strategyOverrides = new InputList<Inputs.UserAttributeProfileUserAttributeStrategyOverrideGetArgs>());
            set => _strategyOverrides = value;
        }

        public UserAttributeProfileUserAttributeGetArgs()
        {
        }
        public static new UserAttributeProfileUserAttributeGetArgs Empty => new UserAttributeProfileUserAttributeGetArgs();
    }
}
