...
namespace Pulumi.Auth0.Inputs
{
    ...
    public sealed class ClientExpressConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("linkedClients")]
        private InputList<Inputs.ClientExpressConfigurationLinkedClientArgs>? _linkedClients;

        /// <summary>
        /// List of client IDs that are linked to this express configuration (e.g. web or mobile clients).
        /// </summary>
        public InputList<Inputs.ClientExpressConfigurationLinkedClientArgs> LinkedClients
        {
            get => _linkedClients ?? (_linkedClients = new InputList<Inputs.ClientExpressConfigurationLinkedClientArgs>());
        ...
        public ClientExpressConfigurationArgs()
        {
        }
        public static new ClientExpressConfigurationArgs Empty => new ClientExpressConfigurationArgs();
    }
}
