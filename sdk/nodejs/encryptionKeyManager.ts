...
export class EncryptionKeyManager extends pulumi.CustomResource {
     ...
     */
    declare public readonly customerProvidedRootKey: pulumi.Output<outputs.EncryptionKeyManagerCustomerProvidedRootKey | undefined>;
    /**
     * All encryption keys.
     */
    declare public /*out*/ readonly encryptionKeys: pulumi.Output<outputs.EncryptionKeyManagerEncryptionKey[]>;
    /**
     * If this value is changed, the encryption keys will be rotated. A UUID is recommended for the `keyRotationId`.
     */
    declare public readonly keyRotationId: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: EncryptionKeyManagerArgs | EncryptionKeyManagerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["customerProvidedRootKey"] = state?.customerProvidedRootKey;
            resourceInputs["encryptionKeys"] = state?.encryptionKeys;
            resourceInputs["keyRotationId"] = state?.keyRotationId;
        } else {
            const args = argsOrState as EncryptionKeyManagerArgs | undefined;
            resourceInputs["customerProvidedRootKey"] = args?.customerProvidedRootKey;
            resourceInputs["keyRotationId"] = args?.keyRotationId;
...
export interface EncryptionKeyManagerState {
     ...
     * This attribute is used for provisioning the customer provided root key. To initiate the provisioning process, create a new empty `customerProvidedRootKey` block. After applying this, the `publicWrappingKey` can be retreived from the resource, and the new root key should be generated by the customer and wrapped with the wrapping key, then base64-encoded and added as the `wrappedKey` attribute.
     */
    customerProvidedRootKey?: pulumi.Input<inputs.EncryptionKeyManagerCustomerProvidedRootKey | undefined>;
    /**
     * All encryption keys.
     */
    encryptionKeys?: pulumi.Input<pulumi.Input<inputs.EncryptionKeyManagerEncryptionKey>[] | undefined>;
    /**
     * If this value is changed, the encryption keys will be rotated. A UUID is recommended for the `keyRotationId`.
     */
    keyRotationId?: pulumi.Input<string | undefined>;
}
