...
class GetOrganizationResult:
    ...
    def client_grants(self) -> Sequence[builtins.str]:
        """
...
def get_organization(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the organization. If not provided, `organization_id` must be set. For performance, it is advised to use the `organization_id` as a lookup if possible.
    :param builtins.str organization_id: The ID of the organization. If not provided, `name` must be set.
    """
    __args__ = dict()
    __args__['name'] = name
