...
class GetClientsResult:
    ...
    def is_first_party(self) -> Optional[builtins.bool]:
        """
...
def get_clients(app_types: Optional[Sequence[builtins.str]] = None,
                is_first_party: Optional[builtins.bool] = None,
                name_filter: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] app_types: Filter clients by application types.
    :param builtins.bool is_first_party: Filter clients by first party status.
    :param builtins.str name_filter: Filter clients by name (partial matches supported).
    """
    __args__ = dict()
...
def get_clients_output(app_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                       is_first_party: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                       name_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
