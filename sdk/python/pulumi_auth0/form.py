...
class FormArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] style: Style specific configuration for the form. (JSON encoded)
        :param pulumi.Input[_builtins.str] translations: Translations of the form. (JSON encoded)
        """
...
class Form(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def ending(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Submission configuration of the form. (JSON encoded)
        """
        return pulumi.get(self, "ending")
    ...
    @_builtins.property
    @pulumi.getter
    def style(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Style specific configuration for the form. (JSON encoded)
        """
        return pulumi.get(self, "style")
    ...
    @_builtins.property
    @pulumi.getter
    def translations(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Translations of the form. (JSON encoded)
        """
        return pulumi.get(self, "translations")
