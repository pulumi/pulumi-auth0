...
class TriggerActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action_id: The ID of the action to bind to the trigger.
        :param pulumi.Input[builtins.str] trigger: The ID of the trigger to bind with. Available options: `post-login`, `credentials-exchange`, `pre-user-registration`, `post-user-registration`, `post-change-password`, `send-phone-message`, `password-reset-post-challenge`, `custom-email-provider`, `custom-phone-provider`.
        :param pulumi.Input[builtins.str] display_name: The name for this action within the trigger. This can be useful for distinguishing between multiple instances of the same action bound to a trigger. Defaults to action name when not provided.
        """
...
class TriggerAction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            action_id: Optional[pulumi.Input[builtins.str]] = None,
            display_name: Optional[pulumi.Input[builtins.str]] = None,
            trigger: Optional[pulumi.Input[builtins.str]] = None) -> 'TriggerAction':
        """
