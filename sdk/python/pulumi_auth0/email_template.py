...
class EmailTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] template: Template name. Options include `verify_email`, `verify_email_by_code`, `reset_email`, `reset_email_by_code`, `welcome_email`, `blocked_account`, `stolen_credentials`, `enrollment_email`, `mfa_oob_code`, `user_invitation`, `change_password` (legacy), `password_reset` (legacy), `async_approval`, or `auth_email_by_code`.
    ...
    def template(self) -> pulumi.Input[_builtins.str]:
        """
        Template name. Options include `verify_email`, `verify_email_by_code`, `reset_email`, `reset_email_by_code`, `welcome_email`, `blocked_account`, `stolen_credentials`, `enrollment_email`, `mfa_oob_code`, `user_invitation`, `change_password` (legacy), `password_reset` (legacy), `async_approval`, or `auth_email_by_code`.
        """
