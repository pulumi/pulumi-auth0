...
class EmailTemplateArgs:
    def __init__(__self__, *,
                 ...
                 syntax: pulumi.Input[builtins.str],
                 template: pulumi.Input[builtins.str],
                 include_email_in_redirect: Optional[pulumi.Input[builtins.bool]] = None,
                 result_url: Optional[pulumi.Input[builtins.str]] = None,
                 url_lifetime_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a EmailTemplate resource.
        :param pulumi.Input[builtins.str] body: Body of the email template. You can include [common variables](https://auth0.com/docs/customize/email/email-templates#common-variables).
        :param pulumi.Input[builtins.bool] enabled: Indicates whether the template is enabled.
        :param pulumi.Input[builtins.str] from_: Email address to use as the sender. You can include [common variables](https://auth0.com/docs/customize/email/email-templates#common-variables).
        :param pulumi.Input[builtins.str] subject: Subject line of the email. You can include [common variables](https://auth0.com/docs/customize/email/email-templates#common-variables).
        :param pulumi.Input[builtins.str] syntax: Syntax of the template body. You can use either text or HTML with Liquid syntax.
        :param pulumi.Input[builtins.str] template: Template name. Options include `verify_email`, `verify_email_by_code`, `reset_email`, `reset_email_by_code`, `welcome_email`, `blocked_account`, `stolen_credentials`, `enrollment_email`, `mfa_oob_code`, `user_invitation`, `change_password` (legacy), or `password_reset` (legacy).
        :param pulumi.Input[builtins.bool] include_email_in_redirect: Whether the `reset_email` and `verify_email` templates should include the user's email address as the email parameter in the `returnUrl` (true) or whether no email address should be included in the redirect (false). Defaults to `true`.
        :param pulumi.Input[builtins.str] result_url: URL to redirect the user to after a successful action. [Learn more](https://auth0.com/docs/customize/email/email-templates#configure-template-fields).
        :param pulumi.Input[builtins.int] url_lifetime_in_seconds: Number of seconds during which the link within the email will be valid.
        """
    ...
    @property
    @pulumi.getter
    def syntax(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @syntax.setter
    def syntax(self, value: pulumi.Input[builtins.str]):
    ...
    def include_email_in_redirect(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def include_email_in_redirect(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "include_email_in_redirect", value)

    @property
    @pulumi.getter(name="resultUrl")
    def result_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @result_url.setter
    def result_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "result_url", value)

    @property
    @pulumi.getter(name="urlLifetimeInSeconds")
    def url_lifetime_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def url_lifetime_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class EmailTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            syntax: Optional[pulumi.Input[builtins.str]] = None,
            template: Optional[pulumi.Input[builtins.str]] = None,
            url_lifetime_in_seconds: Optional[pulumi.Input[builtins.int]] = None) -> 'EmailTemplate':
        """
    ...
    @property
    @pulumi.getter(name="includeEmailInRedirect")
    def include_email_in_redirect(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the `reset_email` and `verify_email` templates should include the user's email address as the email parameter in the `returnUrl` (true) or whether no email address should be included in the redirect (false). Defaults to `true`.
        """
        return pulumi.get(self, "include_email_in_redirect")
    ...
    @property
    @pulumi.getter(name="resultUrl")
    def result_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URL to redirect the user to after a successful action. [Learn more](https://auth0.com/docs/customize/email/email-templates#configure-template-fields).
        """
        return pulumi.get(self, "result_url")
    ...
    @property
    @pulumi.getter
    def syntax(self) -> pulumi.Output[builtins.str]:
        """
        Syntax of the template body. You can use either text or HTML with Liquid syntax.
        """
        return pulumi.get(self, "syntax")
    ...
    @property
    @pulumi.getter(name="urlLifetimeInSeconds")
    def url_lifetime_in_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of seconds during which the link within the email will be valid.
        """
        return pulumi.get(self, "url_lifetime_in_seconds")
