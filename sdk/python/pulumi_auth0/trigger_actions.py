...
class TriggerActionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] trigger: The ID of the trigger to bind with. Options include: `post-login`, `credentials-exchange`, `pre-user-registration`, `post-user-registration`, `post-change-password`, `send-phone-message`, `password-reset-post-challenge`, `custom-email-provider`, `custom-phone-provider`.
        """
...
@pulumi.type_token("auth0:index/triggerActions:TriggerActions")
class TriggerActions(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            actions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TriggerActionsActionArgs', 'TriggerActionsActionArgsDict']]]]] = None,
            trigger: Optional[pulumi.Input[builtins.str]] = None) -> 'TriggerActions':
        """
