...
class GetResourceServerResult:
    ...
    def allow_offline_access(self) -> builtins.bool:
        """
    ...
    def consent_policy(self) -> builtins.str:
        """
    ...
    def enforce_policies(self) -> builtins.bool:
        """
    ...
    def resource_server_id(self) -> Optional[builtins.str]:
        """
    ...
    def signing_alg(self) -> builtins.str:
        """
    ...
    def skip_consent_for_verifiable_first_party_clients(self) -> builtins.bool:
        """
    ...
    def token_dialect(self) -> builtins.str:
        """
    ...
    def token_lifetime_for_web(self) -> builtins.int:
        """
    ...
    def verification_location(self) -> builtins.str:
        """
...
def get_resource_server(identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str identifier: Unique identifier for the resource server. Used as the audience parameter for authorization calls. If not provided, `resource_server_id` must be set.
    :param builtins.str resource_server_id: The ID of the resource server. If not provided, `identifier` must be set.
    """
    __args__ = dict()
...
def get_resource_server_output(identifier: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               resource_server_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
