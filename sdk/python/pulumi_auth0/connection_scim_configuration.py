...
class ConnectionScimConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_id: ID of the connection for this SCIM configuration.
        ...
        :param pulumi.Input[builtins.str] user_id_attribute: User ID attribute for generation unique of user ids. If `user_id_attribute` is set, `mapping` must be set as well. Defaults to `userName` for SAML connections and `externalId` for OIDC connections.
        """
...
class _ConnectionScimConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_id: ID of the connection for this SCIM configuration.
        :param pulumi.Input[builtins.str] connection_name: Name of the connection for this SCIM configuration.
        :param pulumi.Input[Sequence[pulumi.Input['ConnectionScimConfigurationMappingArgs']]] mappings: Mapping between Auth0 attributes and SCIM attributes. If `user_id_attribute` is set, `mapping` must be set as well.
        :param pulumi.Input[builtins.str] strategy: Schema of the connection for this SCIM configuration.
        :param pulumi.Input[builtins.str] tenant_name: Name of the tenant for this SCIM configuration.
        :param pulumi.Input[builtins.str] user_id_attribute: User ID attribute for generation unique of user ids. If `user_id_attribute` is set, `mapping` must be set as well. Defaults to `userName` for SAML connections and `externalId` for OIDC connections.
        """
...
class ConnectionScimConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            strategy: Optional[pulumi.Input[builtins.str]] = None,
            tenant_name: Optional[pulumi.Input[builtins.str]] = None,
            user_id_attribute: Optional[pulumi.Input[builtins.str]] = None) -> 'ConnectionScimConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="userIdAttribute")
    def user_id_attribute(self) -> pulumi.Output[builtins.str]:
        """
        User ID attribute for generation unique of user ids. If `user_id_attribute` is set, `mapping` must be set as well. Defaults to `userName` for SAML connections and `externalId` for OIDC connections.
        """
        return pulumi.get(self, "user_id_attribute")
