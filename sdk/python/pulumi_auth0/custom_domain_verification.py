...
class CustomDomainVerificationInitArgs:
    ...
    def custom_domain_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def custom_domain_id(self, value: pulumi.Input[_builtins.str]):
...
class CustomDomainVerification(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="cnameApiKey")
    def cname_api_key(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "cname_api_key")
