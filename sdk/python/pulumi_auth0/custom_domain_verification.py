...
class CustomDomainVerificationInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] custom_domain_id: ID of the custom domain resource.
        """
...
class _CustomDomainVerificationState:
    def __init__(__self__, *,
                 cname_api_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] custom_domain_id: ID of the custom domain resource.
        :param pulumi.Input[builtins.str] origin_domain_name: The DNS name of the Auth0 origin server that handles traffic for the custom domain.
        """
    ...
    def cname_api_key(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "cname_api_key")

    @cname_api_key.setter
    def cname_api_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def origin_domain_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "origin_domain_name", value)


@pulumi.type_token("auth0:index/customDomainVerification:CustomDomainVerification")
class CustomDomainVerification(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cname_api_key: Optional[pulumi.Input[builtins.str]] = None,
            custom_domain_id: Optional[pulumi.Input[builtins.str]] = None,
            origin_domain_name: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomDomainVerification':
        """
    ...
    @property
    @pulumi.getter(name="cnameApiKey")
    def cname_api_key(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "cname_api_key")
