...
class OrganizationMembersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] members: Add user ID(s) directly from the tenant to become members of the organization.
        :param pulumi.Input[builtins.str] organization_id: The ID of the organization to assign the members to.
        """
...
@pulumi.type_token("auth0:index/organizationMembers:OrganizationMembers")
class OrganizationMembers(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            organization_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationMembers':
        """
