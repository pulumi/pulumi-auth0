...
class GetPromptScreenRendererResult:
    ...
    def context_configurations(self) -> Sequence[builtins.str]:
        """
    ...
    def default_head_tags_disabled(self) -> builtins.bool:
        """
    ...
    def head_tags(self) -> builtins.str:
        """
    ...
    def rendering_mode(self) -> builtins.str:
        """
...
def get_prompt_screen_renderer(prompt_type: Optional[builtins.str] = None,
                               screen_name: Optional[builtins.str] = None,
    ...
    :param builtins.str screen_name: The screen name associated with the prompt type.
    """
    __args__ = dict()
