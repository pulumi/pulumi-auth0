...
class ResourceServerScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_server_identifier: Identifier of the resource server that the scope (permission) is associated with.
        :param pulumi.Input[builtins.str] scope: Name of the scope (permission).
        :param pulumi.Input[builtins.str] description: Description of the scope (permission).
        """
...
class ResourceServerScope(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            resource_server_identifier: Optional[pulumi.Input[builtins.str]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'ResourceServerScope':
        """
