...
class PromptArgs:
    def __init__(__self__, *,
                 identifier_first: Optional[pulumi.Input[builtins.bool]] = None,
                 universal_login_experience: Optional[pulumi.Input[builtins.str]] = None,
                 webauthn_platform_first_factor: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Prompt resource.
        :param pulumi.Input[builtins.bool] identifier_first: Indicates whether the identifier first is used when using the new Universal Login experience.
        :param pulumi.Input[builtins.str] universal_login_experience: Which login experience to use. Options include `classic` and `new`.
        :param pulumi.Input[builtins.bool] webauthn_platform_first_factor: Determines if the login screen uses identifier and biometrics first. Setting this property to `true`, requires MFA factors enabled for enrollment; use the `Guardian` resource to set one up.
        """
    ...
    def identifier_first(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def identifier_first(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "identifier_first", value)

    @property
    @pulumi.getter(name="universalLoginExperience")
    def universal_login_experience(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def universal_login_experience(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "universal_login_experience", value)

    @property
    @pulumi.getter(name="webauthnPlatformFirstFactor")
    def webauthn_platform_first_factor(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def webauthn_platform_first_factor(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Prompt(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            identifier_first: Optional[pulumi.Input[builtins.bool]] = None,
            universal_login_experience: Optional[pulumi.Input[builtins.str]] = None,
            webauthn_platform_first_factor: Optional[pulumi.Input[builtins.bool]] = None) -> 'Prompt':
        """
    ...
    @property
    @pulumi.getter(name="identifierFirst")
    def identifier_first(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the identifier first is used when using the new Universal Login experience.
        """
        return pulumi.get(self, "identifier_first")
    ...
    @property
    @pulumi.getter(name="universalLoginExperience")
    def universal_login_experience(self) -> pulumi.Output[builtins.str]:
        """
        Which login experience to use. Options include `classic` and `new`.
        """
        return pulumi.get(self, "universal_login_experience")
    ...
    @property
    @pulumi.getter(name="webauthnPlatformFirstFactor")
    def webauthn_platform_first_factor(self) -> pulumi.Output[builtins.bool]:
        """
        Determines if the login screen uses identifier and biometrics first. Setting this property to `true`, requires MFA factors enabled for enrollment; use the `Guardian` resource to set one up.
        """
        return pulumi.get(self, "webauthn_platform_first_factor")
