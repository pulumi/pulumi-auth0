...
class LogStreamArgs:
    def __init__(__self__, *,
                 ...
                 filters: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]]] = None,
                 is_priority: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a LogStream resource.
        :param pulumi.Input['LogStreamSinkArgs'] sink: The sink configuration for the log stream.
        :param pulumi.Input[builtins.str] type: Type of the log stream, which indicates the sink provider. Options include: `eventbridge`, `eventgrid`, `http`, `datadog`, `splunk`, `sumo`, `mixpanel`, `segment`.
        :param pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]] filters: Only logs events matching these filters will be delivered by the stream. If omitted or empty, all events will be delivered. Filters available: `auth.ancillary.fail`, `auth.ancillary.success`, `auth.login.fail`, `auth.login.notification`, `auth.login.success`, `auth.logout.fail`, `auth.logout.success`, `auth.signup.fail`, `auth.signup.success`, `auth.silent_auth.fail`, `auth.silent_auth.success`, `auth.token_exchange.fail`, `auth.token_exchange.success`, `management.fail`, `management.success`, `system.notification`, `user.fail`, `user.notification`, `user.success`, `other`.
        :param pulumi.Input[builtins.bool] is_priority: Set True for priority log streams, False for non-priority
        :param pulumi.Input[builtins.str] name: Name of the log stream.
        :param pulumi.Input[builtins.str] status: The current status of the log stream. Options are "active", "paused", "suspended".
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]]]:
        """
    ...
    @filters.setter
    def filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]]]):
        pulumi.set(self, "filters", value)

    @property
    @pulumi.getter(name="isPriority")
    def is_priority(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_priority.setter
    def is_priority(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class LogStream(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isPriority")
    def is_priority(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set True for priority log streams, False for non-priority
        """
        return pulumi.get(self, "is_priority")
