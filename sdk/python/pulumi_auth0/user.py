...
class UserArgs:
    def __init__(__self__, *,
                 ...
                 phone_verified: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] given_name: Given name of the user. This value can only be updated if the connection is a database connection (using the Auth0 store), a passwordless connection (email or sms) or has disabled 'Sync user profile attributes at each login'. For more information, see: [Configure Identity Provider Connection for User Profile Updates](https://auth0.com/docs/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0).
        :param pulumi.Input[builtins.str] name: Name of the user. This value can only be updated if the connection is a database connection (using the Auth0 store), a passwordless connection (email or sms) or has disabled 'Sync user profile attributes at each login'. For more information, see: [Configure Identity Provider Connection for User Profile Updates](https://auth0.com/docs/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0).
        :param pulumi.Input[builtins.str] nickname: Preferred nickname or alias of the user. This value can only be updated if the connection is a database connection (using the Auth0 store), a passwordless connection (email or sms) or has disabled 'Sync user profile attributes at each login'. For more information, see: [Configure Identity Provider Connection for User Profile Updates](https://auth0.com/docs/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0).
        :param pulumi.Input[builtins.str] password: Initial password for this user. Required for non-passwordless connections (SMS and email).
        :param pulumi.Input[builtins.str] phone_number: Phone number for the user; follows the E.164 recommendation. Used for SMS connections.
        :param pulumi.Input[builtins.bool] phone_verified: Indicates whether the phone number has been verified.
        :param pulumi.Input[builtins.str] picture: Picture of the user. This value can only be updated if the connection is a database connection (using the Auth0 store), a passwordless connection (email or sms) or has disabled 'Sync user profile attributes at each login'. For more information, see: [Configure Identity Provider Connection for User Profile Updates](https://auth0.com/docs/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0).
        :param pulumi.Input[builtins.str] user_id: ID of the user.
        :param pulumi.Input[builtins.str] user_metadata: Custom fields that store info about the user that does not impact a user's core functionality. Examples include work address, home address, and user preferences.
        :param pulumi.Input[builtins.str] username: Username of the user. Only valid if the connection requires a username.
        :param pulumi.Input[builtins.bool] verify_email: Indicates whether the user will receive a verification email after creation. Overrides behavior of `email_verified` parameter.
        """
    ...
    def app_metadata(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @app_metadata.setter
    def app_metadata(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def phone_verified(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def phone_verified(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class User(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_metadata: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None,
            verify_email: Optional[pulumi.Input[builtins.bool]] = None) -> 'User':
        """
    ...
    @property
    @pulumi.getter(name="appMetadata")
    def app_metadata(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Custom fields that store info about the user that impact the user's core functionality, such as how an application functions or what the user can access. Examples include support plans and IDs for external accounts.
        """
        return pulumi.get(self, "app_metadata")
    ...
    @property
    @pulumi.getter(name="familyName")
    def family_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Family name of the user. This value can only be updated if the connection is a database connection (using the Auth0 store), a passwordless connection (email or sms) or has disabled 'Sync user profile attributes at each login'. For more information, see: [Configure Identity Provider Connection for User Profile Updates](https://auth0.com/docs/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0).
        """
        return pulumi.get(self, "family_name")
    ...
    @property
    @pulumi.getter(name="phoneVerified")
    def phone_verified(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the phone number has been verified.
        """
        return pulumi.get(self, "phone_verified")
    ...
    @property
    @pulumi.getter
    def picture(self) -> pulumi.Output[builtins.str]:
        """
        Picture of the user. This value can only be updated if the connection is a database connection (using the Auth0 store), a passwordless connection (email or sms) or has disabled 'Sync user profile attributes at each login'. For more information, see: [Configure Identity Provider Connection for User Profile Updates](https://auth0.com/docs/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0).
        """
        return pulumi.get(self, "picture")
    ...
    @property
    @pulumi.getter(name="verifyEmail")
    def verify_email(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the user will receive a verification email after creation. Overrides behavior of `email_verified` parameter.
        """
        return pulumi.get(self, "verify_email")
