...
class OrganizationConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] organization_id: The ID of the organization to enable the connection for.
...
class _OrganizationConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_id: The ID of the connection to enable for the organization.
        :param pulumi.Input[builtins.bool] is_signup_enabled: Determines whether organization sign-up should be enabled for this organization connection. Only applicable for database connections. Note: `is_signup_enabled` can only be `true` if `assign_membership_on_login` is `true`.
        :param pulumi.Input[builtins.str] name: The name of the enabled connection.
        :param pulumi.Input[builtins.str] organization_id: The ID of the organization to enable the connection for.
        :param pulumi.Input[builtins.bool] show_as_button: Determines whether a connection should be displayed on this organization’s login prompt. Only applicable for enterprise connections.
        :param pulumi.Input[builtins.str] strategy: The strategy of the enabled connection.
        """
        if assign_membership_on_login is not None:
            pulumi.set(__self__, "assign_membership_on_login", assign_membership_on_login)
...
@pulumi.type_token("auth0:index/organizationConnection:OrganizationConnection")
class OrganizationConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            organization_id: Optional[pulumi.Input[builtins.str]] = None,
            show_as_button: Optional[pulumi.Input[builtins.bool]] = None,
            strategy: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationConnection':
        """
    ...
    @property
    @pulumi.getter(name="assignMembershipOnLogin")
    def assign_membership_on_login(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When `true`, all users that log in with this connection will be automatically granted membership in the organization. When `false`, users must be granted membership in the organization before logging in with this connection.
        """
        return pulumi.get(self, "assign_membership_on_login")
    ...
    @property
    @pulumi.getter(name="isSignupEnabled")
    def is_signup_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Determines whether organization sign-up should be enabled for this organization connection. Only applicable for database connections. Note: `is_signup_enabled` can only be `true` if `assign_membership_on_login` is `true`.
        """
        return pulumi.get(self, "is_signup_enabled")
    ...
    @property
    @pulumi.getter(name="showAsButton")
    def show_as_button(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Determines whether a connection should be displayed on this organization’s login prompt. Only applicable for enterprise connections.
        """
        return pulumi.get(self, "show_as_button")
