...
class GuardianArgs:
    def __init__(__self__, *,
                 ...
                 otp: Optional[pulumi.Input[builtins.bool]] = None,
                 phone: Optional[pulumi.Input['GuardianPhoneArgs']] = None,
                 push: Optional[pulumi.Input['GuardianPushArgs']] = None,
                 recovery_code: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] policy: Policy to use. Available options are `never`, `all-applications` and `confidence-score`.
        ...
        :param pulumi.Input[builtins.bool] email: Indicates whether email MFA is enabled.
        :param pulumi.Input[builtins.bool] otp: Indicates whether one time password MFA is enabled.
        ...
        :param pulumi.Input[builtins.bool] recovery_code: Indicates whether recovery code MFA is enabled.
    ...
    @property
    @pulumi.getter
    def otp(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @otp.setter
    def otp(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def recovery_code(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def recovery_code(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Guardian(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def email(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether email MFA is enabled.
        """
        return pulumi.get(self, "email")
    ...
    @property
    @pulumi.getter
    def otp(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether one time password MFA is enabled.
        """
        return pulumi.get(self, "otp")
    ...
    @property
    @pulumi.getter(name="recoveryCode")
    def recovery_code(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether recovery code MFA is enabled.
        """
        return pulumi.get(self, "recovery_code")
