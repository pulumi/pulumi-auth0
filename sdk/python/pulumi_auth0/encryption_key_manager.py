...
class EncryptionKeyManagerArgs:
    def __init__(__self__, *,
                 customer_provided_root_key: pulumi.Input[Optional['EncryptionKeyManagerCustomerProvidedRootKeyArgs']] = None,
                 key_rotation_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] key_rotation_id: If this value is changed, the encryption keys will be rotated. A UUID is recommended for the `key_rotation_id`.
        """
    ...
    def customer_provided_root_key(self) -> pulumi.Input[Optional['EncryptionKeyManagerCustomerProvidedRootKeyArgs']]:
        """
    ...
    def customer_provided_root_key(self, value: pulumi.Input[Optional['EncryptionKeyManagerCustomerProvidedRootKeyArgs']]):
        pulumi.set(self, "customer_provided_root_key", value)

    @_builtins.property
    @pulumi.getter(name="keyRotationId")
    def key_rotation_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def key_rotation_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _EncryptionKeyManagerState:
    def __init__(__self__, *,
                 customer_provided_root_key: pulumi.Input[Optional['EncryptionKeyManagerCustomerProvidedRootKeyArgs']] = None,
                 encryption_keys: pulumi.Input[Optional[Sequence[pulumi.Input['EncryptionKeyManagerEncryptionKeyArgs']]]] = None,
                 key_rotation_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def encryption_keys(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EncryptionKeyManagerEncryptionKeyArgs']]]]:
        """
        All encryption keys.
        """
    ...
    def encryption_keys(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EncryptionKeyManagerEncryptionKeyArgs']]]]):
...
class EncryptionKeyManager(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 customer_provided_root_key: pulumi.Input[Optional[Union['EncryptionKeyManagerCustomerProvidedRootKeyArgs', 'EncryptionKeyManagerCustomerProvidedRootKeyArgsDict', 'outputs.EncryptionKeyManagerCustomerProvidedRootKey']]] = None,
                 key_rotation_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['EncryptionKeyManagerCustomerProvidedRootKeyArgs', 'EncryptionKeyManagerCustomerProvidedRootKeyArgsDict', 'outputs.EncryptionKeyManagerCustomerProvidedRootKey']] customer_provided_root_key: This attribute is used for provisioning the customer provided root key. To initiate the provisioning process, create a new empty `customer_provided_root_key` block. After applying this, the `public_wrapping_key` can be retreived from the resource, and the new root key should be generated by the customer and wrapped with the wrapping key, then base64-encoded and added as the `wrapped_key` attribute.
        :param pulumi.Input[_builtins.str] key_rotation_id: If this value is changed, the encryption keys will be rotated. A UUID is recommended for the `key_rotation_id`.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            customer_provided_root_key: pulumi.Input[Optional[Union['EncryptionKeyManagerCustomerProvidedRootKeyArgs', 'EncryptionKeyManagerCustomerProvidedRootKeyArgsDict', 'outputs.EncryptionKeyManagerCustomerProvidedRootKey']]] = None,
            encryption_keys: pulumi.Input[Optional[Sequence[pulumi.Input[Union['EncryptionKeyManagerEncryptionKeyArgs', 'EncryptionKeyManagerEncryptionKeyArgsDict', 'outputs.EncryptionKeyManagerEncryptionKey']]]]] = None,
            key_rotation_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'EncryptionKeyManager':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Union['EncryptionKeyManagerCustomerProvidedRootKeyArgs', 'EncryptionKeyManagerCustomerProvidedRootKeyArgsDict', 'outputs.EncryptionKeyManagerCustomerProvidedRootKey']] customer_provided_root_key: This attribute is used for provisioning the customer provided root key. To initiate the provisioning process, create a new empty `customer_provided_root_key` block. After applying this, the `public_wrapping_key` can be retreived from the resource, and the new root key should be generated by the customer and wrapped with the wrapping key, then base64-encoded and added as the `wrapped_key` attribute.
        :param pulumi.Input[Sequence[pulumi.Input[Union['EncryptionKeyManagerEncryptionKeyArgs', 'EncryptionKeyManagerEncryptionKeyArgsDict', 'outputs.EncryptionKeyManagerEncryptionKey']]]] encryption_keys: All encryption keys.
        :param pulumi.Input[_builtins.str] key_rotation_id: If this value is changed, the encryption keys will be rotated. A UUID is recommended for the `key_rotation_id`.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="keyRotationId")
    def key_rotation_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        If this value is changed, the encryption keys will be rotated. A UUID is recommended for the `key_rotation_id`.
        """
        return pulumi.get(self, "key_rotation_id")
