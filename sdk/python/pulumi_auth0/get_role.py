...
def get_role(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the role. If not provided, `role_id` must be set.
    :param builtins.str role_id: The ID of the role. If not provided, `name` must be set.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_role_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
