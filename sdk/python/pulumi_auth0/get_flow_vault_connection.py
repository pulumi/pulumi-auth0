...
class GetFlowVaultConnectionResult:
    ...
    @property
    @pulumi.getter
    def setup(self) -> Mapping[str, builtins.str]:
        """
...
def get_flow_vault_connection(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The id of the Flow Vault Connection.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_flow_vault_connection_output(id: Optional[pulumi.Input[builtins.str]] = None,
