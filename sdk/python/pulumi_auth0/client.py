...
class ClientArgs:
    def __init__(__self__, *,
                 ...
                 callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 client_aliases: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 cross_origin_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 cross_origin_loc: Optional[pulumi.Input[builtins.str]] = None,
                 custom_login_page: Optional[pulumi.Input[builtins.str]] = None,
                 custom_login_page_on: Optional[pulumi.Input[builtins.bool]] = None,
                 default_organization: Optional[pulumi.Input['ClientDefaultOrganizationArgs']] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_key: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 form_template: Optional[pulumi.Input[builtins.str]] = None,
                 grant_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 initiate_login_uri: Optional[pulumi.Input[builtins.str]] = None,
                 is_first_party: Optional[pulumi.Input[builtins.bool]] = None,
                 is_token_endpoint_ip_header_trusted: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 oidc_backchannel_logout_urls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 oidc_conformant: Optional[pulumi.Input[builtins.bool]] = None,
                 oidc_logout: Optional[pulumi.Input['ClientOidcLogoutArgs']] = None,
                 organization_require_behavior: Optional[pulumi.Input[builtins.str]] = None,
                 organization_usage: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_clients: List of applications ID's that will be allowed to make delegation request. By default, all applications will be allowed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_logout_urls: URLs that Auth0 may redirect to after logout.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_origins: URLs that represent valid origins for cross-origin resource sharing. By default, all your callback URLs will be allowed.
        :param pulumi.Input[builtins.str] app_type: Type of application the client represents. Possible values are: `native`, `spa`, `regular_web`, `non_interactive`, `sso_integration`. Specific SSO integrations types accepted as well are: `rms`, `box`, `cloudbees`, `concur`, `dropbox`, `mscrm`, `echosign`, `egnyte`, `newrelic`, `office365`, `salesforce`, `sentry`, `sharepoint`, `slack`, `springcm`, `zendesk`, `zoom`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] callbacks: URLs that Auth0 may call back to after a user authenticates for the client. Make sure to specify the protocol (https://) otherwise the callback may fail in some cases. With the exception of custom URI schemes for native clients, all callbacks should use protocol https://.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] client_aliases: List of audiences/realms for SAML protocol. Used by the wsfed addon.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] client_metadata: Metadata associated with the client, in the form of an object with string values (max 255 chars). Maximum of 10 metadata properties allowed. Field names (max 255 chars) are alphanumeric and may only include the following special characters: `:,-+=_*?"/\\()<>@ [Tab] [Space]`.
        :param pulumi.Input[builtins.str] compliance_level: Defines the compliance level for this client, which may restrict it's capabilities. Can be one of `none`, `fapi1_adv_pkj_par`, `fapi1_adv_mtls_par`.
        :param pulumi.Input[builtins.bool] cross_origin_auth: Whether this client can be used to make cross-origin authentication requests (`true`) or it is not allowed to make such requests (`false`).
        :param pulumi.Input[builtins.str] cross_origin_loc: URL of the location in your site where the cross-origin verification takes place for the cross-origin auth flow when performing authentication in your own domain instead of Auth0 Universal Login page.
        :param pulumi.Input[builtins.str] custom_login_page: The content (HTML, CSS, JS) of the custom login page.
        :param pulumi.Input[builtins.bool] custom_login_page_on: Indicates whether a custom login page is to be used.
        ...
        :param pulumi.Input[builtins.str] description: Description of the purpose of the client.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] encryption_key: Encryption used for WS-Fed responses with this client.
        :param pulumi.Input[builtins.str] form_template: HTML form template to be used for WS-Federation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] grant_types: Types of grants that this client is authorized to use.
        :param pulumi.Input[builtins.str] initiate_login_uri: Initiate login URI. Must be HTTPS or an empty string.
        :param pulumi.Input[builtins.bool] is_first_party: Indicates whether this client is a first-party client.Defaults to true from the API
        :param pulumi.Input[builtins.bool] is_token_endpoint_ip_header_trusted: Indicates whether the token endpoint IP header is trusted. Requires the authentication method to be set to `client_secret_post` or `client_secret_basic`. Setting this property when creating the resource, will default the authentication method to `client_secret_post`. To change the authentication method to `client_secret_basic` use the `ClientCredentials` resource.
        ...
        :param pulumi.Input[builtins.str] logo_uri: URL of the logo for the client. Recommended size is 150px x 150px. If none is set, the default badge for the application type will be shown.
        :param pulumi.Input['ClientMobileArgs'] mobile: Additional configuration for native mobile apps.
        :param pulumi.Input[builtins.str] name: Name of the client.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] oidc_backchannel_logout_urls: Set of URLs that are valid to call back from Auth0 for OIDC backchannel logout. Currently only one URL is allowed.
        :param pulumi.Input[builtins.bool] oidc_conformant: Indicates whether this client will conform to strict OIDC specifications.
        :param pulumi.Input['ClientOidcLogoutArgs'] oidc_logout: Configure OIDC logout for the Client
        :param pulumi.Input[builtins.str] organization_require_behavior: Defines how to proceed during an authentication transaction when `organization_usage = "require"`. Can be `no_prompt` (default), `pre_login_prompt` or  `post_login_prompt`.
        :param pulumi.Input[builtins.str] organization_usage: Defines how to proceed during an authentication transaction with regards to an organization. Can be `deny` (default), `allow` or `require`.
        ...
        :param pulumi.Input[builtins.bool] require_proof_of_possession: Makes the use of Proof-of-Possession mandatory for this client.
        :param pulumi.Input[builtins.bool] require_pushed_authorization_requests: Makes the use of Pushed Authorization Requests mandatory for this client. This feature currently needs to be enabled on the tenant in order to make use of it.
        :param pulumi.Input[builtins.bool] sso: Applies only to SSO clients and determines whether Auth0 will handle Single Sign-On (true) or whether the identity provider will (false).
        :param pulumi.Input[builtins.bool] sso_disabled: Indicates whether or not SSO is disabled.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] web_origins: URLs that represent valid web origins for use with web message response mode.
        """
    ...
    @property
    @pulumi.getter
    def callbacks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @callbacks.setter
    def callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "callbacks", value)

    @property
    @pulumi.getter(name="clientAliases")
    def client_aliases(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def client_aliases(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def cross_origin_auth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cross_origin_auth(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "cross_origin_auth", value)

    @property
    @pulumi.getter(name="crossOriginLoc")
    def cross_origin_loc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cross_origin_loc(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cross_origin_loc", value)

    @property
    @pulumi.getter(name="customLoginPage")
    def custom_login_page(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_login_page(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_login_page", value)

    @property
    @pulumi.getter(name="customLoginPageOn")
    def custom_login_page_on(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def custom_login_page_on(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def encryption_key(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def encryption_key(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "encryption_key", value)

    @property
    @pulumi.getter(name="formTemplate")
    def form_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def form_template(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def initiate_login_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def initiate_login_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "initiate_login_uri", value)

    @property
    @pulumi.getter(name="isFirstParty")
    def is_first_party(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_first_party(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_first_party", value)

    @property
    @pulumi.getter(name="isTokenEndpointIpHeaderTrusted")
    def is_token_endpoint_ip_header_trusted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_token_endpoint_ip_header_trusted(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def oidc_backchannel_logout_urls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def oidc_backchannel_logout_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "oidc_backchannel_logout_urls", value)

    @property
    @pulumi.getter(name="oidcConformant")
    def oidc_conformant(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def oidc_conformant(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def organization_require_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def organization_require_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "organization_require_behavior", value)

    @property
    @pulumi.getter(name="organizationUsage")
    def organization_usage(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def organization_usage(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def require_proof_of_possession(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def require_proof_of_possession(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @sso.setter
    def sso(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sso", value)

    @property
    @pulumi.getter(name="ssoDisabled")
    def sso_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @sso_disabled.setter
    def sso_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ClientState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] require_proof_of_possession: Makes the use of Proof-of-Possession mandatory for this client.
        :param pulumi.Input[builtins.bool] require_pushed_authorization_requests: Makes the use of Pushed Authorization Requests mandatory for this client. This feature currently needs to be enabled on the tenant in order to make use of it.
        :param pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]] signing_keys: List containing a map of the public cert of the signing key and the public cert of the signing key in PKCS7.
        :param pulumi.Input[builtins.bool] sso: Applies only to SSO clients and determines whether Auth0 will handle Single Sign-On (true) or whether the identity provider will (false).
        :param pulumi.Input[builtins.bool] sso_disabled: Indicates whether or not SSO is disabled.
        :param pulumi.Input['ClientTokenExchangeArgs'] token_exchange: Allows configuration for token exchange
        :param pulumi.Input['ClientTokenQuotaArgs'] token_quota: The token quota configuration.
    ...
    @signing_keys.setter
    def signing_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]]]):
...
class Client(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowedClients")
    def allowed_clients(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of applications ID's that will be allowed to make delegation request. By default, all applications will be allowed.
        """
        return pulumi.get(self, "allowed_clients")
    ...
    @property
    @pulumi.getter(name="allowedLogoutUrls")
    def allowed_logout_urls(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        URLs that Auth0 may redirect to after logout.
        """
        return pulumi.get(self, "allowed_logout_urls")
    ...
    @property
    @pulumi.getter(name="appType")
    def app_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type of application the client represents. Possible values are: `native`, `spa`, `regular_web`, `non_interactive`, `sso_integration`. Specific SSO integrations types accepted as well are: `rms`, `box`, `cloudbees`, `concur`, `dropbox`, `mscrm`, `echosign`, `egnyte`, `newrelic`, `office365`, `salesforce`, `sentry`, `sharepoint`, `slack`, `springcm`, `zendesk`, `zoom`.
        """
        return pulumi.get(self, "app_type")
    ...
    @property
    @pulumi.getter
    def callbacks(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        URLs that Auth0 may call back to after a user authenticates for the client. Make sure to specify the protocol (https://) otherwise the callback may fail in some cases. With the exception of custom URI schemes for native clients, all callbacks should use protocol https://.
        """
        return pulumi.get(self, "callbacks")
    ...
    @property
    @pulumi.getter(name="clientAliases")
    def client_aliases(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of audiences/realms for SAML protocol. Used by the wsfed addon.
        """
        return pulumi.get(self, "client_aliases")
    ...
    @property
    @pulumi.getter(name="complianceLevel")
    def compliance_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines the compliance level for this client, which may restrict it's capabilities. Can be one of `none`, `fapi1_adv_pkj_par`, `fapi1_adv_mtls_par`.
        """
        return pulumi.get(self, "compliance_level")
    ...
    @property
    @pulumi.getter(name="crossOriginAuth")
    def cross_origin_auth(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether this client can be used to make cross-origin authentication requests (`true`) or it is not allowed to make such requests (`false`).
        """
        return pulumi.get(self, "cross_origin_auth")
    ...
    @property
    @pulumi.getter(name="crossOriginLoc")
    def cross_origin_loc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URL of the location in your site where the cross-origin verification takes place for the cross-origin auth flow when performing authentication in your own domain instead of Auth0 Universal Login page.
        """
        return pulumi.get(self, "cross_origin_loc")
    ...
    @property
    @pulumi.getter(name="customLoginPage")
    def custom_login_page(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The content (HTML, CSS, JS) of the custom login page.
        """
        return pulumi.get(self, "custom_login_page")
    ...
    @property
    @pulumi.getter(name="customLoginPageOn")
    def custom_login_page_on(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether a custom login page is to be used.
        """
        return pulumi.get(self, "custom_login_page_on")
    ...
    @property
    @pulumi.getter(name="encryptionKey")
    def encryption_key(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Encryption used for WS-Fed responses with this client.
        """
        return pulumi.get(self, "encryption_key")
    ...
    @property
    @pulumi.getter(name="formTemplate")
    def form_template(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        HTML form template to be used for WS-Federation.
        """
        return pulumi.get(self, "form_template")
    ...
    @property
    @pulumi.getter(name="initiateLoginUri")
    def initiate_login_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Initiate login URI. Must be HTTPS or an empty string.
        """
        return pulumi.get(self, "initiate_login_uri")
    ...
    @property
    @pulumi.getter(name="isFirstParty")
    def is_first_party(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether this client is a first-party client.Defaults to true from the API
        """
        return pulumi.get(self, "is_first_party")
    ...
    @property
    @pulumi.getter(name="isTokenEndpointIpHeaderTrusted")
    def is_token_endpoint_ip_header_trusted(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the token endpoint IP header is trusted. Requires the authentication method to be set to `client_secret_post` or `client_secret_basic`. Setting this property when creating the resource, will default the authentication method to `client_secret_post`. To change the authentication method to `client_secret_basic` use the `ClientCredentials` resource.
        """
        return pulumi.get(self, "is_token_endpoint_ip_header_trusted")
    ...
    @property
    @pulumi.getter(name="oidcConformant")
    def oidc_conformant(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether this client will conform to strict OIDC specifications.
        """
        return pulumi.get(self, "oidc_conformant")
    ...
    @property
    @pulumi.getter(name="organizationRequireBehavior")
    def organization_require_behavior(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines how to proceed during an authentication transaction when `organization_usage = "require"`. Can be `no_prompt` (default), `pre_login_prompt` or  `post_login_prompt`.
        """
        return pulumi.get(self, "organization_require_behavior")
    ...
    @property
    @pulumi.getter(name="organizationUsage")
    def organization_usage(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines how to proceed during an authentication transaction with regards to an organization. Can be `deny` (default), `allow` or `require`.
        """
        return pulumi.get(self, "organization_usage")
    ...
    @property
    @pulumi.getter(name="requireProofOfPossession")
    def require_proof_of_possession(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Makes the use of Proof-of-Possession mandatory for this client.
        """
        return pulumi.get(self, "require_proof_of_possession")
    ...
    @property
    @pulumi.getter(name="requirePushedAuthorizationRequests")
    def require_pushed_authorization_requests(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Makes the use of Pushed Authorization Requests mandatory for this client. This feature currently needs to be enabled on the tenant in order to make use of it.
        """
        return pulumi.get(self, "require_pushed_authorization_requests")
    ...
    @property
    @pulumi.getter(name="signingKeys")
    def signing_keys(self) -> pulumi.Output[Sequence[Mapping[str, builtins.str]]]:
        """
        List containing a map of the public cert of the signing key and the public cert of the signing key in PKCS7.
        """
        return pulumi.get(self, "signing_keys")
    ...
    @property
    @pulumi.getter
    def sso(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Applies only to SSO clients and determines whether Auth0 will handle Single Sign-On (true) or whether the identity provider will (false).
        """
        return pulumi.get(self, "sso")
    ...
    @property
    @pulumi.getter(name="ssoDisabled")
    def sso_disabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether or not SSO is disabled.
        """
        return pulumi.get(self, "sso_disabled")
    ...
    @property
    @pulumi.getter(name="webOrigins")
    def web_origins(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        URLs that represent valid web origins for use with web message response mode.
        """
        return pulumi.get(self, "web_origins")
