...
def get_connection_scim_configuration(connection_id: Optional[builtins.str] = None,
    ...
    :param builtins.str connection_id: ID of the connection for this SCIM configuration.
...
def get_connection_scim_configuration_output(connection_id: Optional[pulumi.Input[builtins.str]] = None,
