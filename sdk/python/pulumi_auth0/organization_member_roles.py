...
class OrganizationMemberRolesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: The role ID(s) to assign to the organization member.
...
class OrganizationMemberRoles(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            organization_id: Optional[pulumi.Input[builtins.str]] = None,
            roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationMemberRoles':
        """
