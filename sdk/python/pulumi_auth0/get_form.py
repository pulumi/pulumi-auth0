...
class GetFormResult:
    ...
    @property
    @pulumi.getter
    def translations(self) -> builtins.str:
        """
...
def get_form(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The id of the Form.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_form_output(id: Optional[pulumi.Input[builtins.str]] = None,
