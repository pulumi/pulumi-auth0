...
class UserRolesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] roles: Set of IDs of roles assigned to the user.
...
@pulumi.type_token("auth0:index/userRoles:UserRoles")
