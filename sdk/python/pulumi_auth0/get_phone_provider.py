...
def get_phone_provider(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the Phone Provider.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_phone_provider_output(id: Optional[pulumi.Input[builtins.str]] = None,
