...
class OrganizationMemberRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_id: The role ID to assign to the organization member.
        :param pulumi.Input[builtins.str] user_id: The user ID of the organization member.
        """
...
class _OrganizationMemberRoleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] organization_id: The ID of the organization.
        :param pulumi.Input[builtins.str] role_description: Description of the role.
        :param pulumi.Input[builtins.str] role_id: The role ID to assign to the organization member.
...
class OrganizationMemberRole(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_id: Optional[pulumi.Input[builtins.str]] = None,
            role_name: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationMemberRole':
        """
    ...
    @property
    @pulumi.getter(name="roleDescription")
    def role_description(self) -> pulumi.Output[builtins.str]:
        """
        Description of the role.
        """
        return pulumi.get(self, "role_description")
