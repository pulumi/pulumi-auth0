...
def get_token_exchange_profile(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The id of the Token Exchange Profile
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_token_exchange_profile_output(id: Optional[pulumi.Input[builtins.str]] = None,
