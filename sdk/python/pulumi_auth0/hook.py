...
class HookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] secrets: The secrets associated with the hook.
        """
...
class Hook(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def dependencies(self) -> pulumi.Output[Optional[Mapping[str, _builtins.str]]]:
        """
        Dependencies of this hook used by the WebTask server.
        """
        return pulumi.get(self, "dependencies")
