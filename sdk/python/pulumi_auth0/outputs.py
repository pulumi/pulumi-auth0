...
__all__ = [
    ...
    'AttackProtectionCaptcha',
    'AttackProtectionCaptchaArkose',
    'AttackProtectionCaptchaAuthChallenge',
    'AttackProtectionCaptchaFriendlyCaptcha',
    ...
    'UserAttributeProfileUserAttributeStrategyOverride',
    'UserAttributeProfileUserAttributeStrategyOverrideOidcMapping',
    ...
    'GetAttackProtectionCaptchaResult',
    'GetAttackProtectionCaptchaArkoseResult',
    'GetAttackProtectionCaptchaAuthChallengeResult',
    'GetAttackProtectionCaptchaFriendlyCaptchaResult',
    ...
    'GetUserAttributeProfileUserAttributeStrategyOverrideResult',
    'GetUserAttributeProfileUserAttributeStrategyOverrideOidcMappingResult',
...
@pulumi.output_type
class AttackProtectionBotDetection(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "botDetectionLevel":
            suggest = "bot_detection_level"
        elif key == "challengePasswordPolicy":
            suggest = "challenge_password_policy"
        elif key == "challengePasswordResetPolicy":
            suggest = "challenge_password_reset_policy"
        elif key == "challengePasswordlessPolicy":
            suggest = "challenge_passwordless_policy"
        elif key == "monitoringModeEnabled":
            suggest = "monitoring_mode_enabled"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AttackProtectionBotDetection. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AttackProtectionBotDetection.__key_warning(key)
    ...
    def __init__(__self__, *,
                 ...
                 bot_detection_level: Optional[_builtins.str] = None,
                 challenge_password_policy: Optional[_builtins.str] = None,
                 challenge_password_reset_policy: Optional[_builtins.str] = None,
                 challenge_passwordless_policy: Optional[_builtins.str] = None,
        ...
        :param _builtins.bool monitoring_mode_enabled: Whether monitoring mode is enabled for bot detection.
        """
    ...
    def challenge_password_policy(self) -> Optional[_builtins.str]:
        """
    ...
    def challenge_password_reset_policy(self) -> Optional[_builtins.str]:
        """
    ...
    def challenge_passwordless_policy(self) -> Optional[_builtins.str]:
        """
    ...
    def monitoring_mode_enabled(self) -> Optional[_builtins.bool]:
        """
...
@pulumi.output_type
class AttackProtectionCaptcha(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "activeProviderId":
            suggest = "active_provider_id"
        elif key == "authChallenge":
            suggest = "auth_challenge"
        elif key == "friendlyCaptcha":
            suggest = "friendly_captcha"
        elif key == "recaptchaEnterprise":
            suggest = "recaptcha_enterprise"
        elif key == "recaptchaV2":
            suggest = "recaptcha_v2"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AttackProtectionCaptcha. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AttackProtectionCaptcha.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 active_provider_id: Optional[_builtins.str] = None,
                 arkose: Optional['outputs.AttackProtectionCaptchaArkose'] = None,
                 auth_challenge: Optional['outputs.AttackProtectionCaptchaAuthChallenge'] = None,
                 friendly_captcha: Optional['outputs.AttackProtectionCaptchaFriendlyCaptcha'] = None,
                 hcaptcha: Optional['outputs.AttackProtectionCaptchaHcaptcha'] = None,
                 recaptcha_enterprise: Optional['outputs.AttackProtectionCaptchaRecaptchaEnterprise'] = None,
                 recaptcha_v2: Optional['outputs.AttackProtectionCaptchaRecaptchaV2'] = None):
        """
        :param _builtins.str active_provider_id: Active CAPTCHA provider ID. Set to empty string to disable CAPTCHA. Possible values: `recaptcha_v2`, `recaptcha_enterprise`, `hcaptcha`, `friendly_captcha`, `arkose`, `auth_challenge`, `simple_captcha`.
        :param 'AttackProtectionCaptchaArkoseArgs' arkose: Configuration for Arkose Labs.
        :param 'AttackProtectionCaptchaAuthChallengeArgs' auth_challenge: Configuration for Auth0's Auth Challenge.
        :param 'AttackProtectionCaptchaFriendlyCaptchaArgs' friendly_captcha: Configuration for Friendly Captcha.
        :param 'AttackProtectionCaptchaHcaptchaArgs' hcaptcha: Configuration for hCaptcha.
        :param 'AttackProtectionCaptchaRecaptchaEnterpriseArgs' recaptcha_enterprise: Configuration for Google reCAPTCHA Enterprise.
        :param 'AttackProtectionCaptchaRecaptchaV2Args' recaptcha_v2: Configuration for Google reCAPTCHA v2.
        """
    ...
    def active_provider_id(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def arkose(self) -> Optional['outputs.AttackProtectionCaptchaArkose']:
        """
    ...
    def auth_challenge(self) -> Optional['outputs.AttackProtectionCaptchaAuthChallenge']:
        """
    ...
    def friendly_captcha(self) -> Optional['outputs.AttackProtectionCaptchaFriendlyCaptcha']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def hcaptcha(self) -> Optional['outputs.AttackProtectionCaptchaHcaptcha']:
        """
    ...
    def recaptcha_enterprise(self) -> Optional['outputs.AttackProtectionCaptchaRecaptchaEnterprise']:
        """
    ...
    def recaptcha_v2(self) -> Optional['outputs.AttackProtectionCaptchaRecaptchaV2']:
        """
...
@pulumi.output_type
class AttackProtectionCaptchaArkose(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "siteKey":
            suggest = "site_key"
        elif key == "clientSubdomain":
            suggest = "client_subdomain"
        elif key == "failOpen":
            suggest = "fail_open"
        elif key == "verifySubdomain":
            suggest = "verify_subdomain"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AttackProtectionCaptchaArkose. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AttackProtectionCaptchaArkose.__key_warning(key)
        return super().__getitem__(key)
    ...
    def client_subdomain(self) -> Optional[_builtins.str]:
        """
    ...
    def verify_subdomain(self) -> Optional[_builtins.str]:
        """
...
@pulumi.output_type
class AttackProtectionCaptchaAuthChallenge(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "failOpen":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AttackProtectionCaptchaAuthChallenge. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AttackProtectionCaptchaAuthChallenge.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 fail_open: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool fail_open: Whether the auth challenge should fail open.
        """
        if fail_open is not None:
            pulumi.set(__self__, "fail_open", fail_open)
...
@pulumi.output_type
class AttackProtectionCaptchaFriendlyCaptcha(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "siteKey":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AttackProtectionCaptchaFriendlyCaptcha. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AttackProtectionCaptchaFriendlyCaptcha.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class AttackProtectionCaptchaHcaptcha(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "siteKey":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AttackProtectionCaptchaHcaptcha. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AttackProtectionCaptchaHcaptcha.__key_warning(key)
        return super().__getitem__(key)
...
class AttackProtectionCaptchaRecaptchaEnterprise(dict):
    ...
    def __getitem__(self, key: str) -> Any:
        AttackProtectionCaptchaRecaptchaEnterprise.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class AttackProtectionCaptchaRecaptchaV2(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "siteKey":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AttackProtectionCaptchaRecaptchaV2. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AttackProtectionCaptchaRecaptchaV2.__key_warning(key)
        return super().__getitem__(key)
...
class LogStreamPiiConfig(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LogStreamPiiConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LogStreamPiiConfig.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 log_fields: Sequence[_builtins.str],
                 algorithm: Optional[_builtins.str] = None,
                 method: Optional[_builtins.str] = None):
        """
        :param _builtins.str algorithm: The algorithm to use for PII handling. Currently, only `xxhash` is supported.
        :param _builtins.str method: The method to use for PII handling. Options are `hash` or `mask`.
        """
    ...
    def log_fields(self) -> Sequence[_builtins.str]:
...
@pulumi.output_type
class UserAttributeProfileUserAttribute(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "auth0Mapping":
            suggest = "auth0_mapping"
        elif key == "profileRequired":
            suggest = "profile_required"
        elif key == "oidcMapping":
            suggest = "oidc_mapping"
        elif key == "samlMappings":
            suggest = "saml_mappings"
        elif key == "scimMapping":
            suggest = "scim_mapping"
        elif key == "strategyOverrides":
            suggest = "strategy_overrides"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in UserAttributeProfileUserAttribute. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        UserAttributeProfileUserAttribute.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 auth0_mapping: _builtins.str,
                 description: _builtins.str,
                 label: _builtins.str,
                 name: _builtins.str,
                 profile_required: _builtins.bool,
                 oidc_mapping: Optional['outputs.UserAttributeProfileUserAttributeOidcMapping'] = None,
                 saml_mappings: Optional[Sequence[_builtins.str]] = None,
                 scim_mapping: Optional[_builtins.str] = None,
                 strategy_overrides: Optional[Sequence['outputs.UserAttributeProfileUserAttributeStrategyOverride']] = None):
        """
        :param _builtins.str auth0_mapping: The Auth0 mapping for the user attribute.
        :param _builtins.str description: Description of the user attribute.
        :param _builtins.str label: Display label for the user attribute.
        :param _builtins.str name: Name of the user attribute.
        :param _builtins.bool profile_required: Whether the attribute is required in the profile.
        :param 'UserAttributeProfileUserAttributeOidcMappingArgs' oidc_mapping: The OIDC mapping configuration for the user attribute.
        :param Sequence[_builtins.str] saml_mappings: SAML mapping override for this strategy.
        :param _builtins.str scim_mapping: The SCIM mapping for the user attribute.
        :param Sequence['UserAttributeProfileUserAttributeStrategyOverrideArgs'] strategy_overrides: Strategy-specific overrides for user attribute mapping.
        """
    ...
    def auth0_mapping(self) -> _builtins.str:
        """
    ...
    def oidc_mapping(self) -> Optional['outputs.UserAttributeProfileUserAttributeOidcMapping']:
        """
    ...
    def saml_mappings(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def scim_mapping(self) -> Optional[_builtins.str]:
        """
    ...
    def strategy_overrides(self) -> Optional[Sequence['outputs.UserAttributeProfileUserAttributeStrategyOverride']]:
        """
...
@pulumi.output_type
class UserAttributeProfileUserAttributeOidcMapping(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "displayName":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in UserAttributeProfileUserAttributeOidcMapping. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        UserAttributeProfileUserAttributeOidcMapping.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str mapping: The OIDC mapping field.
        :param _builtins.str display_name: Display name for the OIDC mapping.
        """
...
@pulumi.output_type
class UserAttributeProfileUserAttributeStrategyOverride(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "oidcMapping":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in UserAttributeProfileUserAttributeStrategyOverride. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        UserAttributeProfileUserAttributeStrategyOverride.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 oidc_mapping: Optional['outputs.UserAttributeProfileUserAttributeStrategyOverrideOidcMapping'] = None,
                 saml_mappings: Optional[Sequence[_builtins.str]] = None,
                 scim_mapping: Optional[_builtins.str] = None):
        """
        :param _builtins.str strategy: The strategy name (e.g., 'oidc', 'samlp', 'ad', etc.).
        :param 'UserAttributeProfileUserAttributeStrategyOverrideOidcMappingArgs' oidc_mapping: OIDC mapping override for this strategy.
        :param Sequence[_builtins.str] saml_mappings: SAML mapping override for this strategy.
        :param _builtins.str scim_mapping: SCIM mapping override for this strategy.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="oidcMapping")
    def oidc_mapping(self) -> Optional['outputs.UserAttributeProfileUserAttributeStrategyOverrideOidcMapping']:
        """
...
@pulumi.output_type
class UserAttributeProfileUserAttributeStrategyOverrideOidcMapping(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "displayName":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in UserAttributeProfileUserAttributeStrategyOverrideOidcMapping. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        UserAttributeProfileUserAttributeStrategyOverrideOidcMapping.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class UserAttributeProfileUserId(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "oidcMapping":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in UserAttributeProfileUserId. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        UserAttributeProfileUserId.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 oidc_mapping: Optional[_builtins.str] = None,
                 saml_mappings: Optional[Sequence[_builtins.str]] = None,
                 scim_mapping: Optional[_builtins.str] = None,
                 strategy_overrides: Optional[Sequence['outputs.UserAttributeProfileUserIdStrategyOverride']] = None):
        """
        :param _builtins.str oidc_mapping: The OIDC mapping for the user ID.
        :param Sequence[_builtins.str] saml_mappings: The SAML mapping for the user ID.
        :param _builtins.str scim_mapping: The SCIM mapping for the user ID.
        :param Sequence['UserAttributeProfileUserIdStrategyOverrideArgs'] strategy_overrides: Strategy-specific overrides for user ID mapping.
        """
        if oidc_mapping is not None:
            pulumi.set(__self__, "oidc_mapping", oidc_mapping)
        if saml_mappings is not None:
    ...
    @_builtins.property
    @pulumi.getter(name="oidcMapping")
    def oidc_mapping(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="strategyOverrides")
    def strategy_overrides(self) -> Optional[Sequence['outputs.UserAttributeProfileUserIdStrategyOverride']]:
        """
...
@pulumi.output_type
class UserAttributeProfileUserIdStrategyOverride(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "oidcMapping":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in UserAttributeProfileUserIdStrategyOverride. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        UserAttributeProfileUserIdStrategyOverride.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str strategy: The strategy name (e.g., 'oidc', 'samlp', 'ad', etc.).
        :param _builtins.str oidc_mapping: OIDC mapping override for this strategy.
        :param Sequence[_builtins.str] saml_mappings: SAML mapping override for this strategy.
        :param _builtins.str scim_mapping: SCIM mapping override for this strategy.
        """
        pulumi.set(__self__, "strategy", strategy)
...
@pulumi.output_type
class GetAttackProtectionBotDetectionResult(dict):
    def __init__(__self__, *,
                 allowlists: Sequence[_builtins.str],
                 bot_detection_level: _builtins.str,
                 challenge_password_policy: _builtins.str,
                 challenge_password_reset_policy: _builtins.str,
                 challenge_passwordless_policy: _builtins.str,
    ...
    @_builtins.property
    @pulumi.getter(name="challengePasswordPolicy")
    def challenge_password_policy(self) -> _builtins.str:
        """
        Challenge policy for password flow. Possible values: `never`, `when_risky`, `always`.
        """
        return pulumi.get(self, "challenge_password_policy")
    ...
    @_builtins.property
    @pulumi.getter(name="challengePasswordResetPolicy")
    def challenge_password_reset_policy(self) -> _builtins.str:
        """
        Challenge policy for password reset flow. Possible values: `never`, `when_risky`, `always`.
        """
        return pulumi.get(self, "challenge_password_reset_policy")
    ...
    @_builtins.property
    @pulumi.getter(name="challengePasswordlessPolicy")
    def challenge_passwordless_policy(self) -> _builtins.str:
        """
        Challenge policy for passwordless flow. Possible values: `never`, `when_risky`, `always`.
        """
        return pulumi.get(self, "challenge_passwordless_policy")
    ...
    @_builtins.property
    @pulumi.getter(name="monitoringModeEnabled")
    def monitoring_mode_enabled(self) -> _builtins.bool:
        """
        Whether monitoring mode is enabled for bot detection.
        """
        return pulumi.get(self, "monitoring_mode_enabled")
...
@pulumi.output_type
class GetAttackProtectionCaptchaResult(dict):
    def __init__(__self__, *,
                 active_provider_id: _builtins.str,
                 arkoses: Sequence['outputs.GetAttackProtectionCaptchaArkoseResult'],
                 auth_challenges: Sequence['outputs.GetAttackProtectionCaptchaAuthChallengeResult'],
                 friendly_captchas: Sequence['outputs.GetAttackProtectionCaptchaFriendlyCaptchaResult'],
                 hcaptchas: Sequence['outputs.GetAttackProtectionCaptchaHcaptchaResult'],
                 recaptcha_enterprises: Sequence['outputs.GetAttackProtectionCaptchaRecaptchaEnterpriseResult'],
                 recaptcha_v2s: Sequence['outputs.GetAttackProtectionCaptchaRecaptchaV2Result']):
        """
        :param _builtins.str active_provider_id: Active CAPTCHA provider ID. Set to empty string to disable CAPTCHA. Possible values: `recaptcha_v2`, `recaptcha_enterprise`, `hcaptcha`, `friendly_captcha`, `arkose`, `auth_challenge`, `simple_captcha`.
        :param Sequence['GetAttackProtectionCaptchaArkoseArgs'] arkoses: Configuration for Arkose Labs.
        :param Sequence['GetAttackProtectionCaptchaAuthChallengeArgs'] auth_challenges: Configuration for Auth0's Auth Challenge.
        :param Sequence['GetAttackProtectionCaptchaFriendlyCaptchaArgs'] friendly_captchas: Configuration for Friendly Captcha.
        :param Sequence['GetAttackProtectionCaptchaHcaptchaArgs'] hcaptchas: Configuration for hCaptcha.
        :param Sequence['GetAttackProtectionCaptchaRecaptchaEnterpriseArgs'] recaptcha_enterprises: Configuration for Google reCAPTCHA Enterprise.
        :param Sequence['GetAttackProtectionCaptchaRecaptchaV2Args'] recaptcha_v2s: Configuration for Google reCAPTCHA v2.
        """
        pulumi.set(__self__, "active_provider_id", active_provider_id)
        pulumi.set(__self__, "arkoses", arkoses)
        pulumi.set(__self__, "auth_challenges", auth_challenges)
        pulumi.set(__self__, "friendly_captchas", friendly_captchas)
        pulumi.set(__self__, "hcaptchas", hcaptchas)
        pulumi.set(__self__, "recaptcha_enterprises", recaptcha_enterprises)
        pulumi.set(__self__, "recaptcha_v2s", recaptcha_v2s)

    @_builtins.property
    @pulumi.getter(name="activeProviderId")
    def active_provider_id(self) -> _builtins.str:
        """
        Active CAPTCHA provider ID. Set to empty string to disable CAPTCHA. Possible values: `recaptcha_v2`, `recaptcha_enterprise`, `hcaptcha`, `friendly_captcha`, `arkose`, `auth_challenge`, `simple_captcha`.
        """
        return pulumi.get(self, "active_provider_id")
    ...
    @_builtins.property
    @pulumi.getter
    def arkoses(self) -> Sequence['outputs.GetAttackProtectionCaptchaArkoseResult']:
        """
        Configuration for Arkose Labs.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="authChallenges")
    def auth_challenges(self) -> Sequence['outputs.GetAttackProtectionCaptchaAuthChallengeResult']:
        """
        Configuration for Auth0's Auth Challenge.
        """
        return pulumi.get(self, "auth_challenges")

    @_builtins.property
    @pulumi.getter(name="friendlyCaptchas")
    def friendly_captchas(self) -> Sequence['outputs.GetAttackProtectionCaptchaFriendlyCaptchaResult']:
        """
        Configuration for Friendly Captcha.
        """
        return pulumi.get(self, "friendly_captchas")

    @_builtins.property
    @pulumi.getter
    def hcaptchas(self) -> Sequence['outputs.GetAttackProtectionCaptchaHcaptchaResult']:
        """
        Configuration for hCaptcha.
        """
    ...
    def recaptcha_enterprises(self) -> Sequence['outputs.GetAttackProtectionCaptchaRecaptchaEnterpriseResult']:
        """
        Configuration for Google reCAPTCHA Enterprise.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="recaptchaV2s")
    def recaptcha_v2s(self) -> Sequence['outputs.GetAttackProtectionCaptchaRecaptchaV2Result']:
        """
        Configuration for Google reCAPTCHA v2.
        """
        return pulumi.get(self, "recaptcha_v2s")


@pulumi.output_type
class GetAttackProtectionCaptchaArkoseResult(dict):
    def __init__(__self__, *,
                 client_subdomain: _builtins.str,
                 fail_open: _builtins.bool,
                 secret: _builtins.str,
                 site_key: _builtins.str,
                 verify_subdomain: _builtins.str):
        """
        :param _builtins.str client_subdomain: Client subdomain for Arkose Labs.
        :param _builtins.bool fail_open: Whether the captcha should fail open.
        :param _builtins.str secret: Secret for Arkose Labs.
    ...
    @_builtins.property
    @pulumi.getter(name="clientSubdomain")
    def client_subdomain(self) -> _builtins.str:
        """
        Client subdomain for Arkose Labs.
        """
        return pulumi.get(self, "client_subdomain")
    ...
    @_builtins.property
    @pulumi.getter(name="verifySubdomain")
    def verify_subdomain(self) -> _builtins.str:
        """
        Verify subdomain for Arkose Labs.
        """
        return pulumi.get(self, "verify_subdomain")
...
@pulumi.output_type
class GetAttackProtectionCaptchaAuthChallengeResult(dict):
    def __init__(__self__, *,
                 fail_open: _builtins.bool):
        """
        :param _builtins.bool fail_open: Whether the auth challenge should fail open.
...
@pulumi.output_type
class GetAttackProtectionCaptchaFriendlyCaptchaResult(dict):
    def __init__(__self__, *,
                 secret: _builtins.str,
                 site_key: _builtins.str):
        """
...
@pulumi.output_type
class GetAttackProtectionCaptchaHcaptchaResult(dict):
    def __init__(__self__, *,
                 secret: _builtins.str,
                 site_key: _builtins.str):
        """
...
@pulumi.output_type
class GetAttackProtectionCaptchaRecaptchaEnterpriseResult(dict):
    def __init__(__self__, *,
                 api_key: _builtins.str,
                 project_id: _builtins.str,
                 site_key: _builtins.str):
...
@pulumi.output_type
class GetAttackProtectionCaptchaRecaptchaV2Result(dict):
    def __init__(__self__, *,
                 secret: _builtins.str,
                 site_key: _builtins.str):
        """
...
@pulumi.output_type
class GetOutboundIpsChangelogResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action: Type of change (add or remove).
        :param _builtins.str date: Date of the change (YYYY-MM-DD format).
        :param Sequence[_builtins.str] ipv4_cidrs: List of IPv4 CIDR blocks affected by this change.
        :param _builtins.str region: Region affected by the change.
        """
        pulumi.set(__self__, "action", action)
...
@pulumi.output_type
class GetOutboundIpsRegionResult(dict):
    def __init__(__self__, *,
                 ipv4_cidrs: Sequence[_builtins.str],
                 region: _builtins.str):
        """
        :param Sequence[_builtins.str] ipv4_cidrs: A list of IPv4 CIDR blocks for the region.
        :param _builtins.str region: The code for the region (e.g., 'US', 'CA').
        """
        pulumi.set(__self__, "ipv4_cidrs", ipv4_cidrs)
        pulumi.set(__self__, "region", region)
...
@pulumi.output_type
class GetUserAttributeProfileUserAttributeResult(dict):
    def __init__(__self__, *,
                 auth0_mapping: _builtins.str,
                 description: _builtins.str,
                 label: _builtins.str,
                 name: _builtins.str,
                 oidc_mappings: Sequence['outputs.GetUserAttributeProfileUserAttributeOidcMappingResult'],
                 profile_required: _builtins.bool,
                 saml_mappings: Sequence[_builtins.str],
                 scim_mapping: _builtins.str,
                 strategy_overrides: Sequence['outputs.GetUserAttributeProfileUserAttributeStrategyOverrideResult']):
        """
        :param _builtins.str auth0_mapping: The Auth0 mapping for the user attribute.
        :param _builtins.str description: Description of the user attribute.
        :param _builtins.str label: Display label for the user attribute.
        :param _builtins.str name: Name of the user attribute.
        :param Sequence['GetUserAttributeProfileUserAttributeOidcMappingArgs'] oidc_mappings: The OIDC mapping configuration for the user attribute.
        :param _builtins.bool profile_required: Whether the attribute is required in the profile.
        :param Sequence[_builtins.str] saml_mappings: SAML mapping override for this strategy.
        :param _builtins.str scim_mapping: The SCIM mapping for the user attribute.
        :param Sequence['GetUserAttributeProfileUserAttributeStrategyOverrideArgs'] strategy_overrides: Strategy-specific overrides for user attribute mapping.
        """
        pulumi.set(__self__, "auth0_mapping", auth0_mapping)
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "label", label)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "oidc_mappings", oidc_mappings)
        pulumi.set(__self__, "profile_required", profile_required)
        pulumi.set(__self__, "saml_mappings", saml_mappings)
        pulumi.set(__self__, "scim_mapping", scim_mapping)
        pulumi.set(__self__, "strategy_overrides", strategy_overrides)
    ...
    @_builtins.property
    @pulumi.getter(name="oidcMappings")
    def oidc_mappings(self) -> Sequence['outputs.GetUserAttributeProfileUserAttributeOidcMappingResult']:
        """
        The OIDC mapping configuration for the user attribute.
        """
        return pulumi.get(self, "oidc_mappings")
    ...
    @_builtins.property
    @pulumi.getter(name="samlMappings")
    def saml_mappings(self) -> Sequence[_builtins.str]:
        """
        SAML mapping override for this strategy.
        """
        return pulumi.get(self, "saml_mappings")
    ...
    @_builtins.property
    @pulumi.getter(name="scimMapping")
    def scim_mapping(self) -> _builtins.str:
        """
        The SCIM mapping for the user attribute.
        """
        return pulumi.get(self, "scim_mapping")
    ...
    @_builtins.property
    @pulumi.getter(name="strategyOverrides")
    def strategy_overrides(self) -> Sequence['outputs.GetUserAttributeProfileUserAttributeStrategyOverrideResult']:
        """
        Strategy-specific overrides for user attribute mapping.
        """
        return pulumi.get(self, "strategy_overrides")
...
@pulumi.output_type
class GetUserAttributeProfileUserAttributeOidcMappingResult(dict):
    def __init__(__self__, *,
                 display_name: _builtins.str,
                 mapping: _builtins.str):
        """
...
@pulumi.output_type
class GetUserAttributeProfileUserAttributeStrategyOverrideResult(dict):
    def __init__(__self__, *,
                 oidc_mappings: Sequence['outputs.GetUserAttributeProfileUserAttributeStrategyOverrideOidcMappingResult'],
                 saml_mappings: Sequence[_builtins.str],
                 scim_mapping: _builtins.str,
                 strategy: _builtins.str):
        """
        :param Sequence['GetUserAttributeProfileUserAttributeStrategyOverrideOidcMappingArgs'] oidc_mappings: OIDC mapping override for this strategy.
        :param Sequence[_builtins.str] saml_mappings: SAML mapping override for this strategy.
        :param _builtins.str scim_mapping: SCIM mapping override for this strategy.
        :param _builtins.str strategy: The strategy name (e.g., 'oidc', 'samlp', 'ad', etc.).
        """
    ...
    @_builtins.property
    @pulumi.getter(name="oidcMappings")
    def oidc_mappings(self) -> Sequence['outputs.GetUserAttributeProfileUserAttributeStrategyOverrideOidcMappingResult']:
        """
        OIDC mapping override for this strategy.
        """
        return pulumi.get(self, "oidc_mappings")
...
@pulumi.output_type
class GetUserAttributeProfileUserAttributeStrategyOverrideOidcMappingResult(dict):
    def __init__(__self__, *,
                 display_name: _builtins.str,
                 mapping: _builtins.str):
        """
...
@pulumi.output_type
class GetUserAttributeProfileUserIdResult(dict):
    def __init__(__self__, *,
                 oidc_mapping: _builtins.str,
                 saml_mappings: Sequence[_builtins.str],
                 scim_mapping: _builtins.str,
                 strategy_overrides: Sequence['outputs.GetUserAttributeProfileUserIdStrategyOverrideResult']):
        """
        :param _builtins.str oidc_mapping: The OIDC mapping for the user ID.
        :param Sequence[_builtins.str] saml_mappings: The SAML mapping for the user ID.
        :param _builtins.str scim_mapping: The SCIM mapping for the user ID.
        :param Sequence['GetUserAttributeProfileUserIdStrategyOverrideArgs'] strategy_overrides: Strategy-specific overrides for user ID mapping.
        """
        pulumi.set(__self__, "oidc_mapping", oidc_mapping)
        pulumi.set(__self__, "saml_mappings", saml_mappings)
        pulumi.set(__self__, "scim_mapping", scim_mapping)
    ...
    @_builtins.property
    @pulumi.getter(name="oidcMapping")
    def oidc_mapping(self) -> _builtins.str:
        """
        The OIDC mapping for the user ID.
        """
        return pulumi.get(self, "oidc_mapping")
    ...
    @_builtins.property
    @pulumi.getter(name="strategyOverrides")
    def strategy_overrides(self) -> Sequence['outputs.GetUserAttributeProfileUserIdStrategyOverrideResult']:
        """
        Strategy-specific overrides for user ID mapping.
        """
        return pulumi.get(self, "strategy_overrides")
...
@pulumi.output_type
class GetUserAttributeProfileUserIdStrategyOverrideResult(dict):
    def __init__(__self__, *,
                 oidc_mapping: _builtins.str,
                 saml_mappings: Sequence[_builtins.str],
                 scim_mapping: _builtins.str,
