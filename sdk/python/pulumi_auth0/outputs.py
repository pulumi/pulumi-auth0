...
class ActionDependency(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Dependency name, e.g. `lodash`.
        :param builtins.str version: Dependency version, e.g. `latest` or `4.17.21`.
        """
...
class ActionSupportedTriggers(dict):
    def __init__(__self__, *,
                 ...
                 version: builtins.str):
        """
        :param builtins.str id: The trigger ID.
        :param builtins.str version: The trigger version. This regulates which `runtime` versions are supported.
        """
...
class AttackProtectionBreachedPasswordDetection(dict):
    ...
    def admin_notification_frequencies(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AttackProtectionBreachedPasswordDetectionPreUserRegistration(dict):
    def __init__(__self__, *,
                 shields: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] shields: Action to take when a breached password is detected during a signup. Possible values: `block` (block compromised credentials for new accounts), `admin_notification` (send an email notification with a summary of compromised credentials in new accounts).
        """
        if shields is not None:
            pulumi.set(__self__, "shields", shields)
...
class AttackProtectionBruteForceProtection(dict):
    ...
    def __init__(__self__, *,
                 enabled: builtins.bool,
                 allowlists: Optional[Sequence[builtins.str]] = None,
                 max_attempts: Optional[builtins.int] = None,
                 mode: Optional[builtins.str] = None,
                 shields: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool enabled: Whether brute force attack protections are active.
        :param Sequence[builtins.str] allowlists: List of trusted IP addresses that will not have attack protection enforced against them. This field allows you to specify multiple IP addresses, or ranges. You can use IPv4 or IPv6 addresses and CIDR notation.
        :param builtins.int max_attempts: Maximum number of consecutive failed login attempts from a single user before blocking is triggered. Only available on public tenants.
        :param builtins.str mode: Determines whether the IP address is used when counting failed attempts. Possible values: `count_per_identifier_and_ip` (lockout an account from a given IP Address) or `count_per_identifier` (lockout an account regardless of IP Address).
        :param Sequence[builtins.str] shields: Action to take when a brute force protection threshold is violated. Possible values: `block` (block login attempts for a flagged user account), `user_notification` (send an email to user when their account has been blocked).
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    @property
    @pulumi.getter
    def allowlists(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AttackProtectionSuspiciousIpThrottling(dict):
    ...
    def __init__(__self__, *,
                 ...
                 shields: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool enabled: Whether suspicious IP throttling attack protections are active.
        :param Sequence[builtins.str] allowlists: List of trusted IP addresses that will not have attack protection enforced against them. This field allows you to specify multiple IP addresses, or ranges. You can use IPv4 or IPv6 addresses and CIDR notation.
...
class AttackProtectionSuspiciousIpThrottlingPreLogin(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_attempts: The maximum number of failed login attempts allowed from a single IP address.
        :param builtins.int rate: Interval of time, given in milliseconds at which new login tokens will become available after they have been used by an IP address. Each login attempt will be added on the defined throttling rate.
        """
        if max_attempts is not None:
            pulumi.set(__self__, "max_attempts", max_attempts)
        if rate is not None:
...
class AttackProtectionSuspiciousIpThrottlingPreUserRegistration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rate: Optional[builtins.int] = None):
        """
        :param builtins.int max_attempts: The maximum number of sign up attempts allowed from a single IP address.
        :param builtins.int rate: Interval of time, given in milliseconds at which new sign up tokens will become available after they have been used by an IP address. Each sign up attempt will be added on the defined throttling rate.
        """
        if max_attempts is not None:
            pulumi.set(__self__, "max_attempts", max_attempts)
        if rate is not None:
...
class BrandingColors(dict):
    ...
    def __init__(__self__, *,
                 page_background: Optional[builtins.str] = None,
                 primary: Optional[builtins.str] = None):
        """
        :param builtins.str page_background: Background color of login pages in hexadecimal.
        :param builtins.str primary: Primary button background color in hexadecimal.
        """
    ...
    def page_background(self) -> Optional[builtins.str]:
        """
...
class BrandingThemeBorders(dict):
    ...
    def __init__(__self__, *,
                 button_border_radius: Optional[builtins.float] = None,
                 button_border_weight: Optional[builtins.float] = None,
                 buttons_style: Optional[builtins.str] = None,
                 input_border_radius: Optional[builtins.float] = None,
                 input_border_weight: Optional[builtins.float] = None,
                 inputs_style: Optional[builtins.str] = None,
                 show_widget_shadow: Optional[builtins.bool] = None,
                 widget_border_weight: Optional[builtins.float] = None,
                 widget_corner_radius: Optional[builtins.float] = None):
        """
        :param builtins.float button_border_radius: Button border radius. Value needs to be between `1` and `10`. Defaults to `3.0`.
        :param builtins.float button_border_weight: Button border weight. Value needs to be between `0` and `10`. Defaults to `1.0`.
        :param builtins.str buttons_style: Buttons style. Available options: `pill`, `rounded`, `sharp`. Defaults to `rounded`.
        :param builtins.float input_border_radius: Input border radius. Value needs to be between `0` and `10`. Defaults to `3.0`.
        :param builtins.float input_border_weight: Input border weight. Value needs to be between `0` and `3`. Defaults to `1.0`.
        :param builtins.str inputs_style: Inputs style. Available options: `pill`, `rounded`, `sharp`. Defaults to `rounded`.
        :param builtins.bool show_widget_shadow: Show widget shadow. Defaults to `true`.
        :param builtins.float widget_border_weight: Widget border weight. Value needs to be between `0` and `10`. Defaults to `0.0`.
        :param builtins.float widget_corner_radius: Widget corner radius. Value needs to be between `0` and `50`. Defaults to `5.0`.
        """
    ...
    def button_border_radius(self) -> Optional[builtins.float]:
        """
    ...
    def button_border_weight(self) -> Optional[builtins.float]:
        """
    ...
    def buttons_style(self) -> Optional[builtins.str]:
        """
    ...
    def input_border_radius(self) -> Optional[builtins.float]:
        """
    ...
    def input_border_weight(self) -> Optional[builtins.float]:
        """
    ...
    def inputs_style(self) -> Optional[builtins.str]:
        """
    ...
    def show_widget_shadow(self) -> Optional[builtins.bool]:
        """
    ...
    def widget_border_weight(self) -> Optional[builtins.float]:
        """
    ...
    def widget_corner_radius(self) -> Optional[builtins.float]:
        """
...
class BrandingThemeColors(dict):
    ...
    def __init__(__self__, *,
                 base_focus_color: Optional[builtins.str] = None,
                 base_hover_color: Optional[builtins.str] = None,
                 body_text: Optional[builtins.str] = None,
                 captcha_widget_theme: Optional[builtins.str] = None,
                 error: Optional[builtins.str] = None,
                 header: Optional[builtins.str] = None,
                 icons: Optional[builtins.str] = None,
                 input_background: Optional[builtins.str] = None,
                 input_border: Optional[builtins.str] = None,
                 input_filled_text: Optional[builtins.str] = None,
                 input_labels_placeholders: Optional[builtins.str] = None,
                 links_focused_components: Optional[builtins.str] = None,
                 primary_button: Optional[builtins.str] = None,
                 primary_button_label: Optional[builtins.str] = None,
                 secondary_button_border: Optional[builtins.str] = None,
                 secondary_button_label: Optional[builtins.str] = None,
                 success: Optional[builtins.str] = None,
                 widget_background: Optional[builtins.str] = None,
                 widget_border: Optional[builtins.str] = None):
        """
        :param builtins.str base_focus_color: Base focus color. Defaults to `#635dff`.
        :param builtins.str base_hover_color: Base hover color. Defaults to `#000000`.
        :param builtins.str body_text: Body text. Defaults to `#1e212a`.
        :param builtins.str captcha_widget_theme: Captcha Widget Theme.
        :param builtins.str error: Error. Defaults to `#d03c38`.
        :param builtins.str header: Header. Defaults to `#1e212a`.
        :param builtins.str icons: Icons. Defaults to `#65676e`.
        :param builtins.str input_background: Input background. Defaults to `#ffffff`.
        :param builtins.str input_border: Input border. Defaults to `#c9cace`.
        :param builtins.str input_filled_text: Input filled text. Defaults to `#000000`.
        :param builtins.str input_labels_placeholders: Input labels & placeholders. Defaults to `#65676e`.
        :param builtins.str links_focused_components: Links & focused components. Defaults to `#635dff`.
        :param builtins.str primary_button: Primary button. Defaults to `#635dff`.
        :param builtins.str primary_button_label: Primary button label. Defaults to `#ffffff`.
        :param builtins.str secondary_button_border: Secondary button border. Defaults to `#c9cace`.
        :param builtins.str secondary_button_label: Secondary button label. Defaults to `#1e212a`.
        :param builtins.str success: Success. Defaults to `#13a688`.
        :param builtins.str widget_background: Widget background. Defaults to `#ffffff`.
        :param builtins.str widget_border: Widget border. Defaults to `#c9cace`.
        """
    ...
    def base_focus_color(self) -> Optional[builtins.str]:
        """
    ...
    def base_hover_color(self) -> Optional[builtins.str]:
        """
    ...
    def body_text(self) -> Optional[builtins.str]:
        """
    ...
    def captcha_widget_theme(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def icons(self) -> Optional[builtins.str]:
        """
    ...
    def input_background(self) -> Optional[builtins.str]:
        """
    ...
    def input_border(self) -> Optional[builtins.str]:
        """
    ...
    def input_filled_text(self) -> Optional[builtins.str]:
        """
    ...
    def input_labels_placeholders(self) -> Optional[builtins.str]:
        """
    ...
    def links_focused_components(self) -> Optional[builtins.str]:
        """
    ...
    def primary_button(self) -> Optional[builtins.str]:
        """
    ...
    def primary_button_label(self) -> Optional[builtins.str]:
        """
    ...
    def secondary_button_border(self) -> Optional[builtins.str]:
        """
    ...
    def secondary_button_label(self) -> Optional[builtins.str]:
        """
    ...
    def widget_background(self) -> Optional[builtins.str]:
        """
    ...
    def widget_border(self) -> Optional[builtins.str]:
        """
...
class BrandingThemeFonts(dict):
    ...
    def __init__(__self__, *,
                 ...
                 links_style: Optional[builtins.str] = None,
                 reference_text_size: Optional[builtins.float] = None):
        """
        ...
        :param builtins.str font_url: Font URL. Defaults to an empty string.
        :param builtins.str links_style: Links style. Defaults to `normal`.
        :param builtins.float reference_text_size: Reference text size. Value needs to be between `12` and `24`. Defaults to `16.0`.
        """
        pulumi.set(__self__, "body_text", body_text)
    ...
    def links_style(self) -> Optional[builtins.str]:
        """
    ...
    def reference_text_size(self) -> Optional[builtins.float]:
        """
...
class BrandingThemeFontsBodyText(dict):
    def __init__(__self__, *,
                 bold: Optional[builtins.bool] = None,
                 size: Optional[builtins.float] = None):
        """
        :param builtins.bool bold: Body text bold. Defaults to `false`.
        :param builtins.float size: Body text size. Value needs to be between `0` and `150`. Defaults to `87.5`.
        """
        if bold is not None:
    ...
    @property
    @pulumi.getter
    def bold(self) -> Optional[builtins.bool]:
        """
...
class BrandingThemeFontsButtonsText(dict):
    def __init__(__self__, *,
                 ...
                 size: Optional[builtins.float] = None):
        """
        :param builtins.bool bold: Buttons text bold. Defaults to `false`.
        :param builtins.float size: Buttons text size. Value needs to be between `0` and `150`. Defaults to `100.0`.
        """
        if bold is not None:
            pulumi.set(__self__, "bold", bold)
        if size is not None:
...
class BrandingThemeFontsInputLabels(dict):
    def __init__(__self__, *,
                 ...
                 size: Optional[builtins.float] = None):
        """
        :param builtins.bool bold: Input labels bold. Defaults to `false`.
        :param builtins.float size: Input labels size. Value needs to be between `0` and `150`. Defaults to `100.0`.
        """
        if bold is not None:
            pulumi.set(__self__, "bold", bold)
        if size is not None:
...
class BrandingThemeFontsLinks(dict):
    def __init__(__self__, *,
                 ...
                 size: Optional[builtins.float] = None):
        """
        :param builtins.bool bold: Links bold. Defaults to `true`.
        :param builtins.float size: Links size. Value needs to be between `0` and `150`. Defaults to `87.5`.
        """
        if bold is not None:
            pulumi.set(__self__, "bold", bold)
        if size is not None:
...
class BrandingThemeFontsSubtitle(dict):
    def __init__(__self__, *,
                 ...
                 size: Optional[builtins.float] = None):
        """
        :param builtins.bool bold: Subtitle bold. Defaults to `false`.
        :param builtins.float size: Subtitle size. Value needs to be between `0` and `150`. Defaults to `87.5`.
        """
        if bold is not None:
            pulumi.set(__self__, "bold", bold)
        if size is not None:
...
class BrandingThemeFontsTitle(dict):
    def __init__(__self__, *,
                 ...
                 size: Optional[builtins.float] = None):
        """
        :param builtins.bool bold: Title bold. Defaults to `false`.
        :param builtins.float size: Title size. Value needs to be between `75` and `150`. Defaults to `150.0`.
        """
        if bold is not None:
            pulumi.set(__self__, "bold", bold)
        if size is not None:
...
class BrandingThemePageBackground(dict):
    ...
    def __init__(__self__, *,
                 ...
                 background_image_url: Optional[builtins.str] = None,
                 page_layout: Optional[builtins.str] = None):
        """
        :param builtins.str background_color: Background color. Defaults to `#000000`.
        :param builtins.str background_image_url: Background image url. Defaults to an empty string.
        :param builtins.str page_layout: Page layout. Available options: `center`, `left`, `right`. Defaults to `center`.
        """
    ...
    def background_image_url(self) -> Optional[builtins.str]:
        """
    ...
    def page_layout(self) -> Optional[builtins.str]:
        """
...
class BrandingThemeWidget(dict):
    ...
    def __init__(__self__, *,
                 header_text_alignment: Optional[builtins.str] = None,
                 logo_height: Optional[builtins.float] = None,
                 logo_position: Optional[builtins.str] = None,
                 logo_url: Optional[builtins.str] = None,
                 social_buttons_layout: Optional[builtins.str] = None):
        """
        :param builtins.str header_text_alignment: Header text alignment. Available options: `center`, `left`, `right`. Defaults to `center`.
        :param builtins.float logo_height: Logo height. Value needs to be between `1` and `100`. Defaults to `52.0`.
        :param builtins.str logo_position: Logo position. Available options: `center`, `left`, `right`, `none`. Defaults to `center`.
        :param builtins.str logo_url: Logo url. Defaults to an empty string.
        :param builtins.str social_buttons_layout: Social buttons layout. Available options: `bottom`, `top`. Defaults to `bottom`.
        """
    ...
    def header_text_alignment(self) -> Optional[builtins.str]:
        """
    ...
    def logo_height(self) -> Optional[builtins.float]:
        """
    ...
    def logo_position(self) -> Optional[builtins.str]:
        """
    ...
    def social_buttons_layout(self) -> Optional[builtins.str]:
        """
...
class BrandingUniversalLogin(dict):
    def __init__(__self__, *,
                 body: builtins.str):
        """
        :param builtins.str body: The html template for the New Universal Login Experience.
        """
...
class ClientAddonsAws(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int lifetime_in_seconds: AWS token lifetime in seconds.
        :param builtins.str principal: AWS principal ARN, for example `arn:aws:iam::010616021751:saml-provider/idpname`.
        :param builtins.str role: AWS role ARN, for example `arn:aws:iam::010616021751:role/foo`.
        """
    ...
    def lifetime_in_seconds(self) -> Optional[builtins.int]:
        """
...
class ClientAddonsAzureBlob(dict):
    ...
    def __init__(__self__, *,
                 ...
                 blob_delete: Optional[builtins.bool] = None,
                 blob_name: Optional[builtins.str] = None,
                 blob_read: Optional[builtins.bool] = None,
                 blob_write: Optional[builtins.bool] = None,
                 container_delete: Optional[builtins.bool] = None,
                 container_list: Optional[builtins.bool] = None,
                 container_name: Optional[builtins.str] = None,
                 container_read: Optional[builtins.bool] = None,
                 container_write: Optional[builtins.bool] = None,
                 expiration: Optional[builtins.int] = None,
                 signed_identifier: Optional[builtins.str] = None,
                 storage_access_key: Optional[builtins.str] = None):
        """
        :param builtins.str account_name: Your Azure storage account name. Usually first segment in your Azure storage URL, for example `https://acme-org.blob.core.windows.net` would be the account name `acme-org`.
        :param builtins.bool blob_delete: Indicates if the issued token has permission to delete the blob.
        :param builtins.str blob_name: Entity to request a token for, such as `my-blob`. If blank the computed SAS will apply to the entire storage container.
        :param builtins.bool blob_read: Indicates if the issued token has permission to read the content, properties, metadata and block list. Use the blob as the source of a copy operation.
        :param builtins.bool blob_write: Indicates if the issued token has permission to create or write content, properties, metadata, or block list. Snapshot or lease the blob. Resize the blob (page blob only). Use the blob as the destination of a copy operation within the same account.
        :param builtins.bool container_delete: Indicates if issued token has permission to delete any blob in the container.
        :param builtins.bool container_list: Indicates if the issued token has permission to list blobs in the container.
        :param builtins.str container_name: Container to request a token for, such as `my-container`.
        :param builtins.bool container_read: Indicates if the issued token has permission to read the content, properties, metadata or block list of any blob in the container. Use any blob in the container as the source of a copy operation.
        :param builtins.bool container_write: Indicates that for any blob in the container if the issued token has permission to create or write content, properties, metadata, or block list. Snapshot or lease the blob. Resize the blob (page blob only). Use the blob as the destination of a copy operation within the same account.
        :param builtins.int expiration: Expiration in minutes for the generated token (default of 5 minutes).
        :param builtins.str signed_identifier: Shared access policy identifier defined in your storage account resource.
        :param builtins.str storage_access_key: Access key associated with this storage account.
        """
    ...
    def blob_delete(self) -> Optional[builtins.bool]:
        """
    ...
    def blob_name(self) -> Optional[builtins.str]:
        """
    ...
    def blob_read(self) -> Optional[builtins.bool]:
        """
    ...
    def blob_write(self) -> Optional[builtins.bool]:
        """
    ...
    def container_delete(self) -> Optional[builtins.bool]:
        """
    ...
    def container_list(self) -> Optional[builtins.bool]:
        """
    ...
    def container_read(self) -> Optional[builtins.bool]:
        """
    ...
    def container_write(self) -> Optional[builtins.bool]:
        """
    ...
    def signed_identifier(self) -> Optional[builtins.str]:
        """
    ...
    def storage_access_key(self) -> Optional[builtins.str]:
        """
...
class ClientAddonsAzureSb(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sas_key_name: Optional[builtins.str] = None):
        """
        :param builtins.str entity_path: Entity you want to request a token for, such as `my-queue`.
        :param builtins.int expiration: Optional expiration in minutes for the generated token. Defaults to 5 minutes.
        :param builtins.str namespace: Your Azure Service Bus namespace. Usually the first segment of your Service Bus URL (for example `https://acme-org.servicebus.windows.net` would be `acme-org`).
        :param builtins.str sas_key: Primary Key associated with your shared access policy.
        :param builtins.str sas_key_name: Your shared access policy name defined in your Service Bus entity.
        """
    ...
    def sas_key_name(self) -> Optional[builtins.str]:
        """
...
class ClientAddonsEchosign(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str domain: Your custom domain found in your EchoSign URL, for example `https://acme-org.echosign.com` would be `acme-org`.
        """
...
class ClientAddonsEgnyte(dict):
    def __init__(__self__, *,
                 domain: Optional[builtins.str] = None):
        """
        :param builtins.str domain: Your custom domain found in your Egnyte URL, for example `https://acme-org.echosign.com` would be `acme-org`.
        """
        if domain is not None:
            pulumi.set(__self__, "domain", domain)
...
class ClientAddonsFirebase(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str client_email: ID of the Service Account you have created (shown as `client_email` in the generated JSON file, SDK v3+ tokens only).
        :param builtins.int lifetime_in_seconds: Optional expiration in seconds for the generated token. Defaults to 3600 seconds (SDK v3+ tokens only).
        :param builtins.str private_key: Private Key for signing the token (SDK v3+ tokens only).
        :param builtins.str private_key_id: Optional ID of the private key to obtain the `kid` header claim from the issued token (SDK v3+ tokens only).
        :param builtins.str secret: Google Firebase Secret. (SDK v2 only).
        """
...
class ClientAddonsLayer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 principal: Optional[builtins.str] = None):
        """
        :param builtins.str key_id: Authentication Key identifier used to sign the Layer token.
        :param builtins.str private_key: Private key for signing the Layer token.
        :param builtins.str provider_id: Provider ID of your Layer account.
        :param builtins.int expiration: Optional expiration in minutes for the generated token. Defaults to 5 minutes.
        :param builtins.str principal: Name of the property used as the unique user ID in Layer. If not specified `user_id` is used.
        """
...
class ClientAddonsMscrm(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str url: Microsoft Dynamics CRM application URL.
        """
        if url is not None:
            pulumi.set(__self__, "url", url)
...
class ClientAddonsNewrelic(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str account: Your New Relic Account ID found in your New Relic URL after the `/accounts/` path, for example `https://rpm.newrelic.com/accounts/123456/query` would be `123456`.
        """
...
class ClientAddonsOffice365(dict):
    def __init__(__self__, *,
                 ...
                 domain: Optional[builtins.str] = None):
        """
        :param builtins.str connection: Optional Auth0 database connection for testing an already-configured Office 365 tenant.
        :param builtins.str domain: Your Office 365 domain name, for example `acme-org.com`.
        """
...
class ClientAddonsRms(dict):
    def __init__(__self__, *,
                 url: Optional[builtins.str] = None):
        """
        :param builtins.str url: URL of your Rights Management Server. It can be internal or external, but users will have to be able to reach it.
        """
        if url is not None:
            pulumi.set(__self__, "url", url)
...
class ClientAddonsSalesforce(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str entity_id: Arbitrary logical URL that identifies the Saleforce resource, for example `https://acme-org.com`.
        """
...
class ClientAddonsSalesforceApi(dict):
    ...
    def __init__(__self__, *,
                 ...
                 community_url_section: Optional[builtins.str] = None,
                 principal: Optional[builtins.str] = None):
        """
        :param builtins.str client_id: Consumer Key assigned by Salesforce to the Connected App.
        :param builtins.str community_name: Community name.
        :param builtins.str community_url_section: Community URL section.
        :param builtins.str principal: Name of the property in the user object that maps to a Salesforce username, for example `email`.
        """
    ...
    def community_url_section(self) -> Optional[builtins.str]:
        """
...
class ClientAddonsSamlp(dict):
    ...
    def __init__(__self__, *,
                 ...
                 authn_context_class_ref: Optional[builtins.str] = None,
                 binding: Optional[builtins.str] = None,
                 ...
                 map_identities: Optional[builtins.bool] = None,
                 map_unknown_claims_as_is: Optional[builtins.bool] = None,
                 mappings: Optional[Mapping[str, builtins.str]] = None,
                 name_identifier_format: Optional[builtins.str] = None,
                 name_identifier_probes: Optional[Sequence[builtins.str]] = None,
                 passthrough_claims_with_no_mapping: Optional[builtins.bool] = None,
                 recipient: Optional[builtins.str] = None,
                 sign_response: Optional[builtins.bool] = None,
                 signature_algorithm: Optional[builtins.str] = None,
                 signing_cert: Optional[builtins.str] = None,
                 typed_attributes: Optional[builtins.bool] = None):
        """
        :param builtins.str audience: Audience of the SAML Assertion. Default will be the Issuer on SAMLRequest.
        :param builtins.str authn_context_class_ref: Class reference of the authentication context.
        :param builtins.str binding: Protocol binding used for SAML logout responses.
        ...
        :param builtins.bool map_identities: Indicates whether or not to add additional identity information in the token, such as the provider used and the `access_token`, if available. Defaults to `true`.
        :param builtins.bool map_unknown_claims_as_is: Indicates whether to add a prefix of `http://schema.auth0.com` to any claims that are not mapped to the common profile when passed through in the output assertion. Defaults to `false`.
        :param Mapping[str, builtins.str] mappings: Mappings between the Auth0 user profile property name (`name`) and the output attributes on the SAML attribute in the assertion (`value`).
        :param builtins.str name_identifier_format: Format of the name identifier. Defaults to `urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified`.
        :param Sequence[builtins.str] name_identifier_probes: Attributes that can be used for Subject/NameID. Auth0 will try each of the attributes of this array in order and use the first value it finds.
        :param builtins.bool passthrough_claims_with_no_mapping: Indicates whether or not to passthrough claims that are not mapped to the common profile in the output assertion. Defaults to `true`.
        :param builtins.str recipient: Recipient of the SAML Assertion (SubjectConfirmationData). Default is `AssertionConsumerUrl` on SAMLRequest or callback URL if no SAMLRequest was sent.
        :param builtins.bool sign_response: Indicates whether or not the SAML Response should be signed instead of the SAML Assertion.
        :param builtins.str signature_algorithm: Algorithm used to sign the SAML Assertion or response. Options include `rsa-sha1` and `rsa-sha256`. Defaults to `rsa-sha1`.
        :param builtins.str signing_cert: Optionally indicates the public key certificate used to validate SAML requests. If set, SAML requests will be required to be signed. A sample value would be `-----BEGIN PUBLIC KEY-----\\nMIGf...bpP/t3\\n+JGNGIRMj1hF1rnb6QIDAQAB\\n-----END PUBLIC KEY-----\\n`.
        :param builtins.bool typed_attributes: Indicates whether or not we should infer the `xs:type` of the element. Types include `xs:string`, `xs:boolean`, `xs:double`, and `xs:anyType`. When set to `false`, all `xs:type` are `xs:anyType`. Defaults to `true`.
        """
    ...
    def authn_context_class_ref(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def binding(self) -> Optional[builtins.str]:
        """
    ...
    def create_upn_claim(self) -> Optional[builtins.bool]:
        """
    ...
    def digest_algorithm(self) -> Optional[builtins.str]:
        """
    ...
    def include_attribute_name_format(self) -> Optional[builtins.bool]:
        """
    ...
    def map_identities(self) -> Optional[builtins.bool]:
        """
    ...
    def map_unknown_claims_as_is(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def mappings(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def name_identifier_format(self) -> Optional[builtins.str]:
        """
    ...
    def name_identifier_probes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def passthrough_claims_with_no_mapping(self) -> Optional[builtins.bool]:
        """
    ...
    def sign_response(self) -> Optional[builtins.bool]:
        """
    ...
    def signing_cert(self) -> Optional[builtins.str]:
        """
    ...
    def typed_attributes(self) -> Optional[builtins.bool]:
        """
...
class ClientAddonsSamlpLogout(dict):
    ...
    def __init__(__self__, *,
                 callback: Optional[builtins.str] = None,
                 slo_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str callback: The service provider (client application)'s Single Logout Service URL, where Auth0 will send logout requests and responses.
        :param builtins.bool slo_enabled: Controls whether Auth0 should notify service providers of session termination.
        """
    ...
    @property
    @pulumi.getter
    def callback(self) -> Optional[builtins.str]:
        """
    ...
    def slo_enabled(self) -> Optional[builtins.bool]:
        """
...
class ClientAddonsSapApi(dict):
    ...
    def __init__(__self__, *,
                 ...
                 service_password: Optional[builtins.str] = None,
                 token_endpoint_url: Optional[builtins.str] = None,
                 username_attribute: Optional[builtins.str] = None):
        """
        :param builtins.str client_id: If activated in the OAuth 2.0 client configuration (transaction `SOAUTH2) the SAML attribute`client*id`must be set and equal the`client*id` form parameter of the access token request.
        :param builtins.str name_identifier_format: NameID element of the Subject which can be used to express the user's identity. Defaults to `urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified`.
        :param builtins.str scope: Requested scope for SAP APIs.
        :param builtins.str service_password: Service account password to use to authenticate API calls to the token endpoint.
        :param builtins.str token_endpoint_url: The OAuth2 token endpoint URL of your SAP OData server.
        :param builtins.str username_attribute: Name of the property in the user object that maps to a SAP username, for example `email`.
        """
        if client_id is not None:
            pulumi.set(__self__, "client_id", client_id)
        if name_identifier_format is not None:
    ...
    def service_password(self) -> Optional[builtins.str]:
        """
    ...
    def token_endpoint_url(self) -> Optional[builtins.str]:
        """
    ...
    def username_attribute(self) -> Optional[builtins.str]:
        """
...
class ClientAddonsSentry(dict):
    ...
    def __init__(__self__, *,
                 ...
                 org_slug: Optional[builtins.str] = None):
        """
        :param builtins.str base_url: URL prefix only if running Sentry Community Edition, otherwise leave empty.
        :param builtins.str org_slug: Generated slug for your Sentry organization. Found in your Sentry URL, for example `https://sentry.acme.com/acme-org/` would be `acme-org`.
        """
    ...
    def org_slug(self) -> Optional[builtins.str]:
        """
...
class ClientAddonsSharepoint(dict):
    ...
    def __init__(__self__, *,
                 ...
                 url: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] external_urls: External SharePoint application URLs if exposed to the Internet.
        :param builtins.str url: Internal SharePoint application URL.
        """
...
class ClientAddonsSlack(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str team: Slack team name.
        """
        if team is not None:
...
class ClientAddonsSpringcm(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str acs_url: SpringCM ACS URL, for example `https://na11.springcm.com/atlas/sso/SSOEndpoint.ashx`.
        """
...
class ClientAddonsSsoIntegration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: SSO integration name.
        :param builtins.str version: SSO integration version installed.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class ClientAddonsWams(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str master_key: Your master key for Windows Azure Mobile Services.
        """
...
class ClientAddonsZendesk(dict):
    ...
    def __init__(__self__, *,
                 account_name: Optional[builtins.str] = None):
        """
        :param builtins.str account_name: Zendesk account name. Usually the first segment in your Zendesk URL, for example `https://acme-org.zendesk.com` would be `acme-org`.
        """
        if account_name is not None:
            pulumi.set(__self__, "account_name", account_name)
...
class ClientAddonsZoom(dict):
    def __init__(__self__, *,
                 account: Optional[builtins.str] = None):
        """
        :param builtins.str account: Zoom account name. Usually the first segment of your Zoom URL, for example `https://acme-org.zoom.us` would be `acme-org`.
        """
        if account is not None:
            pulumi.set(__self__, "account", account)
...
class ClientCredentialsPrivateKeyJwtCredential(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None,
                 parse_expiry_from_cert: Optional[builtins.bool] = None,
                 updated_at: Optional[builtins.str] = None):
        """
        :param builtins.str credential_type: Credential type. Supported types: `public_key`.
        :param builtins.str pem: PEM-formatted public key (SPKI and PKCS1) or X509 certificate. Must be JSON escaped.
        :param builtins.str algorithm: Algorithm which will be used with the credential. Can be one of `RS256`, `RS384`, `PS256`. If not specified, `RS256` will be used.
        :param builtins.str created_at: The ISO 8601 formatted date the credential was created.
        :param builtins.str expires_at: The ISO 8601 formatted date representing the expiration of the credential. It is not possible to set this to never expire after it has been set. Recreate the certificate if needed.
        :param builtins.str id: The ID of the client credential.
        :param builtins.str key_id: The key identifier of the credential, generated on creation.
        :param builtins.str name: Friendly name for a credential.
        :param builtins.bool parse_expiry_from_cert: Parse expiry from x509 certificate. If true, attempts to parse the expiry date from the provided PEM. If also the `expires_at` is set the credential expiry will be set to the explicit `expires_at` value.
        :param builtins.str updated_at: The ISO 8601 formatted date the credential was updated.
        """
    ...
    def parse_expiry_from_cert(self) -> Optional[builtins.bool]:
        """
...
class ClientCredentialsSelfSignedTlsClientAuthCredential(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 thumbprint_sha256: Optional[builtins.str] = None,
                 updated_at: Optional[builtins.str] = None):
        """
        :param builtins.str pem: PEM-formatted X509 certificate. Must be JSON escaped.
        :param builtins.str created_at: The ISO 8601 formatted date the credential was created.
        :param builtins.str credential_type: Credential type. Supported types: `x509_cert`.
        :param builtins.str expires_at: The ISO 8601 formatted date representing the expiration of the credential.
        :param builtins.str id: The ID of the client credential.
        :param builtins.str name: Friendly name for a credential.
        :param builtins.str thumbprint_sha256: The X509 certificate's SHA256 thumbprint.
        :param builtins.str updated_at: The ISO 8601 formatted date the credential was updated.
        """
        pulumi.set(__self__, "pem", pem)
        if created_at is not None:
    ...
    def thumbprint_sha256(self) -> Optional[builtins.str]:
        """
...
class ClientCredentialsSignedRequestObject(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool required: Require JWT-secured authorization requests.
        """
        pulumi.set(__self__, "credentials", credentials)
...
class ClientCredentialsTlsClientAuthCredential(dict):
    ...
    def __init__(__self__, *,
                 ...
                 subject_dn: Optional[builtins.str] = None,
                 updated_at: Optional[builtins.str] = None):
        """
        :param builtins.str credential_type: Credential type. Supported types: `cert_subject_dn`.
        :param builtins.str created_at: The ISO 8601 formatted date the credential was created.
        :param builtins.str id: The ID of the client credential.
        :param builtins.str name: Friendly name for a credential.
        :param builtins.str pem: PEM-formatted X509 certificate. Must be JSON escaped. Mutually exlusive with `subject_dn` property.
        :param builtins.str subject_dn: Subject Distinguished Name. Mutually exlusive with `pem` property.
        :param builtins.str updated_at: The ISO 8601 formatted date the credential was updated.
        """
        pulumi.set(__self__, "credential_type", credential_type)
        if created_at is not None:
    ...
    def subject_dn(self) -> Optional[builtins.str]:
        """
...
class ClientDefaultOrganization(dict):
    ...
    def __init__(__self__, *,
                 ...
                 flows: Optional[Sequence[builtins.str]] = None,
                 organization_id: Optional[builtins.str] = None):
        """
        :param builtins.bool disable: If set, the `default_organization` will be removed.
        :param Sequence[builtins.str] flows: Definition of the flow that needs to be configured. Eg. client_credentials
        :param builtins.str organization_id: The unique identifier of the organization
        """
    ...
    @property
    @pulumi.getter
    def flows(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ClientJwtConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 lifetime_in_seconds: Optional[builtins.int] = None,
                 scopes: Optional[Mapping[str, builtins.str]] = None,
                 secret_encoded: Optional[builtins.bool] = None):
        """
        :param builtins.str alg: Algorithm used to sign JWTs. Can be one of `HS256`, `RS256`, `PS256`.
        :param builtins.int lifetime_in_seconds: Number of seconds during which the JWT will be valid.
        :param Mapping[str, builtins.str] scopes: Permissions (scopes) included in JWTs.
        :param builtins.bool secret_encoded: Indicates whether the client secret is Base64-encoded.
        """
        if alg is not None:
    ...
    @property
    @pulumi.getter
    def scopes(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def secret_encoded(self) -> Optional[builtins.bool]:
        """
...
class ClientMobileAndroid(dict):
    ...
    def __init__(__self__, *,
                 app_package_name: Optional[builtins.str] = None,
                 sha256_cert_fingerprints: Optional[Sequence[builtins.str]] = None):
    ...
    def app_package_name(self) -> Optional[builtins.str]:
        return pulumi.get(self, "app_package_name")

    @property
    @pulumi.getter(name="sha256CertFingerprints")
    def sha256_cert_fingerprints(self) -> Optional[Sequence[builtins.str]]:
...
class ClientMobileIos(dict):
    ...
    def __init__(__self__, *,
                 app_bundle_identifier: Optional[builtins.str] = None,
    ...
    def app_bundle_identifier(self) -> Optional[builtins.str]:
...
class ClientOidcLogout(dict):
    ...
    def __init__(__self__, *,
                 backchannel_logout_urls: Sequence[builtins.str],
                 backchannel_logout_initiators: Optional['outputs.ClientOidcLogoutBackchannelLogoutInitiators'] = None):
        """
        :param Sequence[builtins.str] backchannel_logout_urls: Set of URLs that are valid to call back from Auth0 for OIDC backchannel logout. Currently only one URL is allowed.
    ...
    def backchannel_logout_urls(self) -> Sequence[builtins.str]:
        """
...
class ClientOidcLogoutBackchannelLogoutInitiators(dict):
    ...
    def __init__(__self__, *,
                 mode: builtins.str,
                 selected_initiators: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str mode: Determines the configuration method for enabling initiators. `custom` enables only the initiators listed in the backchannel*logout*selected_initiators set, `all` enables all current and future initiators.
        :param Sequence[builtins.str] selected_initiators: Contains the list of initiators to be enabled for the given client.
        """
        pulumi.set(__self__, "mode", mode)
    ...
    def selected_initiators(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ClientRefreshToken(dict):
    ...
    def __init__(__self__, *,
                 expiration_type: builtins.str,
                 rotation_type: builtins.str,
                 idle_token_lifetime: Optional[builtins.int] = None,
        ...
        :param builtins.int idle_token_lifetime: The time in seconds after which inactive refresh tokens will expire.
    ...
    def expiration_type(self) -> builtins.str:
        """
    ...
    def idle_token_lifetime(self) -> Optional[builtins.int]:
        """
    ...
    def infinite_idle_token_lifetime(self) -> Optional[builtins.bool]:
        """
    ...
    def infinite_token_lifetime(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def leeway(self) -> Optional[builtins.int]:
        """
...
class ClientTokenExchange(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] allow_any_profile_of_types: List of allowed profile types for token exchange
        """
        pulumi.set(__self__, "allow_any_profile_of_types", allow_any_profile_of_types)

    @property
    @pulumi.getter(name="allowAnyProfileOfTypes")
    def allow_any_profile_of_types(self) -> Sequence[builtins.str]:
        """
...
class ConnectionOptions(dict):
    ...
    def __init__(__self__, *,
                 adfs_server: Optional[builtins.str] = None,
                 allowed_audiences: Optional[Sequence[builtins.str]] = None,
                 api_enable_users: Optional[builtins.bool] = None,
                 ...
                 auth_params: Optional[Mapping[str, builtins.str]] = None,
                 ...
                 brute_force_protection: Optional[builtins.bool] = None,
                 client_id: Optional[builtins.str] = None,
                 ...
                 digest_algorithm: Optional[builtins.str] = None,
                 disable_cache: Optional[builtins.bool] = None,
                 disable_self_service_change_password: Optional[builtins.bool] = None,
                 disable_sign_out: Optional[builtins.bool] = None,
                 disable_signup: Optional[builtins.bool] = None,
                 discovery_url: Optional[builtins.str] = None,
                 domain: Optional[builtins.str] = None,
                 domain_aliases: Optional[Sequence[builtins.str]] = None,
                 enable_script_context: Optional[builtins.bool] = None,
                 enabled_database_customization: Optional[builtins.bool] = None,
                 entity_id: Optional[builtins.str] = None,
                 fed_metadata_xml: Optional[builtins.str] = None,
                 fields_map: Optional[builtins.str] = None,
                 forward_request_info: Optional[builtins.bool] = None,
                 from_: Optional[builtins.str] = None,
                 gateway_authentication: Optional['outputs.ConnectionOptionsGatewayAuthentication'] = None,
                 gateway_url: Optional[builtins.str] = None,
                 global_token_revocation_jwt_iss: Optional[builtins.str] = None,
                 global_token_revocation_jwt_sub: Optional[builtins.str] = None,
                 icon_url: Optional[builtins.str] = None,
                 identity_api: Optional[builtins.str] = None,
                 idp_initiated: Optional['outputs.ConnectionOptionsIdpInitiated'] = None,
                 import_mode: Optional[builtins.bool] = None,
                 ips: Optional[Sequence[builtins.str]] = None,
                 issuer: Optional[builtins.str] = None,
                 jwks_uri: Optional[builtins.str] = None,
                 key_id: Optional[builtins.str] = None,
                 map_user_id_to_id: Optional[builtins.bool] = None,
                 max_groups_to_retrieve: Optional[builtins.str] = None,
                 messaging_service_sid: Optional[builtins.str] = None,
                 metadata_url: Optional[builtins.str] = None,
                 metadata_xml: Optional[builtins.str] = None,
                 mfa: Optional['outputs.ConnectionOptionsMfa'] = None,
                 name: Optional[builtins.str] = None,
                 non_persistent_attrs: Optional[Sequence[builtins.str]] = None,
                 ...
                 password_policy: Optional[builtins.str] = None,
                 ping_federate_base_url: Optional[builtins.str] = None,
                 ...
                 scripts: Optional[Mapping[str, builtins.str]] = None,
                 set_user_root_attributes: Optional[builtins.str] = None,
                 should_trust_email_verified_connection: Optional[builtins.str] = None,
                 sign_in_endpoint: Optional[builtins.str] = None,
                 sign_out_endpoint: Optional[builtins.str] = None,
                 sign_saml_request: Optional[builtins.bool] = None,
                 signature_algorithm: Optional[builtins.str] = None,
                 signing_cert: Optional[builtins.str] = None,
                 signing_key: Optional['outputs.ConnectionOptionsSigningKey'] = None,
                 strategy_version: Optional[builtins.int] = None,
                 ...
                 upstream_params: Optional[builtins.str] = None,
                 use_cert_auth: Optional[builtins.bool] = None,
                 use_kerberos: Optional[builtins.bool] = None,
                 use_wsfed: Optional[builtins.bool] = None,
                 user_id_attribute: Optional[builtins.str] = None,
                 userinfo_endpoint: Optional[builtins.str] = None,
                 validation: Optional['outputs.ConnectionOptionsValidation'] = None,
                 waad_common_endpoint: Optional[builtins.bool] = None,
                 waad_protocol: Optional[builtins.str] = None):
        """
        :param builtins.str adfs_server: ADFS URL where to fetch the metadata source.
        :param Sequence[builtins.str] allowed_audiences: List of allowed audiences.
        :param builtins.bool api_enable_users: Enable API Access to users.
        ...
        :param Mapping[str, builtins.str] auth_params: Query string parameters to be included as part of the generated passwordless email link.
        ...
        :param builtins.str authorization_endpoint: Authorization endpoint.
        :param builtins.bool brute_force_protection: Indicates whether to enable brute force protection, which will limit the number of signups and failed logins from a suspicious IP address.
        :param builtins.str client_id: The strategy's client ID.
        :param builtins.str client_secret: The strategy's client secret.
        ...
        :param builtins.str digest_algorithm: Sign Request Algorithm Digest.
        :param builtins.bool disable_cache: Indicates whether to disable the cache or not.
        :param builtins.bool disable_self_service_change_password: Indicates whether to remove the forgot password link within the New Universal Login.
        :param builtins.bool disable_sign_out: When enabled, will disable sign out.
        :param builtins.bool disable_signup: Indicates whether to allow user sign-ups to your application.
        :param builtins.str discovery_url: OpenID discovery URL, e.g. `https://auth.example.com/.well-known/openid-configuration`.
        :param builtins.str domain: Domain name.
        :param Sequence[builtins.str] domain_aliases: List of the domains that can be authenticated using the identity provider. Only needed for Identifier First authentication flows.
        :param builtins.bool enable_script_context: Set to `true` to inject context into custom DB scripts (warning: cannot be disabled once enabled).
        :param builtins.bool enabled_database_customization: Set to `true` to use a legacy user store.
        :param builtins.str entity_id: Custom Entity ID for the connection.
        :param builtins.str fed_metadata_xml: Federation Metadata for the ADFS connection.
        :param builtins.str fields_map: If you're configuring a SAML enterprise connection for a non-standard PingFederate Server, you must update the attribute mappings.
        :param builtins.bool forward_request_info: Specifies whether or not request info should be forwarded to sms gateway.
        :param builtins.str from_: Address to use as the sender.
        ...
        :param builtins.str gateway_url: Defines a custom sms gateway to use instead of Twilio.
        :param builtins.str global_token_revocation_jwt_iss: Specifies the issuer of the JWT used for global token revocation for the SAML connection.
        :param builtins.str global_token_revocation_jwt_sub: Specifies the subject of the JWT used for global token revocation for the SAML connection.
        :param builtins.str icon_url: Icon URL.
        :param builtins.str identity_api: Azure AD Identity API. Available options are: `microsoft-identity-platform-v2.0` or `azure-active-directory-v1.0`.
        ...
        :param builtins.bool import_mode: Indicates whether you have a legacy user store and want to gradually migrate those users to the Auth0 user store.
        :param Sequence[builtins.str] ips: A list of IPs.
        :param builtins.str issuer: Issuer URL, e.g. `https://auth.example.com`.
        :param builtins.str jwks_uri: JWKS URI.
        :param builtins.str key_id: Apple Key ID.
        :param builtins.bool map_user_id_to_id: By default Auth0 maps `user_id` to `email`. Enabling this setting changes the behavior to map `user_id` to 'id' instead. This can only be defined on a new Google Workspace connection and can not be changed once set.
        :param builtins.str max_groups_to_retrieve: Maximum number of groups to retrieve.
        :param builtins.str messaging_service_sid: SID for Copilot. Used when SMS Source is Copilot.
        :param builtins.str metadata_url: The URL of the SAML metadata document.
        :param builtins.str metadata_xml: The XML content for the SAML metadata document. Values within the xml will take precedence over other attributes set on the options block.
        :param 'ConnectionOptionsMfaArgs' mfa: Configuration options for multifactor authentication.
        :param builtins.str name: The public name of the email or SMS Connection. In most cases this is the same name as the connection name.
        :param Sequence[builtins.str] non_persistent_attrs: If there are user fields that should not be stored in Auth0 databases due to privacy reasons, you can add them to the DenyList here.
        ...
        :param builtins.str password_policy: Indicates level of password strength to enforce during authentication. A strong password policy will make it difficult, if not improbable, for someone to guess a password through either manual or automated means. Options include `none`, `low`, `fair`, `good`, `excellent`.
        :param builtins.str ping_federate_base_url: Ping Federate Server URL.
        :param builtins.bool pkce_enabled: Enables Proof Key for Code Exchange (PKCE) functionality for OAuth2 connections.
        ...
        :param Mapping[str, builtins.str] scripts: A map of scripts used for an OAuth connection. Only accepts a `fetchUserProfile` script.
        :param builtins.str set_user_root_attributes: Determines whether to sync user profile attributes (`name`, `given_name`, `family_name`, `nickname`, `picture`) at each login or only on the first login. Options include: `on_each_login`, `on_first_login`, `never_on_login`. Default value: `on_each_login`.
        :param builtins.str should_trust_email_verified_connection: Choose how Auth0 sets the email_verified field in the user profile.
        :param builtins.str sign_in_endpoint: SAML single login URL for the connection.
        :param builtins.str sign_out_endpoint: SAML single logout URL for the connection.
        :param builtins.bool sign_saml_request: When enabled, the SAML authentication request will be signed.
        :param builtins.str signature_algorithm: Sign Request Algorithm.
        :param builtins.str signing_cert: X.509 signing certificate (encoded in PEM or CER) you retrieved from the IdP, Base64-encoded.
        ...
        :param builtins.int strategy_version: Version 1 is deprecated, use version 2.
        :param builtins.str subject: Subject line of the email.
        :param builtins.str syntax: Syntax of the template body.
        :param builtins.str team_id: Apple Team ID.
        ...
        :param builtins.str type: Value can be `back_channel` or `front_channel`. Front Channel will use OIDC protocol with `response_mode=form_post` and `response_type=id_token`. Back Channel will use `response_type=code`.
        :param builtins.str upstream_params: You can pass provider-specific parameters to an identity provider during authentication. The values can either be static per connection or dynamic per user.
        :param builtins.bool use_cert_auth: Indicates whether to use cert auth or not.
        :param builtins.bool use_kerberos: Indicates whether to use Kerberos or not.
        :param builtins.bool use_wsfed: Whether to use WS-Fed.
        :param builtins.str user_id_attribute: Attribute in the token that will be mapped to the user_id property in Auth0.
        :param builtins.str userinfo_endpoint: User info endpoint.
        ...
        :param builtins.bool waad_common_endpoint: Indicates whether to use the common endpoint rather than the default endpoint. Typically enabled if you're using this for a multi-tenant application in Azure AD.
        :param builtins.str waad_protocol: Protocol to use.
        """
    ...
    def adfs_server(self) -> Optional[builtins.str]:
        """
    ...
    def api_enable_users(self) -> Optional[builtins.bool]:
        """
    ...
    def auth_params(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def brute_force_protection(self) -> Optional[builtins.bool]:
        """
    ...
    def community_base_url(self) -> Optional[builtins.str]:
        """
    ...
    def custom_scripts(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def disable_cache(self) -> Optional[builtins.bool]:
        """
    ...
    def disable_self_service_change_password(self) -> Optional[builtins.bool]:
        """
    ...
    def disable_sign_out(self) -> Optional[builtins.bool]:
        """
    ...
    def disable_signup(self) -> Optional[builtins.bool]:
        """
    ...
    def domain_aliases(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def enable_script_context(self) -> Optional[builtins.bool]:
        """
    ...
    def enabled_database_customization(self) -> Optional[builtins.bool]:
        """
    ...
    def fed_metadata_xml(self) -> Optional[builtins.str]:
        """
    ...
    def fields_map(self) -> Optional[builtins.str]:
        """
    ...
    def forward_request_info(self) -> Optional[builtins.bool]:
        """
    ...
    def global_token_revocation_jwt_iss(self) -> Optional[builtins.str]:
        """
    ...
    def global_token_revocation_jwt_sub(self) -> Optional[builtins.str]:
        """
    ...
    def identity_api(self) -> Optional[builtins.str]:
        """
    ...
    def import_mode(self) -> Optional[builtins.bool]:
        """
    ...
    def jwks_uri(self) -> Optional[builtins.str]:
        """
        JWKS URI.
        """
    ...
    def map_user_id_to_id(self) -> Optional[builtins.bool]:
        """
    ...
    def max_groups_to_retrieve(self) -> Optional[builtins.str]:
        """
    ...
    def metadata_xml(self) -> Optional[builtins.str]:
        """
    ...
    def non_persistent_attrs(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def password_policy(self) -> Optional[builtins.str]:
        """
    ...
    def ping_federate_base_url(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def precedences(self) -> Optional[Sequence[builtins.str]]:
        """
        Order of attributes for precedence in identification.Valid values: email, phone*number, username. If Precedence is set, it must contain all values (email, phone*number, username) in specific order
        """
    ...
    def protocol_binding(self) -> Optional[builtins.str]:
        """
    ...
    def request_template(self) -> Optional[builtins.str]:
        """
    ...
    def requires_username(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def scripts(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def set_user_root_attributes(self) -> Optional[builtins.str]:
        """
    ...
    def should_trust_email_verified_connection(self) -> Optional[builtins.str]:
        """
    ...
    def sign_in_endpoint(self) -> Optional[builtins.str]:
        """
    ...
    def sign_out_endpoint(self) -> Optional[builtins.str]:
        """
    ...
    def sign_saml_request(self) -> Optional[builtins.bool]:
        """
    ...
    def strategy_version(self) -> Optional[builtins.int]:
        """
    ...
    def tenant_domain(self) -> Optional[builtins.str]:
        """
        Tenant domain name.
        """
    ...
    def twilio_sid(self) -> Optional[builtins.str]:
        """
    ...
    def twilio_token(self) -> Optional[builtins.str]:
        """
    ...
    def upstream_params(self) -> Optional[builtins.str]:
        """
    ...
    def use_cert_auth(self) -> Optional[builtins.bool]:
        """
    ...
    def use_kerberos(self) -> Optional[builtins.bool]:
        """
    ...
    def use_wsfed(self) -> Optional[builtins.bool]:
        """
    ...
    def user_id_attribute(self) -> Optional[builtins.str]:
        """
    ...
    def userinfo_endpoint(self) -> Optional[builtins.str]:
        """
        User info endpoint.
        """
    ...
    def waad_common_endpoint(self) -> Optional[builtins.bool]:
        """
    ...
    def waad_protocol(self) -> Optional[builtins.str]:
        """
        Protocol to use.
        """
...
class ConnectionOptionsAttributeEmail(dict):
    ...
    def __init__(__self__, *,
                 ...
                 profile_required: Optional[builtins.bool] = None,
        ...
        :param builtins.bool profile_required: Defines whether Profile is required
        :param Sequence['ConnectionOptionsAttributeEmailSignupArgs'] signups: Defines signup settings for Email attribute
        :param builtins.str verification_method: Defines whether whether user will receive a link or an OTP during user signup for email verification and password reset for email verification
        """
    ...
    def profile_required(self) -> Optional[builtins.bool]:
        """
    ...
    def verification_method(self) -> Optional[builtins.str]:
        """
...
class ConnectionOptionsAttributeEmailIdentifier(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool active: Defines whether email attribute is active as an identifier
        """
...
class ConnectionOptionsAttributeEmailSignup(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str status: Defines signup status for Email Attribute
...
class ConnectionOptionsAttributeEmailSignupVerification(dict):
    def __init__(__self__, *,
                 active: Optional[builtins.bool] = None):
        """
        :param builtins.bool active: Defines verification settings for signup attribute
        """
        if active is not None:
            pulumi.set(__self__, "active", active)
...
class ConnectionOptionsAttributeMap(dict):
    ...
    def __init__(__self__, *,
                 mapping_mode: builtins.str,
                 attributes: Optional[builtins.str] = None,
                 userinfo_scope: Optional[builtins.str] = None):
        """
        :param builtins.str mapping_mode: Method used to map incoming claims. Possible values: `use_map` (Okta or OIDC), `bind_all` (OIDC) or `basic_profile` (Okta).
        :param builtins.str attributes: This property is an object containing mapping information that allows Auth0 to interpret incoming claims from the IdP. Mapping information must be provided as key/value pairs.
        :param builtins.str userinfo_scope: This property defines the scopes that Auth0 sends to the IdP’s UserInfo endpoint when requested.
        """
    ...
    def userinfo_scope(self) -> Optional[builtins.str]:
        """
...
class ConnectionOptionsAttributePhoneNumberIdentifier(dict):
    def __init__(__self__, *,
                 active: Optional[builtins.bool] = None):
        """
        :param builtins.bool active: Defines whether Phone Number attribute is active as an identifier
        """
        if active is not None:
            pulumi.set(__self__, "active", active)
...
class ConnectionOptionsAttributePhoneNumberSignup(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str status: Defines status of signup for Phone Number attribute
...
class ConnectionOptionsAttributePhoneNumberSignupVerification(dict):
    def __init__(__self__, *,
                 active: Optional[builtins.bool] = None):
        """
        :param builtins.bool active: Defines verification settings for Phone Number attribute
        """
        if active is not None:
            pulumi.set(__self__, "active", active)
...
class ConnectionOptionsAttributeUsernameIdentifier(dict):
    def __init__(__self__, *,
                 active: Optional[builtins.bool] = None):
        """
        :param builtins.bool active: Defines whether UserName attribute is active as an identifier
        """
        if active is not None:
            pulumi.set(__self__, "active", active)
...
class ConnectionOptionsAttributeUsernameSignup(dict):
    def __init__(__self__, *,
                 status: Optional[builtins.str] = None):
        """
        :param builtins.str status: Defines whether User Name attribute is active as an identifier
        """
        if status is not None:
            pulumi.set(__self__, "status", status)
...
class ConnectionOptionsAttributeUsernameValidation(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int max_length: Defines Max Length for User Name attribute
        :param builtins.int min_length: Defines Min Length for User Name attribute
        """
...
class ConnectionOptionsAttributeUsernameValidationAllowedType(dict):
    ...
    def __init__(__self__, *,
                 email: Optional[builtins.bool] = None,
                 phone_number: Optional[builtins.bool] = None):
        """
        :param builtins.bool email: One of the allowed types for UserName signup attribute
        :param builtins.bool phone_number: One of the allowed types for UserName signup attribute
        """
    ...
    @property
    @pulumi.getter
    def email(self) -> Optional[builtins.bool]:
        """
    ...
    def phone_number(self) -> Optional[builtins.bool]:
        """
        One of the allowed types for UserName signup attribute
        """
...
class ConnectionOptionsAuthenticationMethodPasskey(dict):
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool enabled: Enables passkey authentication
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ConnectionOptionsAuthenticationMethodPassword(dict):
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool enabled: Enables password authentication
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ConnectionOptionsConnectionSettings(dict):
    def __init__(__self__, *,
                 pkce: builtins.str):
        """
        :param builtins.str pkce: PKCE configuration. Possible values: `auto` (uses the strongest algorithm available), `S256` (uses the SHA-256 algorithm), `plain` (uses plaintext as described in the PKCE specification) or `disabled` (disables support for PKCE).
        """
        pulumi.set(__self__, "pkce", pkce)

    @property
    @pulumi.getter
    def pkce(self) -> builtins.str:
        """
...
class ConnectionOptionsGatewayAuthentication(dict):
    ...
    def __init__(__self__, *,
                 ...
                 method: Optional[builtins.str] = None,
                 secret: Optional[builtins.str] = None,
                 secret_base64_encoded: Optional[builtins.bool] = None,
                 subject: Optional[builtins.str] = None):
        """
        :param builtins.str audience: Audience claim for the HS256 token sent to `gateway_url`.
        :param builtins.str method: Authentication method (default is `bearer` token).
        :param builtins.str secret: Secret used to sign the HS256 token sent to `gateway_url`.
        :param builtins.bool secret_base64_encoded: Specifies whether or not the secret is Base64-encoded.
        :param builtins.str subject: Subject claim for the HS256 token sent to `gateway_url`.
        """
        if audience is not None:
            pulumi.set(__self__, "audience", audience)
        if method is not None:
    ...
    def secret_base64_encoded(self) -> Optional[builtins.bool]:
        """
...
class ConnectionOptionsIdpInitiated(dict):
    ...
    def __init__(__self__, *,
                 client_authorize_query: Optional[builtins.str] = None,
                 client_id: Optional[builtins.str] = None,
                 client_protocol: Optional[builtins.str] = None,
                 enabled: Optional[builtins.bool] = None):
    ...
    def client_authorize_query(self) -> Optional[builtins.str]:
...
class ConnectionOptionsMfa(dict):
    ...
    def __init__(__self__, *,
                 active: Optional[builtins.bool] = None,
                 return_enroll_settings: Optional[builtins.bool] = None):
        """
        :param builtins.bool active: Indicates whether multifactor authentication is enabled for this connection.
        :param builtins.bool return_enroll_settings: Indicates whether multifactor authentication enrollment settings will be returned.
        """
        if active is not None:
            pulumi.set(__self__, "active", active)
    ...
    def return_enroll_settings(self) -> Optional[builtins.bool]:
        """
...
class ConnectionOptionsPasskeyOptions(dict):
    ...
    def __init__(__self__, *,
                 challenge_ui: Optional[builtins.str] = None,
                 local_enrollment_enabled: Optional[builtins.bool] = None,
                 progressive_enrollment_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str challenge_ui: Controls the UI used to challenge the user for their passkey
        :param builtins.bool local_enrollment_enabled: Enables or disables enrollment prompt for local passkey when user authenticates using a cross-device passkey for the connection
        :param builtins.bool progressive_enrollment_enabled: Enables or disables progressive enrollment of passkeys for the connection
        """
    ...
    def challenge_ui(self) -> Optional[builtins.str]:
        """
    ...
    def local_enrollment_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def progressive_enrollment_enabled(self) -> Optional[builtins.bool]:
        """
...
class ConnectionOptionsPasswordComplexityOptions(dict):
    ...
    def __init__(__self__, *,
                 min_length: Optional[builtins.int] = None):
        """
        :param builtins.int min_length: Minimum number of characters allowed in passwords.
        """
        if min_length is not None:
            pulumi.set(__self__, "min_length", min_length)
...
class ConnectionOptionsPasswordDictionary(dict):
    def __init__(__self__, *,
                 dictionaries: Optional[Sequence[builtins.str]] = None,
                 enable: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] dictionaries: Customized contents of the password dictionary. By default, the password dictionary contains a list of the [10,000 most common passwords](https://github.com/danielmiessler/SecLists/blob/master/Passwords/Common-Credentials/10k-most-common.txt); your customized content is used in addition to the default password dictionary. Matching is not case-sensitive.
        :param builtins.bool enable: Indicates whether the password dictionary check is enabled for this connection.
        """
    ...
    @property
    @pulumi.getter
    def dictionaries(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConnectionOptionsTotp(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_step: Optional[builtins.int] = None):
        """
        :param builtins.int length: Length of the one-time password.
        :param builtins.int time_step: Seconds between allowed generation of new passwords.
        """
    ...
    def time_step(self) -> Optional[builtins.int]:
        """
...
class CustomDomainCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 error_msg: Optional[builtins.str] = None,
                 renews_before: Optional[builtins.str] = None,
                 status: Optional[builtins.str] = None):
        """
        :param builtins.str certificate_authority: Name of the certificate authority that issued the certificate.
        :param builtins.str error_msg: Contains the error message if the provisioning process fails.
        :param builtins.str renews_before: Specifies the date by which the certificate should be renewed.
        :param builtins.str status: Indicates the current state of the certificate provisioning process.
        """
    ...
    def error_msg(self) -> Optional[builtins.str]:
        """
    ...
    def renews_before(self) -> Optional[builtins.str]:
        """
...
class CustomDomainVerification(dict):
    ...
    def __init__(__self__, *,
                 error_msg: Optional[builtins.str] = None,
                 last_verified_at: Optional[builtins.str] = None,
                 methods: Optional[Sequence[Any]] = None,
                 status: Optional[builtins.str] = None):
        """
        :param builtins.str error_msg: Contains error message, if any, from the last DNS verification check.
        :param builtins.str last_verified_at: Indicates the last time the domain was successfully verified.
        :param Sequence[Any] methods: Defines the list of domain verification methods used.
        :param builtins.str status: Represents the current status of the domain verification process.
        """
        if error_msg is not None:
            pulumi.set(__self__, "error_msg", error_msg)
    ...
    def last_verified_at(self) -> Optional[builtins.str]:
        """
...
class EmailProviderCredentials(dict):
    ...
    def __init__(__self__, *,
                 ...
                 azure_cs_connection_string: Optional[builtins.str] = None,
                 domain: Optional[builtins.str] = None,
                 ms365_client_id: Optional[builtins.str] = None,
                 ms365_client_secret: Optional[builtins.str] = None,
                 ms365_tenant_id: Optional[builtins.str] = None,
                 region: Optional[builtins.str] = None,
                 secret_access_key: Optional[builtins.str] = None,
                 smtp_host: Optional[builtins.str] = None,
                 smtp_pass: Optional[builtins.str] = None,
                 smtp_port: Optional[builtins.int] = None,
                 smtp_user: Optional[builtins.str] = None):
        """
        :param builtins.str access_key_id: AWS Access Key ID. Used only for AWS.
        :param builtins.str api_key: API Key for your email service. Will always be encrypted in our database.
        :param builtins.str azure_cs_connection_string: Azure Communication Services Connection String.
        :param builtins.str domain: Domain name.
        :param builtins.str ms365_client_id: Microsoft 365 Client ID.
        :param builtins.str ms365_client_secret: Microsoft 365 Client Secret.
        :param builtins.str ms365_tenant_id: Microsoft 365 Tenant ID.
        :param builtins.str region: Default region. Used only for AWS, Mailgun, and SparkPost.
        :param builtins.str secret_access_key: AWS Secret Key. Will always be encrypted in our database. Used only for AWS.
        :param builtins.str smtp_host: Hostname or IP address of your SMTP server. Used only for SMTP.
        :param builtins.str smtp_pass: SMTP password. Used only for SMTP.
        :param builtins.int smtp_port: Port used by your SMTP server. Please avoid using port 25 if possible because many providers have limitations on this port. Used only for SMTP.
        :param builtins.str smtp_user: SMTP username. Used only for SMTP.
        """
    ...
    def azure_cs_connection_string(self) -> Optional[builtins.str]:
        """
    ...
    def ms365_client_id(self) -> Optional[builtins.str]:
        """
    ...
    def ms365_client_secret(self) -> Optional[builtins.str]:
        """
    ...
    def ms365_tenant_id(self) -> Optional[builtins.str]:
        """
    ...
    def smtp_host(self) -> Optional[builtins.str]:
        """
    ...
    def smtp_pass(self) -> Optional[builtins.str]:
        """
    ...
    def smtp_port(self) -> Optional[builtins.int]:
        """
    ...
    def smtp_user(self) -> Optional[builtins.str]:
        """
...
class EmailProviderSettingsHeaders(dict):
    ...
    def __init__(__self__, *,
                 x_mc_view_content_link: Optional[builtins.str] = None,
                 x_ses_configuration_set: Optional[builtins.str] = None):
        """
        :param builtins.str x_mc_view_content_link: Disable or enable the default View Content Link for sensitive emails.
        :param builtins.str x_ses_configuration_set: SES Configuration set to include when sending emails.
        """
    ...
    def x_mc_view_content_link(self) -> Optional[builtins.str]:
        """
    ...
    def x_ses_configuration_set(self) -> Optional[builtins.str]:
        """
...
class EmailProviderSettingsMessage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 view_content_link: Optional[builtins.bool] = None):
        """
        :param builtins.str configuration_set_name: Setting for the `ses` email provider. The name of the configuration set to apply to the sent emails.
        :param builtins.bool view_content_link: Setting for the `mandrill` email provider. Set to `true` to see the content of individual emails sent to users.
        """
    ...
    def view_content_link(self) -> Optional[builtins.bool]:
        """
...
class EncryptionKeyManagerCustomerProvidedRootKey(dict):
    ...
    def __init__(__self__, *,
                 created_at: Optional[builtins.str] = None,
                 key_id: Optional[builtins.str] = None,
                 parent_key_id: Optional[builtins.str] = None,
                 public_wrapping_key: Optional[builtins.str] = None,
                 state: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None,
                 updated_at: Optional[builtins.str] = None,
                 wrapped_key: Optional[builtins.str] = None,
                 wrapping_algorithm: Optional[builtins.str] = None):
        """
        :param builtins.str created_at: The ISO 8601 formatted date the customer provided root key was created.
        :param builtins.str key_id: The key ID of the customer provided root key.
        :param builtins.str parent_key_id: The key ID of the parent wrapping key.
        :param builtins.str public_wrapping_key: The public wrapping key in PEM format.
        :param builtins.str state: The state of the encryption key. One of `pre-activation`, `active`, `deactivated`, or `destroyed`.
        :param builtins.str type: The type of the customer provided root key. Should be `customer-provided-root-key`.
        :param builtins.str updated_at: The ISO 8601 formatted date the customer provided root key was updated.
        :param builtins.str wrapped_key: The base64-encoded customer provided root key, wrapped using the `public_wrapping_key`. This can be removed after the wrapped key has been applied.
        :param builtins.str wrapping_algorithm: The algorithm that should be used to wrap the customer provided root key. Should be `CKM_RSA_AES_KEY_WRAP`.
        """
        if created_at is not None:
            pulumi.set(__self__, "created_at", created_at)
        if key_id is not None:
    ...
    def parent_key_id(self) -> Optional[builtins.str]:
        """
    ...
    def public_wrapping_key(self) -> Optional[builtins.str]:
        """
    ...
    def wrapped_key(self) -> Optional[builtins.str]:
        """
    ...
    def wrapping_algorithm(self) -> Optional[builtins.str]:
        """
...
class EncryptionKeyManagerEncryptionKey(dict):
    ...
    def __init__(__self__, *,
                 ...
                 updated_at: Optional[builtins.str] = None):
        """
        :param builtins.str created_at: The ISO 8601 formatted date the encryption key was created.
        :param builtins.str key_id: The key ID of the encryption key.
        :param builtins.str parent_key_id: The key ID of the parent wrapping key.
        :param builtins.str state: The state of the encryption key. One of `pre-activation`, `active`, `deactivated`, or `destroyed`.
        :param builtins.str type: The type of the encryption key. One of `customer-provided-root-key`, `environment-root-key`, or `tenant-master-key`.
        :param builtins.str updated_at: The ISO 8601 formatted date the encryption key was updated.
        """
        if created_at is not None:
            pulumi.set(__self__, "created_at", created_at)
        if key_id is not None:
...
class FormLanguage(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str primary: Primary language for the form.
        :param builtins.str default: Default language for the form.
        """
        pulumi.set(__self__, "primary", primary)
...
class FormMessage(dict):
    def __init__(__self__, *,
                 custom: Optional[builtins.str] = None,
                 errors: Optional[builtins.str] = None):
        """
        :param builtins.str custom: Custom message for the form. (JSON encoded)
        :param builtins.str errors: Error message for the form. (JSON encoded)
        """
    ...
    @property
    @pulumi.getter
    def custom(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def errors(self) -> Optional[builtins.str]:
        """
...
class GuardianDuo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 integration_key: Optional[builtins.str] = None,
                 secret_key: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: Indicates whether Duo MFA is enabled.
        :param builtins.str hostname: Duo API Hostname, see the Duo documentation for more details on Duo setup.
        :param builtins.str integration_key: Duo client ID, see the Duo documentation for more details on Duo setup.
        :param builtins.str secret_key: Duo client secret, see the Duo documentation for more details on Duo setup.
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    def integration_key(self) -> Optional[builtins.str]:
        """
...
class GuardianPhone(dict):
    ...
    def __init__(__self__, *,
                 ...
                 provider: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: Indicates whether Phone MFA is enabled.
        :param Sequence[builtins.str] message_types: Message types to use, array of `sms` and/or `voice`. Adding both to the array should enable the user to choose.
        :param 'GuardianPhoneOptionsArgs' options: Options for the various providers.
        :param builtins.str provider: Provider to use, one of `auth0`, `twilio` or `phone-message-hook`. Selecting `phone-message-hook` will require a Phone Message Action to be created before. [Learn how](https://auth0.com/docs/customize/actions/flows-and-triggers/send-phone-message-flow).
        """
        pulumi.set(__self__, "enabled", enabled)
...
class GuardianPhoneOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enrollment_message: Optional[builtins.str] = None,
                 from_: Optional[builtins.str] = None,
                 messaging_service_sid: Optional[builtins.str] = None,
                 sid: Optional[builtins.str] = None,
                 verification_message: Optional[builtins.str] = None):
        """
        :param builtins.str auth_token: AuthToken for your Twilio account.
        :param builtins.str enrollment_message: This message will be sent whenever a user enrolls a new device for the first time using MFA. Supports Liquid syntax, see [Auth0 docs](https://auth0.com/docs/customize/customize-sms-or-voice-messages).
        :param builtins.str from_: Phone number to use as the sender.
        :param builtins.str messaging_service_sid: Messaging service SID.
        :param builtins.str sid: SID for your Twilio account.
        :param builtins.str verification_message: This message will be sent whenever a user logs in after the enrollment. Supports Liquid syntax, see [Auth0 docs](https://auth0.com/docs/customize/customize-sms-or-voice-messages).
        """
    ...
    def enrollment_message(self) -> Optional[builtins.str]:
        """
    ...
    def verification_message(self) -> Optional[builtins.str]:
        """
...
class GuardianPush(dict):
    ...
    def __init__(__self__, *,
                 ...
                 provider: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: Indicates whether Push MFA is enabled.
        ...
        :param builtins.str provider: Provider to use, one of `direct`, `guardian`, `sns`.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class GuardianPushAmazonSns(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sns_apns_platform_application_arn: builtins.str,
                 sns_gcm_platform_application_arn: builtins.str):
        """
        :param builtins.str aws_access_key_id: Your AWS Access Key ID.
        :param builtins.str aws_region: Your AWS application's region.
        :param builtins.str aws_secret_access_key: Your AWS Secret Access Key.
        :param builtins.str sns_apns_platform_application_arn: The Amazon Resource Name for your Apple Push Notification Service.
        :param builtins.str sns_gcm_platform_application_arn: The Amazon Resource Name for your Firebase Cloud Messaging Service.
        """
    ...
    def sns_apns_platform_application_arn(self) -> builtins.str:
        """
    ...
    def sns_gcm_platform_application_arn(self) -> builtins.str:
        """
...
class GuardianPushCustomApp(dict):
    ...
    def __init__(__self__, *,
                 ...
                 apple_app_link: Optional[builtins.str] = None,
                 google_app_link: Optional[builtins.str] = None):
        """
        :param builtins.str app_name: Custom Application Name.
        :param builtins.str apple_app_link: Apple App Store URL. Must be HTTPS or an empty string.
        :param builtins.str google_app_link: Google Store URL. Must be HTTPS or an empty string.
        """
    ...
    def apple_app_link(self) -> Optional[builtins.str]:
        """
    ...
    def google_app_link(self) -> Optional[builtins.str]:
        """
...
class GuardianPushDirectApns(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str bundle_id: The Apple Push Notification service Bundle ID.
        :param builtins.str p12: The base64 encoded certificate in P12 format.
        :param builtins.bool sandbox: Set to true to use the sandbox iOS app environment, otherwise set to false to use the production iOS app environment.
        :param builtins.bool enabled: Indicates whether the Apple Push Notification service is enabled.
        """
    ...
    @property
    @pulumi.getter
    def sandbox(self) -> builtins.bool:
        """
...
class GuardianPushDirectFcm(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str server_key: The Firebase Cloud Messaging Server Key. For security purposes, we don’t retrieve your existing FCM server key to check for drift.
        """
...
class GuardianWebauthnPlatform(dict):
    ...
    def __init__(__self__, *,
                 enabled: builtins.bool,
                 override_relying_party: Optional[builtins.bool] = None,
                 relying_party_identifier: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: Indicates whether WebAuthn with FIDO Device Biometrics MFA is enabled.
        :param builtins.bool override_relying_party: The Relying Party is the domain for which the WebAuthn keys will be issued, set to `true` if you are customizing the identifier.
        :param builtins.str relying_party_identifier: The Relying Party should be a suffix of the custom domain.
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    def override_relying_party(self) -> Optional[builtins.bool]:
        """
    ...
    def relying_party_identifier(self) -> Optional[builtins.str]:
        """
...
class GuardianWebauthnRoaming(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Indicates whether WebAuthn with FIDO Security Keys MFA is enabled.
        :param builtins.bool override_relying_party: The Relying Party is the domain for which the WebAuthn keys will be issued, set to `true` if you are customizing the identifier.
        :param builtins.str relying_party_identifier: The Relying Party should be a suffix of the custom domain.
        :param builtins.str user_verification: User verification, one of `discouraged`, `preferred` or `required`.
        """
        pulumi.set(__self__, "enabled", enabled)
        if override_relying_party is not None:
            pulumi.set(__self__, "override_relying_party", override_relying_party)
...
class LogStreamSink(dict):
    ...
    def __init__(__self__, *,
                 ...
                 aws_partner_event_source: Optional[builtins.str] = None,
                 aws_region: Optional[builtins.str] = None,
                 azure_partner_topic: Optional[builtins.str] = None,
                 azure_region: Optional[builtins.str] = None,
                 azure_resource_group: Optional[builtins.str] = None,
                 azure_subscription_id: Optional[builtins.str] = None,
                 datadog_api_key: Optional[builtins.str] = None,
                 datadog_region: Optional[builtins.str] = None,
                 http_authorization: Optional[builtins.str] = None,
                 http_content_format: Optional[builtins.str] = None,
                 http_content_type: Optional[builtins.str] = None,
                 http_custom_headers: Optional[Sequence[Mapping[str, builtins.str]]] = None,
                 http_endpoint: Optional[builtins.str] = None,
                 mixpanel_project_id: Optional[builtins.str] = None,
                 mixpanel_region: Optional[builtins.str] = None,
                 mixpanel_service_account_password: Optional[builtins.str] = None,
                 mixpanel_service_account_username: Optional[builtins.str] = None,
                 segment_write_key: Optional[builtins.str] = None,
                 splunk_domain: Optional[builtins.str] = None,
                 splunk_port: Optional[builtins.str] = None,
                 splunk_secure: Optional[builtins.bool] = None,
                 splunk_token: Optional[builtins.str] = None,
                 sumo_source_address: Optional[builtins.str] = None):
        """
        :param builtins.str aws_account_id: The AWS Account ID.
        :param builtins.str aws_partner_event_source: Name of the Partner Event Source to be used with AWS. Generally generated by Auth0 and passed to AWS, so this should be an output attribute.
        :param builtins.str aws_region: The region in which the EventBridge event source will be created. Possible values: `ap-east-1`, `ap-northeast-1`, `ap-northeast-2`, `ap-northeast-3`, `ap-south-1`, `ap-southeast-1`, `ap-southeast-2`, `ca-central-1`, `cn-north-1`, `cn-northwest-1`, `eu-central-1`, `eu-north-1`, `eu-west-1`, `eu-west-2`, `eu-west-3`, `me-south-1`, `sa-east-1`, `us-gov-east-1`, `us-gov-west-1`, `us-east-1`, `us-east-2`, `us-west-1`, `us-west-2`.
        :param builtins.str azure_partner_topic: Name of the Partner Topic to be used with Azure. Generally should not be specified.
        :param builtins.str azure_region: The Azure region code. Possible values: `australiacentral`, `australiaeast`, `australiasoutheast`, `brazilsouth`, `canadacentral`, `canadaeast`, `centralindia`, `centralus`, `eastasia`, `eastus`, `eastus2`, `francecentral`, `germanywestcentral`, `japaneast`, `japanwest`, `koreacentral`, `koreasouth`, `northcentralus`, `northeurope`, `norwayeast`, `southafricanorth`, `southcentralus`, `southeastasia`, `southindia`, `switzerlandnorth`, `uaenorth`, `uksouth`, `ukwest`, `westcentralus`, `westeurope`, `westindia`, `westus`, `westus2`.
        :param builtins.str azure_resource_group: The Azure EventGrid resource group which allows you to manage all Azure assets within one subscription.
        :param builtins.str azure_subscription_id: The unique alphanumeric string that identifies your Azure subscription.
        :param builtins.str datadog_api_key: The Datadog API key.
        :param builtins.str datadog_region: The Datadog region. Possible values: `us`, `eu`, `us3`, `us5`.
        :param builtins.str http_authorization: Sent in the HTTP "Authorization" header with each request.
        :param builtins.str http_content_format: The format of data sent over HTTP. Options are "JSONLINES", "JSONARRAY" or "JSONOBJECT"
        :param builtins.str http_content_type: The "Content-Type" header to send over HTTP. Common value is "application/json".
        :param Sequence[Mapping[str, builtins.str]] http_custom_headers: Additional HTTP headers to be included as part of the HTTP request.
        :param builtins.str http_endpoint: The HTTP endpoint to send streaming logs.
        :param builtins.str mixpanel_project_id: The Mixpanel project ID, found on the Project Settings page.
        :param builtins.str mixpanel_region: The Mixpanel region. Options are ["us", "eu"]. EU is required for customers with EU data residency requirements.
        :param builtins.str mixpanel_service_account_password: The Mixpanel Service Account password.
        :param builtins.str mixpanel_service_account_username: The Mixpanel Service Account username. Services Accounts can be created in the Project Settings page.
        :param builtins.str segment_write_key: The [Segment Write Key](https://segment.com/docs/connections/find-writekey/).
        :param builtins.str splunk_domain: The Splunk domain name.
        :param builtins.str splunk_port: The Splunk port.
        :param builtins.bool splunk_secure: This toggle should be turned off when using self-signed certificates.
        :param builtins.str splunk_token: The Splunk access token.
        :param builtins.str sumo_source_address: Generated URL for your defined HTTP source in Sumo Logic for collecting streaming data from Auth0.
        """
    ...
    def aws_partner_event_source(self) -> Optional[builtins.str]:
        """
    ...
    def azure_partner_topic(self) -> Optional[builtins.str]:
        """
    ...
    def azure_region(self) -> Optional[builtins.str]:
        """
        The Azure region code. Possible values: `australiacentral`, `australiaeast`, `australiasoutheast`, `brazilsouth`, `canadacentral`, `canadaeast`, `centralindia`, `centralus`, `eastasia`, `eastus`, `eastus2`, `francecentral`, `germanywestcentral`, `japaneast`, `japanwest`, `koreacentral`, `koreasouth`, `northcentralus`, `northeurope`, `norwayeast`, `southafricanorth`, `southcentralus`, `southeastasia`, `southindia`, `switzerlandnorth`, `uaenorth`, `uksouth`, `ukwest`, `westcentralus`, `westeurope`, `westindia`, `westus`, `westus2`.
        """
    ...
    def azure_resource_group(self) -> Optional[builtins.str]:
        """
    ...
    def datadog_api_key(self) -> Optional[builtins.str]:
        """
        The Datadog API key.
        """
    ...
    def http_authorization(self) -> Optional[builtins.str]:
        """
    ...
    def http_content_format(self) -> Optional[builtins.str]:
        """
    ...
    def http_content_type(self) -> Optional[builtins.str]:
        """
    ...
    def http_custom_headers(self) -> Optional[Sequence[Mapping[str, builtins.str]]]:
        """
    ...
    def mixpanel_project_id(self) -> Optional[builtins.str]:
        """
    ...
    def mixpanel_region(self) -> Optional[builtins.str]:
        """
    ...
    def mixpanel_service_account_password(self) -> Optional[builtins.str]:
        """
    ...
    def mixpanel_service_account_username(self) -> Optional[builtins.str]:
        """
    ...
    def segment_write_key(self) -> Optional[builtins.str]:
        """
    ...
    def splunk_domain(self) -> Optional[builtins.str]:
        """
    ...
    def splunk_port(self) -> Optional[builtins.str]:
        """
        The Splunk port.
        """
    ...
    def splunk_secure(self) -> Optional[builtins.bool]:
        """
    ...
    def splunk_token(self) -> Optional[builtins.str]:
        """
    ...
    def sumo_source_address(self) -> Optional[builtins.str]:
        """
...
class OrganizationBranding(dict):
    ...
    def __init__(__self__, *,
                 colors: Optional[Mapping[str, builtins.str]] = None,
                 logo_url: Optional[builtins.str] = None):
        """
        :param Mapping[str, builtins.str] colors: Color scheme used to customize the login pages.
        :param builtins.str logo_url: URL of logo to display on login page.
        """
    ...
    @property
    @pulumi.getter
    def colors(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class OrganizationConnectionsEnabledConnection(dict):
    ...
    def __init__(__self__, *,
                 ...
                 assign_membership_on_login: Optional[builtins.bool] = None,
                 is_signup_enabled: Optional[builtins.bool] = None,
                 show_as_button: Optional[builtins.bool] = None):
        """
        :param builtins.str connection_id: The ID of the connection to enable for the organization.
        :param builtins.bool assign_membership_on_login: When `true`, all users that log in with this connection will be automatically granted membership in the organization. When `false`, users must be granted membership in the organization before logging in with this connection.
        :param builtins.bool is_signup_enabled: Determines whether organization sign-up should be enabled for this organization connection. Only applicable for database connections. Note: `is_signup_enabled` can only be `true` if `assign_membership_on_login` is `true`.
        :param builtins.bool show_as_button: Determines whether a connection should be displayed on this organization’s login prompt. Only applicable for enterprise connections.
        """
    ...
    def assign_membership_on_login(self) -> Optional[builtins.bool]:
        """
    ...
    def is_signup_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def show_as_button(self) -> Optional[builtins.bool]:
        """
...
class PagesChangePassword(dict):
    def __init__(__self__, *,
                 ...
                 html: builtins.str):
        """
        :param builtins.bool enabled: Indicates whether to use the custom Reset Password HTML (`true`) or the default Auth0 page (`false`).
        :param builtins.str html: Customized content for the Reset Password page. HTML format with supported [Liquid syntax](https://github.com/Shopify/liquid/wiki/Liquid-for-Designers).
        """
        pulumi.set(__self__, "enabled", enabled)
...
class PagesError(dict):
    ...
    def __init__(__self__, *,
                 ...
                 url: Optional[builtins.str] = None):
        """
        :param builtins.bool show_log_link: Indicates whether to show the link to logs as part of the default error page.
        :param builtins.str html: Customized content for the Error page. HTML format with supported [Liquid syntax](https://github.com/Shopify/liquid/wiki/Liquid-for-Designers).
...
class PagesGuardianMfa(dict):
    def __init__(__self__, *,
                 ...
                 html: builtins.str):
        """
        :param builtins.bool enabled: Indicates whether to use the custom Guardian MFA HTML (`true`) or the default Auth0 page (`false`).
        :param builtins.str html: Customized content for the Guardian MFA page. HTML format with supported [Liquid syntax](https://github.com/Shopify/liquid/wiki/Liquid-for-Designers).
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "html", html)
...
class PagesLogin(dict):
    def __init__(__self__, *,
                 ...
                 html: builtins.str):
        """
        :param builtins.bool enabled: Indicates whether to use the custom Login page HTML (`true`) or the default Auth0 page (`false`).
        :param builtins.str html: Customized content for the Login page. HTML format with supported [Liquid syntax](https://github.com/Shopify/liquid/wiki/Liquid-for-Designers).
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "html", html)
...
class PhoneProviderConfiguration(dict):
    ...
    def __init__(__self__, *,
                 delivery_methods: Sequence[builtins.str],
                 default_from: Optional[builtins.str] = None,
                 mssid: Optional[builtins.str] = None,
                 sid: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] delivery_methods: Media set supported by a given provider to deliver a notification
        :param builtins.str default_from: Default sender subject as "from" when no other value is specified.
        :param builtins.str mssid: Twilio Messaging Service SID
        :param builtins.str sid: Twilio Account SID.
        """
    ...
    def delivery_methods(self) -> Sequence[builtins.str]:
        """
    ...
    def default_from(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def mssid(self) -> Optional[builtins.str]:
        """
...
class PhoneProviderCredentials(dict):
    ...
    def __init__(__self__, *,
                 auth_token: Optional[builtins.str] = None):
        """
        :param builtins.str auth_token: The Auth Token for the phone provider.
        """
        if auth_token is not None:
            pulumi.set(__self__, "auth_token", auth_token)
...
class PromptScreenPartialInsertionPoints(dict):
    ...
    def __init__(__self__, *,
                 form_content: Optional[builtins.str] = None,
                 form_content_end: Optional[builtins.str] = None,
                 form_content_start: Optional[builtins.str] = None,
                 form_footer_end: Optional[builtins.str] = None,
                 form_footer_start: Optional[builtins.str] = None,
                 secondary_actions_end: Optional[builtins.str] = None,
                 secondary_actions_start: Optional[builtins.str] = None):
        """
    ...
    def form_content(self) -> Optional[builtins.str]:
        """
    ...
    def form_content_end(self) -> Optional[builtins.str]:
        """
    ...
    def form_content_start(self) -> Optional[builtins.str]:
        """
    ...
    def form_footer_end(self) -> Optional[builtins.str]:
        """
    ...
    def form_footer_start(self) -> Optional[builtins.str]:
        """
    ...
    def secondary_actions_end(self) -> Optional[builtins.str]:
        """
    ...
    def secondary_actions_start(self) -> Optional[builtins.str]:
        """
...
class PromptScreenRendererFilters(dict):
    ...
    def __init__(__self__, *,
                 ...
                 clients: Optional[builtins.str] = None,
                 domains: Optional[builtins.str] = None,
                 organizations: Optional[builtins.str] = None):
        """
        :param builtins.str match_type: Type of match to apply. Options: `includes_any`, `excludes_any`.
        :param builtins.str clients: An array of clients (applications) identified by id or a metadata key/value pair. Entity Limit: 25.
        :param builtins.str domains: An array of domains identified by id or a metadata key/value pair. Entity Limit: 25.
        :param builtins.str organizations: An array of organizations identified by id or a metadata key/value pair. Entity Limit: 25.
        """
    ...
    @property
    @pulumi.getter
    def clients(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def domains(self) -> Optional[builtins.str]:
        """
...
class ResourceServerAuthorizationDetail(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.bool disable: Disable authorization details.
        :param builtins.str type: Type of authorization details.
        """
        if disable is not None:
            pulumi.set(__self__, "disable", disable)
        if type is not None:
...
class ResourceServerProofOfPossession(dict):
    def __init__(__self__, *,
                 ...
                 required: Optional[builtins.bool] = None):
        """
        :param builtins.bool disable: Disable proof-of-possession.
        :param builtins.str mechanism: Mechanism used for proof-of-possession. Only `mtls` is supported.
        :param builtins.bool required: Indicates whether proof-of-possession is required with this resource server.
        """
        if disable is not None:
            pulumi.set(__self__, "disable", disable)
...
class ResourceServerScopesScope(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name of the scope (permission). Examples include `read:appointments` or `delete:appointments`.
        :param builtins.str description: User-friendly description of the scope (permission).
        """
        pulumi.set(__self__, "name", name)
...
class ResourceServerTokenEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool disable: Disable token encryption.
        :param 'ResourceServerTokenEncryptionEncryptionKeyArgs' encryption_key: Authorization details for this resource server.
        :param builtins.str format: Format of the token encryption. Only `compact-nested-jwe` is supported.
        """
        if disable is not None:
            pulumi.set(__self__, "disable", disable)
...
class ResourceServerTokenEncryptionEncryptionKey(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str algorithm: Algorithm used to encrypt the token.
        :param builtins.str pem: PEM-formatted public key. Must be JSON escaped.
        :param builtins.str kid: Key ID.
        :param builtins.str name: Name of the encryption key.
        """
        pulumi.set(__self__, "algorithm", algorithm)
        pulumi.set(__self__, "pem", pem)
        if kid is not None:
...
class RolePermissionsPermission(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 resource_server_identifier: builtins.str,
                 description: Optional[builtins.str] = None,
                 resource_server_name: Optional[builtins.str] = None):
        """
        :param builtins.str name: Name of permission.
        :param builtins.str resource_server_identifier: Resource server identifier associated with the permission.
        :param builtins.str description: Description of the permission.
        :param builtins.str resource_server_name: Name of resource server that the permission is associated with.
        """
        pulumi.set(__self__, "name", name)
    ...
    def resource_server_identifier(self) -> builtins.str:
        """
    ...
    def resource_server_name(self) -> Optional[builtins.str]:
        """
...
class SelfServiceProfileUserAttribute(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str description: A human readable description of the attribute.
        :param builtins.bool is_optional: Indicates if this attribute is optional or if it has to be provided by the customer for the application to function.
        :param builtins.str name: Attribute’s name on Auth0 side
        """
        pulumi.set(__self__, "description", description)
...
class TenantFlags(dict):
    ...
    def __init__(__self__, *,
                 allow_legacy_delegation_grant_types: Optional[builtins.bool] = None,
                 allow_legacy_ro_grant_types: Optional[builtins.bool] = None,
                 allow_legacy_tokeninfo_endpoint: Optional[builtins.bool] = None,
                 dashboard_insights_view: Optional[builtins.bool] = None,
                 dashboard_log_streams_next: Optional[builtins.bool] = None,
                 disable_clickjack_protection_headers: Optional[builtins.bool] = None,
                 disable_fields_map_fix: Optional[builtins.bool] = None,
                 disable_management_api_sms_obfuscation: Optional[builtins.bool] = None,
                 enable_adfs_waad_email_verification: Optional[builtins.bool] = None,
                 enable_apis_section: Optional[builtins.bool] = None,
                 enable_client_connections: Optional[builtins.bool] = None,
                 enable_custom_domain_in_emails: Optional[builtins.bool] = None,
                 enable_dynamic_client_registration: Optional[builtins.bool] = None,
                 enable_idtoken_api2: Optional[builtins.bool] = None,
                 enable_legacy_logs_search_v2: Optional[builtins.bool] = None,
                 enable_legacy_profile: Optional[builtins.bool] = None,
                 enable_pipeline2: Optional[builtins.bool] = None,
                 enable_public_signup_user_exists_error: Optional[builtins.bool] = None,
                 enable_sso: Optional[builtins.bool] = None,
                 mfa_show_factor_list_on_enrollment: Optional[builtins.bool] = None,
                 no_disclose_enterprise_connections: Optional[builtins.bool] = None,
                 remove_alg_from_jwks: Optional[builtins.bool] = None,
                 require_pushed_authorization_requests: Optional[builtins.bool] = None,
                 revoke_refresh_token_grant: Optional[builtins.bool] = None,
                 use_scope_descriptions_for_consent: Optional[builtins.bool] = None):
        """
        :param builtins.bool allow_legacy_delegation_grant_types: Whether the legacy delegation endpoint will be enabled for your account (true) or not available (false).
        :param builtins.bool allow_legacy_ro_grant_types: Whether the legacy `auth/ro` endpoint (used with resource owner password and passwordless features) will be enabled for your account (true) or not available (false).
        :param builtins.bool allow_legacy_tokeninfo_endpoint: If enabled, customers can use Tokeninfo Endpoint, otherwise they can not use it.
        :param builtins.bool dashboard_insights_view: Enables new insights activity page view.
        :param builtins.bool dashboard_log_streams_next: Enables beta access to log streaming changes.
        :param builtins.bool disable_clickjack_protection_headers: Indicates whether classic Universal Login prompts include additional security headers to prevent clickjacking.
        :param builtins.bool disable_fields_map_fix: Disables SAML fields map fix for bad mappings with repeated attributes.
        :param builtins.bool disable_management_api_sms_obfuscation: If true, SMS phone numbers will not be obfuscated in Management API GET calls.
        :param builtins.bool enable_adfs_waad_email_verification: If enabled, users will be presented with an email verification prompt during their first login when using Azure AD or ADFS connections.
        :param builtins.bool enable_apis_section: Indicates whether the APIs section is enabled for the tenant.
        :param builtins.bool enable_client_connections: Indicates whether all current connections should be enabled when a new client is created.
        :param builtins.bool enable_custom_domain_in_emails: Indicates whether the tenant allows custom domains in emails. Before enabling this flag, you must have a custom domain with status: `ready`.
        :param builtins.bool enable_dynamic_client_registration: Indicates whether the tenant allows dynamic client registration.
        :param builtins.bool enable_idtoken_api2: Whether ID tokens can be used to authorize some types of requests to API v2 (true) or not (false).
        :param builtins.bool enable_legacy_logs_search_v2: Indicates whether to use the older v2 legacy logs search.
        :param builtins.bool enable_legacy_profile: Whether ID tokens and the userinfo endpoint includes a complete user profile (true) or only OpenID Connect claims (false).
        :param builtins.bool enable_pipeline2: Indicates whether advanced API Authorization scenarios are enabled.
        :param builtins.bool enable_public_signup_user_exists_error: Indicates whether the public sign up process shows a `user_exists` error if the user already exists.
        :param builtins.bool enable_sso: Flag indicating whether users will not be prompted to confirm log in before SSO redirection. This flag applies to existing tenants only; new tenants have it enforced as true.
        :param builtins.bool mfa_show_factor_list_on_enrollment: Used to allow users to pick which factor to enroll with from the list of available MFA factors.
        :param builtins.bool no_disclose_enterprise_connections: Do not Publish Enterprise Connections Information with IdP domains on the lock configuration file.
        :param builtins.bool remove_alg_from_jwks: Remove `alg` from jwks(JSON Web Key Sets).
        :param builtins.bool require_pushed_authorization_requests: This Flag is not supported by the Auth0 Management API and will be removed in the next major release.
        :param builtins.bool revoke_refresh_token_grant: Delete underlying grant when a refresh token is revoked via the Authentication API.
        :param builtins.bool use_scope_descriptions_for_consent: Indicates whether to use scope descriptions for consent.
        """
    ...
    def allow_legacy_delegation_grant_types(self) -> Optional[builtins.bool]:
        """
    ...
    def allow_legacy_ro_grant_types(self) -> Optional[builtins.bool]:
        """
    ...
    def allow_legacy_tokeninfo_endpoint(self) -> Optional[builtins.bool]:
        """
    ...
    def dashboard_insights_view(self) -> Optional[builtins.bool]:
        """
    ...
    def dashboard_log_streams_next(self) -> Optional[builtins.bool]:
        """
    ...
    def disable_clickjack_protection_headers(self) -> Optional[builtins.bool]:
        """
    ...
    def disable_fields_map_fix(self) -> Optional[builtins.bool]:
        """
    ...
    def disable_management_api_sms_obfuscation(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_adfs_waad_email_verification(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_apis_section(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_client_connections(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_custom_domain_in_emails(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_dynamic_client_registration(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_idtoken_api2(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_legacy_logs_search_v2(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_legacy_profile(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_pipeline2(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_public_signup_user_exists_error(self) -> Optional[builtins.bool]:
        """
    ...
    def mfa_show_factor_list_on_enrollment(self) -> Optional[builtins.bool]:
        """
    ...
    def no_disclose_enterprise_connections(self) -> Optional[builtins.bool]:
        """
    ...
    def remove_alg_from_jwks(self) -> Optional[builtins.bool]:
        """
    ...
    def require_pushed_authorization_requests(self) -> Optional[builtins.bool]:
        """
    ...
    def revoke_refresh_token_grant(self) -> Optional[builtins.bool]:
        """
    ...
    def use_scope_descriptions_for_consent(self) -> Optional[builtins.bool]:
        """
...
class TenantMtls(dict):
    ...
    def __init__(__self__, *,
                 disable: Optional[builtins.bool] = None,
                 enable_endpoint_aliases: Optional[builtins.bool] = None):
        """
        :param builtins.bool disable: Disable mTLS settings.
        :param builtins.bool enable_endpoint_aliases: Enable mTLS endpoint aliases.
        """
        if disable is not None:
            pulumi.set(__self__, "disable", disable)
    ...
    def enable_endpoint_aliases(self) -> Optional[builtins.bool]:
        """
...
class TenantSessionCookie(dict):
    def __init__(__self__, *,
                 mode: Optional[builtins.str] = None):
        """
        :param builtins.str mode: Behavior of tenant session cookie. Accepts either "persistent" or "non-persistent".
        """
        if mode is not None:
            pulumi.set(__self__, "mode", mode)
...
class TenantSessions(dict):
    ...
    def __init__(__self__, *,
                 oidc_logout_prompt_enabled: builtins.bool):
        """
        :param builtins.bool oidc_logout_prompt_enabled: When active, users will be presented with a consent prompt to confirm the logout request if the request is not trustworthy. Turn off the consent prompt to bypass user confirmation.
        """
        pulumi.set(__self__, "oidc_logout_prompt_enabled", oidc_logout_prompt_enabled)

    @property
    @pulumi.getter(name="oidcLogoutPromptEnabled")
    def oidc_logout_prompt_enabled(self) -> builtins.bool:
        """
...
class TriggerActionsAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: builtins.str):
        """
        :param builtins.str display_name: The display name of the action within the flow.
        :param builtins.str id: Action ID.
        """
...
class GetAttackProtectionBreachedPasswordDetectionResult(dict):
    ...
    @property
    @pulumi.getter(name="adminNotificationFrequencies")
    def admin_notification_frequencies(self) -> Sequence[builtins.str]:
        """
        When `admin_notification` is enabled within the `shields` property, determines how often email notifications are sent. Possible values: `immediately`, `daily`, `weekly`, `monthly`.
        """
        return pulumi.get(self, "admin_notification_frequencies")
...
class GetAttackProtectionBruteForceProtectionResult(dict):
    def __init__(__self__, *,
                 allowlists: Sequence[builtins.str],
                 enabled: builtins.bool,
    ...
    @property
    @pulumi.getter
    def allowlists(self) -> Sequence[builtins.str]:
        """
        List of trusted IP addresses that will not have attack protection enforced against them. This field allows you to specify multiple IP addresses, or ranges. You can use IPv4 or IPv6 addresses and CIDR notation.
        """
        return pulumi.get(self, "allowlists")
...
class GetBrandingColorResult(dict):
    ...
    @property
    @pulumi.getter(name="pageBackground")
    def page_background(self) -> builtins.str:
        """
        Background color of login pages in hexadecimal.
        """
        return pulumi.get(self, "page_background")
...
class GetBrandingThemeBorderResult(dict):
    def __init__(__self__, *,
                 button_border_radius: builtins.float,
                 button_border_weight: builtins.float,
                 buttons_style: builtins.str,
                 input_border_radius: builtins.float,
                 input_border_weight: builtins.float,
                 inputs_style: builtins.str,
                 show_widget_shadow: builtins.bool,
                 widget_border_weight: builtins.float,
                 widget_corner_radius: builtins.float):
        """
        :param builtins.float button_border_radius: Button border radius. Value needs to be between `1` and `10`. Defaults to `3.0`.
        :param builtins.float button_border_weight: Button border weight. Value needs to be between `0` and `10`. Defaults to `1.0`.
        :param builtins.str buttons_style: Buttons style. Available options: `pill`, `rounded`, `sharp`. Defaults to `rounded`.
    ...
    @property
    @pulumi.getter(name="buttonBorderRadius")
    def button_border_radius(self) -> builtins.float:
        """
        Button border radius. Value needs to be between `1` and `10`. Defaults to `3.0`.
        """
        return pulumi.get(self, "button_border_radius")
    ...
    @property
    @pulumi.getter(name="buttonBorderWeight")
    def button_border_weight(self) -> builtins.float:
        """
        Button border weight. Value needs to be between `0` and `10`. Defaults to `1.0`.
        """
        return pulumi.get(self, "button_border_weight")
    ...
    @property
    @pulumi.getter(name="buttonsStyle")
    def buttons_style(self) -> builtins.str:
        """
        Buttons style. Available options: `pill`, `rounded`, `sharp`. Defaults to `rounded`.
        """
        return pulumi.get(self, "buttons_style")
    ...
    @property
    @pulumi.getter(name="inputBorderRadius")
    def input_border_radius(self) -> builtins.float:
        """
        Input border radius. Value needs to be between `0` and `10`. Defaults to `3.0`.
        """
        return pulumi.get(self, "input_border_radius")
    ...
    @property
    @pulumi.getter(name="inputBorderWeight")
    def input_border_weight(self) -> builtins.float:
        """
        Input border weight. Value needs to be between `0` and `3`. Defaults to `1.0`.
        """
        return pulumi.get(self, "input_border_weight")
    ...
    @property
    @pulumi.getter(name="inputsStyle")
    def inputs_style(self) -> builtins.str:
        """
        Inputs style. Available options: `pill`, `rounded`, `sharp`. Defaults to `rounded`.
        """
        return pulumi.get(self, "inputs_style")
    ...
    @property
    @pulumi.getter(name="showWidgetShadow")
    def show_widget_shadow(self) -> builtins.bool:
        """
        Show widget shadow. Defaults to `true`.
        """
        return pulumi.get(self, "show_widget_shadow")
    ...
    @property
    @pulumi.getter(name="widgetBorderWeight")
    def widget_border_weight(self) -> builtins.float:
        """
        Widget border weight. Value needs to be between `0` and `10`. Defaults to `0.0`.
        """
        return pulumi.get(self, "widget_border_weight")
    ...
    @property
    @pulumi.getter(name="widgetCornerRadius")
    def widget_corner_radius(self) -> builtins.float:
        """
        Widget corner radius. Value needs to be between `0` and `50`. Defaults to `5.0`.
        """
        return pulumi.get(self, "widget_corner_radius")
...
class GetBrandingThemeColorResult(dict):
    def __init__(__self__, *,
                 base_focus_color: builtins.str,
                 base_hover_color: builtins.str,
                 body_text: builtins.str,
                 captcha_widget_theme: builtins.str,
                 error: builtins.str,
                 header: builtins.str,
                 icons: builtins.str,
                 input_background: builtins.str,
                 input_border: builtins.str,
                 input_filled_text: builtins.str,
                 input_labels_placeholders: builtins.str,
                 links_focused_components: builtins.str,
                 primary_button: builtins.str,
                 primary_button_label: builtins.str,
                 secondary_button_border: builtins.str,
                 secondary_button_label: builtins.str,
                 success: builtins.str,
                 widget_background: builtins.str,
                 widget_border: builtins.str):
        """
        :param builtins.str base_focus_color: Base focus color. Defaults to `#635dff`.
        :param builtins.str base_hover_color: Base hover color. Defaults to `#000000`.
        :param builtins.str body_text: Body text. Defaults to `#1e212a`.
    ...
    @property
    @pulumi.getter(name="baseFocusColor")
    def base_focus_color(self) -> builtins.str:
        """
        Base focus color. Defaults to `#635dff`.
        """
        return pulumi.get(self, "base_focus_color")
    ...
    @property
    @pulumi.getter(name="baseHoverColor")
    def base_hover_color(self) -> builtins.str:
        """
        Base hover color. Defaults to `#000000`.
        """
        return pulumi.get(self, "base_hover_color")
    ...
    @property
    @pulumi.getter(name="bodyText")
    def body_text(self) -> builtins.str:
        """
        Body text. Defaults to `#1e212a`.
        """
        return pulumi.get(self, "body_text")
    ...
    @property
    @pulumi.getter(name="captchaWidgetTheme")
    def captcha_widget_theme(self) -> builtins.str:
        """
        Captcha Widget Theme.
        """
        return pulumi.get(self, "captcha_widget_theme")
    ...
    @property
    @pulumi.getter(name="inputBackground")
    def input_background(self) -> builtins.str:
        """
        Input background. Defaults to `#ffffff`.
        """
        return pulumi.get(self, "input_background")
    ...
    @property
    @pulumi.getter(name="inputBorder")
    def input_border(self) -> builtins.str:
        """
        Input border. Defaults to `#c9cace`.
        """
        return pulumi.get(self, "input_border")
    ...
    @property
    @pulumi.getter(name="inputFilledText")
    def input_filled_text(self) -> builtins.str:
        """
        Input filled text. Defaults to `#000000`.
        """
        return pulumi.get(self, "input_filled_text")
    ...
    @property
    @pulumi.getter(name="inputLabelsPlaceholders")
    def input_labels_placeholders(self) -> builtins.str:
        """
        Input labels & placeholders. Defaults to `#65676e`.
        """
        return pulumi.get(self, "input_labels_placeholders")
    ...
    @property
    @pulumi.getter(name="linksFocusedComponents")
    def links_focused_components(self) -> builtins.str:
        """
        Links & focused components. Defaults to `#635dff`.
        """
        return pulumi.get(self, "links_focused_components")
    ...
    @property
    @pulumi.getter(name="primaryButton")
    def primary_button(self) -> builtins.str:
        """
        Primary button. Defaults to `#635dff`.
        """
        return pulumi.get(self, "primary_button")
    ...
    @property
    @pulumi.getter(name="primaryButtonLabel")
    def primary_button_label(self) -> builtins.str:
        """
        Primary button label. Defaults to `#ffffff`.
        """
        return pulumi.get(self, "primary_button_label")
    ...
    @property
    @pulumi.getter(name="secondaryButtonBorder")
    def secondary_button_border(self) -> builtins.str:
        """
        Secondary button border. Defaults to `#c9cace`.
        """
        return pulumi.get(self, "secondary_button_border")
    ...
    @property
    @pulumi.getter(name="secondaryButtonLabel")
    def secondary_button_label(self) -> builtins.str:
        """
        Secondary button label. Defaults to `#1e212a`.
        """
        return pulumi.get(self, "secondary_button_label")
    ...
    @property
    @pulumi.getter(name="widgetBackground")
    def widget_background(self) -> builtins.str:
        """
        Widget background. Defaults to `#ffffff`.
        """
        return pulumi.get(self, "widget_background")
    ...
    @property
    @pulumi.getter(name="widgetBorder")
    def widget_border(self) -> builtins.str:
        """
        Widget border. Defaults to `#c9cace`.
        """
        return pulumi.get(self, "widget_border")
...
class GetBrandingThemeFontResult(dict):
    ...
    @property
    @pulumi.getter(name="fontUrl")
    def font_url(self) -> builtins.str:
        """
        Font URL. Defaults to an empty string.
        """
        return pulumi.get(self, "font_url")
    ...
    @property
    @pulumi.getter(name="linksStyle")
    def links_style(self) -> builtins.str:
        """
        Links style. Defaults to `normal`.
        """
        return pulumi.get(self, "links_style")
    ...
    @property
    @pulumi.getter(name="referenceTextSize")
    def reference_text_size(self) -> builtins.float:
        """
        Reference text size. Value needs to be between `12` and `24`. Defaults to `16.0`.
        """
        return pulumi.get(self, "reference_text_size")
...
class GetBrandingThemePageBackgroundResult(dict):
    ...
    @property
    @pulumi.getter(name="pageLayout")
    def page_layout(self) -> builtins.str:
        """
        Page layout. Available options: `center`, `left`, `right`. Defaults to `center`.
        """
        return pulumi.get(self, "page_layout")
...
class GetBrandingThemeWidgetResult(dict):
    def __init__(__self__, *,
                 header_text_alignment: builtins.str,
                 logo_height: builtins.float,
                 logo_position: builtins.str,
                 logo_url: builtins.str,
                 social_buttons_layout: builtins.str):
        """
        :param builtins.str header_text_alignment: Header text alignment. Available options: `center`, `left`, `right`. Defaults to `center`.
        :param builtins.float logo_height: Logo height. Value needs to be between `1` and `100`. Defaults to `52.0`.
        :param builtins.str logo_position: Logo position. Available options: `center`, `left`, `right`, `none`. Defaults to `center`.
    ...
    @property
    @pulumi.getter(name="headerTextAlignment")
    def header_text_alignment(self) -> builtins.str:
        """
        Header text alignment. Available options: `center`, `left`, `right`. Defaults to `center`.
        """
        return pulumi.get(self, "header_text_alignment")
    ...
    @property
    @pulumi.getter(name="logoHeight")
    def logo_height(self) -> builtins.float:
        """
        Logo height. Value needs to be between `1` and `100`. Defaults to `52.0`.
        """
        return pulumi.get(self, "logo_height")
    ...
    @property
    @pulumi.getter(name="logoPosition")
    def logo_position(self) -> builtins.str:
        """
        Logo position. Available options: `center`, `left`, `right`, `none`. Defaults to `center`.
        """
        return pulumi.get(self, "logo_position")
    ...
    @property
    @pulumi.getter(name="socialButtonsLayout")
    def social_buttons_layout(self) -> builtins.str:
        """
        Social buttons layout. Available options: `bottom`, `top`. Defaults to `bottom`.
        """
        return pulumi.get(self, "social_buttons_layout")
...
class GetClientAddonAwResult(dict):
    ...
    @property
    @pulumi.getter(name="lifetimeInSeconds")
    def lifetime_in_seconds(self) -> builtins.int:
        """
        AWS token lifetime in seconds.
        """
        return pulumi.get(self, "lifetime_in_seconds")
...
class GetClientAddonAzureBlobResult(dict):
    def __init__(__self__, *,
                 ...
                 blob_delete: builtins.bool,
                 blob_name: builtins.str,
                 blob_read: builtins.bool,
                 blob_write: builtins.bool,
                 container_delete: builtins.bool,
                 container_list: builtins.bool,
                 container_name: builtins.str,
                 container_read: builtins.bool,
                 container_write: builtins.bool,
                 expiration: builtins.int,
                 signed_identifier: builtins.str,
                 storage_access_key: builtins.str):
        """
        :param builtins.str account_name: Your Azure storage account name. Usually first segment in your Azure storage URL, for example `https://acme-org.blob.core.windows.net` would be the account name `acme-org`.
        :param builtins.bool blob_delete: Indicates if the issued token has permission to delete the blob.
        :param builtins.str blob_name: Entity to request a token for, such as `my-blob`. If blank the computed SAS will apply to the entire storage container.
    ...
    @property
    @pulumi.getter(name="blobDelete")
    def blob_delete(self) -> builtins.bool:
        """
        Indicates if the issued token has permission to delete the blob.
        """
        return pulumi.get(self, "blob_delete")
    ...
    @property
    @pulumi.getter(name="blobRead")
    def blob_read(self) -> builtins.bool:
        """
        Indicates if the issued token has permission to read the content, properties, metadata and block list. Use the blob as the source of a copy operation.
        """
        return pulumi.get(self, "blob_read")
    ...
    @property
    @pulumi.getter(name="blobWrite")
    def blob_write(self) -> builtins.bool:
        """
        Indicates if the issued token has permission to create or write content, properties, metadata, or block list. Snapshot or lease the blob. Resize the blob (page blob only). Use the blob as the destination of a copy operation within the same account.
        """
        return pulumi.get(self, "blob_write")
    ...
    @property
    @pulumi.getter(name="containerDelete")
    def container_delete(self) -> builtins.bool:
        """
        Indicates if issued token has permission to delete any blob in the container.
        """
        return pulumi.get(self, "container_delete")
    ...
    @property
    @pulumi.getter(name="containerList")
    def container_list(self) -> builtins.bool:
        """
        Indicates if the issued token has permission to list blobs in the container.
        """
        return pulumi.get(self, "container_list")
    ...
    @property
    @pulumi.getter(name="containerRead")
    def container_read(self) -> builtins.bool:
        """
        Indicates if the issued token has permission to read the content, properties, metadata or block list of any blob in the container. Use any blob in the container as the source of a copy operation.
        """
        return pulumi.get(self, "container_read")
    ...
    @property
    @pulumi.getter(name="containerWrite")
    def container_write(self) -> builtins.bool:
        """
        Indicates that for any blob in the container if the issued token has permission to create or write content, properties, metadata, or block list. Snapshot or lease the blob. Resize the blob (page blob only). Use the blob as the destination of a copy operation within the same account.
        """
        return pulumi.get(self, "container_write")
    ...
    @property
    @pulumi.getter
    def expiration(self) -> builtins.int:
        """
        Expiration in minutes for the generated token (default of 5 minutes).
        """
        return pulumi.get(self, "expiration")
    ...
    @property
    @pulumi.getter(name="signedIdentifier")
    def signed_identifier(self) -> builtins.str:
        """
        Shared access policy identifier defined in your storage account resource.
        """
        return pulumi.get(self, "signed_identifier")
...
class GetClientAddonAzureSbResult(dict):
    ...
    @property
    @pulumi.getter(name="sasKeyName")
    def sas_key_name(self) -> builtins.str:
        """
        Your shared access policy name defined in your Service Bus entity.
        """
        return pulumi.get(self, "sas_key_name")
...
class GetClientAddonSalesforceApiResult(dict):
    def __init__(__self__, *,
                 ...
                 community_url_section: builtins.str,
                 principal: builtins.str):
        """
        :param builtins.str client_id: Consumer Key assigned by Salesforce to the Connected App.
        :param builtins.str community_name: Community name.
    ...
    @property
    @pulumi.getter(name="communityName")
    def community_name(self) -> builtins.str:
        """
        Community name.
        """
        return pulumi.get(self, "community_name")
    ...
    @property
    @pulumi.getter(name="communityUrlSection")
    def community_url_section(self) -> builtins.str:
        """
        Community URL section.
        """
        return pulumi.get(self, "community_url_section")
...
class GetClientAddonSamlpResult(dict):
    def __init__(__self__, *,
                 audience: builtins.str,
                 authn_context_class_ref: builtins.str,
                 ...
                 map_identities: builtins.bool,
                 map_unknown_claims_as_is: builtins.bool,
                 mappings: Mapping[str, builtins.str],
                 name_identifier_format: builtins.str,
                 name_identifier_probes: Sequence[builtins.str],
                 passthrough_claims_with_no_mapping: builtins.bool,
                 recipient: builtins.str,
                 sign_response: builtins.bool,
                 signature_algorithm: builtins.str,
                 signing_cert: builtins.str,
                 typed_attributes: builtins.bool):
        """
        :param builtins.str audience: Audience of the SAML Assertion. Default will be the Issuer on SAMLRequest.
        :param builtins.str authn_context_class_ref: Class reference of the authentication context.
        :param builtins.str binding: Protocol binding used for SAML logout responses.
    ...
    @property
    @pulumi.getter(name="createUpnClaim")
    def create_upn_claim(self) -> builtins.bool:
        """
        Indicates whether a UPN claim should be created. Defaults to `true`.
        """
        return pulumi.get(self, "create_upn_claim")
    ...
    @property
    @pulumi.getter(name="includeAttributeNameFormat")
    def include_attribute_name_format(self) -> builtins.bool:
        """
        Indicates whether or not we should infer the NameFormat based on the attribute name. If set to `false`, the attribute NameFormat is not set in the assertion. Defaults to `true`.
        """
        return pulumi.get(self, "include_attribute_name_format")
    ...
    @property
    @pulumi.getter(name="mapIdentities")
    def map_identities(self) -> builtins.bool:
        """
        Indicates whether or not to add additional identity information in the token, such as the provider used and the `access_token`, if available. Defaults to `true`.
        """
        return pulumi.get(self, "map_identities")
    ...
    @property
    @pulumi.getter(name="mapUnknownClaimsAsIs")
    def map_unknown_claims_as_is(self) -> builtins.bool:
        """
        Indicates whether to add a prefix of `http://schema.auth0.com` to any claims that are not mapped to the common profile when passed through in the output assertion. Defaults to `false`.
        """
        return pulumi.get(self, "map_unknown_claims_as_is")
    ...
    @property
    @pulumi.getter(name="nameIdentifierFormat")
    def name_identifier_format(self) -> builtins.str:
        """
        Format of the name identifier. Defaults to `urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified`.
        """
        return pulumi.get(self, "name_identifier_format")
    ...
    @property
    @pulumi.getter(name="nameIdentifierProbes")
    def name_identifier_probes(self) -> Sequence[builtins.str]:
        """
        Attributes that can be used for Subject/NameID. Auth0 will try each of the attributes of this array in order and use the first value it finds.
        """
        return pulumi.get(self, "name_identifier_probes")
    ...
    @property
    @pulumi.getter(name="passthroughClaimsWithNoMapping")
    def passthrough_claims_with_no_mapping(self) -> builtins.bool:
        """
        Indicates whether or not to passthrough claims that are not mapped to the common profile in the output assertion. Defaults to `true`.
        """
        return pulumi.get(self, "passthrough_claims_with_no_mapping")
    ...
    @property
    @pulumi.getter(name="signResponse")
    def sign_response(self) -> builtins.bool:
        """
        Indicates whether or not the SAML Response should be signed instead of the SAML Assertion.
        """
        return pulumi.get(self, "sign_response")
    ...
    @property
    @pulumi.getter(name="signingCert")
    def signing_cert(self) -> builtins.str:
        """
        Optionally indicates the public key certificate used to validate SAML requests. If set, SAML requests will be required to be signed. A sample value would be `-----BEGIN PUBLIC KEY-----\\nMIGf...bpP/t3\\n+JGNGIRMj1hF1rnb6QIDAQAB\\n-----END PUBLIC KEY-----\\n`.
        """
        return pulumi.get(self, "signing_cert")
    ...
    @property
    @pulumi.getter(name="typedAttributes")
    def typed_attributes(self) -> builtins.bool:
        """
        Indicates whether or not we should infer the `xs:type` of the element. Types include `xs:string`, `xs:boolean`, `xs:double`, and `xs:anyType`. When set to `false`, all `xs:type` are `xs:anyType`. Defaults to `true`.
        """
        return pulumi.get(self, "typed_attributes")
...
class GetClientAddonSamlpLogoutResult(dict):
    ...
    @property
    @pulumi.getter(name="sloEnabled")
    def slo_enabled(self) -> builtins.bool:
        """
        Controls whether Auth0 should notify service providers of session termination.
        """
        return pulumi.get(self, "slo_enabled")
...
class GetClientAddonSapApiResult(dict):
    def __init__(__self__, *,
                 ...
                 name_identifier_format: builtins.str,
                 scope: builtins.str,
                 service_password: builtins.str,
                 token_endpoint_url: builtins.str,
                 username_attribute: builtins.str):
        """
        :param builtins.str client_id: If activated in the OAuth 2.0 client configuration (transaction `SOAUTH2) the SAML attribute `client_id` must be set and equal the `client_id` form parameter of the access token request.
        :param builtins.str name_identifier_format: NameID element of the Subject which can be used to express the user's identity. Defaults to `urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified`.
        :param builtins.str scope: Requested scope for SAP APIs.
        :param builtins.str service_password: Service account password to use to authenticate API calls to the token endpoint.
        :param builtins.str token_endpoint_url: The OAuth2 token endpoint URL of your SAP OData server.
...
class GetClientAddonSharepointResult(dict):
    def __init__(__self__, *,
                 external_urls: Sequence[builtins.str],
                 url: builtins.str):
        """
        :param Sequence[builtins.str] external_urls: External SharePoint application URLs if exposed to the Internet.
        :param builtins.str url: Internal SharePoint application URL.
    ...
    @property
    @pulumi.getter(name="externalUrls")
    def external_urls(self) -> Sequence[builtins.str]:
        """
        External SharePoint application URLs if exposed to the Internet.
        """
        return pulumi.get(self, "external_urls")
...
class GetClientDefaultOrganizationResult(dict):
    ...
    @property
    @pulumi.getter
    def flows(self) -> Sequence[builtins.str]:
        """
        Definition of the flow that needs to be configured. Eg. client_credentials
        """
        return pulumi.get(self, "flows")
...
class GetClientJwtConfigurationResult(dict):
    def __init__(__self__, *,
                 alg: builtins.str,
                 lifetime_in_seconds: builtins.int,
                 scopes: Mapping[str, builtins.str],
                 secret_encoded: builtins.bool):
        """
        :param builtins.str alg: Algorithm used to sign JWTs. Can be one of `HS256`, `RS256`, `PS256`.
        :param builtins.int lifetime_in_seconds: Number of seconds during which the JWT will be valid.
        :param Mapping[str, builtins.str] scopes: Permissions (scopes) included in JWTs.
    ...
    @property
    @pulumi.getter
    def scopes(self) -> Mapping[str, builtins.str]:
        """
        Permissions (scopes) included in JWTs.
        """
        return pulumi.get(self, "scopes")
    ...
    @property
    @pulumi.getter(name="secretEncoded")
    def secret_encoded(self) -> builtins.bool:
        """
        Indicates whether the client secret is Base64-encoded.
        """
        return pulumi.get(self, "secret_encoded")
...
class GetClientMobileAndroidResult(dict):
    def __init__(__self__, *,
                 ...
                 sha256_cert_fingerprints: Sequence[builtins.str]):
        pulumi.set(__self__, "app_package_name", app_package_name)
        pulumi.set(__self__, "sha256_cert_fingerprints", sha256_cert_fingerprints)

    @property
    @pulumi.getter(name="appPackageName")
    def app_package_name(self) -> builtins.str:
        return pulumi.get(self, "app_package_name")

    @property
    @pulumi.getter(name="sha256CertFingerprints")
    def sha256_cert_fingerprints(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "sha256_cert_fingerprints")
...
class GetClientMobileIoResult(dict):
    def __init__(__self__, *,
                 app_bundle_identifier: builtins.str,
    ...
    @property
    @pulumi.getter(name="appBundleIdentifier")
    def app_bundle_identifier(self) -> builtins.str:
        return pulumi.get(self, "app_bundle_identifier")
...
class GetClientOidcLogoutBackchannelLogoutInitiatorResult(dict):
    def __init__(__self__, *,
                 mode: builtins.str,
                 selected_initiators: Sequence[builtins.str]):
        """
        :param builtins.str mode: Determines the configuration method for enabling initiators. `custom` enables only the initiators listed in the backchannel_logout_selected_initiators set, `all` enables all current and future initiators.
        :param Sequence[builtins.str] selected_initiators: Contains the list of initiators to be enabled for the given client.
        """
        pulumi.set(__self__, "mode", mode)
        pulumi.set(__self__, "selected_initiators", selected_initiators)
    ...
    @property
    @pulumi.getter(name="selectedInitiators")
    def selected_initiators(self) -> Sequence[builtins.str]:
        """
        Contains the list of initiators to be enabled for the given client.
        """
        return pulumi.get(self, "selected_initiators")
...
class GetClientRefreshTokenResult(dict):
    def __init__(__self__, *,
                 expiration_type: builtins.str,
                 idle_token_lifetime: builtins.int,
    ...
    @property
    @pulumi.getter(name="idleTokenLifetime")
    def idle_token_lifetime(self) -> builtins.int:
        """
        The time in seconds after which inactive refresh tokens will expire.
        """
        return pulumi.get(self, "idle_token_lifetime")
    ...
    @property
    @pulumi.getter(name="infiniteIdleTokenLifetime")
    def infinite_idle_token_lifetime(self) -> builtins.bool:
        """
        Whether inactive refresh tokens should remain valid indefinitely.
        """
        return pulumi.get(self, "infinite_idle_token_lifetime")
    ...
    @property
    @pulumi.getter(name="infiniteTokenLifetime")
    def infinite_token_lifetime(self) -> builtins.bool:
        """
        Whether refresh tokens should remain valid indefinitely. If false, `token_lifetime` should also be set.
        """
        return pulumi.get(self, "infinite_token_lifetime")
    ...
    @property
    @pulumi.getter(name="tokenLifetime")
    def token_lifetime(self) -> builtins.int:
        """
        The absolute lifetime of a refresh token in seconds.
        """
        return pulumi.get(self, "token_lifetime")
...
class GetClientsClientResult(dict):
    def __init__(__self__, *,
                 ...
                 allowed_logout_urls: Sequence[builtins.str],
                 allowed_origins: Sequence[builtins.str],
                 app_type: builtins.str,
                 callbacks: Sequence[builtins.str],
                 client_metadata: Mapping[str, builtins.str],
                 client_secret: builtins.str,
                 description: builtins.str,
                 grant_types: Sequence[builtins.str],
                 ...
                 name: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] allowed_clients: List of applications ID's that will be allowed to make delegation request. By default, all applications will be allowed.
        :param Sequence[builtins.str] allowed_logout_urls: URLs that Auth0 may redirect to after logout.
        :param Sequence[builtins.str] allowed_origins: URLs that represent valid origins for cross-origin resource sharing. By default, all your callback URLs will be allowed.
        :param builtins.str app_type: Type of application the client represents. Possible values are: `native`, `spa`, `regular_web`, `non_interactive`, `sso_integration`. Specific SSO integrations types accepted as well are: `rms`, `box`, `cloudbees`, `concur`, `dropbox`, `mscrm`, `echosign`, `egnyte`, `newrelic`, `office365`, `salesforce`, `sentry`, `sharepoint`, `slack`, `springcm`, `zendesk`, `zoom`.
        :param Sequence[builtins.str] callbacks: URLs that Auth0 may call back to after a user authenticates for the client. Make sure to specify the protocol (https://) otherwise the callback may fail in some cases. With the exception of custom URI schemes for native clients, all callbacks should use protocol https://.
        :param Mapping[str, builtins.str] client_metadata: Metadata associated with the client, in the form of an object with string values (max 255 chars). Maximum of 10 metadata properties allowed. Field names (max 255 chars) are alphanumeric and may only include the following special characters: `:,-+=_*?"/\\()<>@ [Tab] [Space]`.
        :param builtins.str description: Description of the purpose of the client.
        :param Sequence[builtins.str] grant_types: Types of grants that this client is authorized to use.
        :param builtins.bool is_first_party: Indicates whether this client is a first-party client.Defaults to true from the API
    ...
    def allowed_logout_urls(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def callbacks(self) -> Sequence[builtins.str]:
        """
    ...
    def client_metadata(self) -> Mapping[str, builtins.str]:
        """
    ...
    def is_first_party(self) -> builtins.bool:
        """
    ...
    def is_token_endpoint_ip_header_trusted(self) -> builtins.bool:
        """
...
class GetConnectionOptionResult(dict):
    def __init__(__self__, *,
                 ...
                 api_enable_users: builtins.bool,
                 app_id: builtins.str,
                 ...
                 digest_algorithm: builtins.str,
                 disable_cache: builtins.bool,
                 disable_self_service_change_password: builtins.bool,
                 disable_sign_out: builtins.bool,
                 disable_signup: builtins.bool,
                 discovery_url: builtins.str,
                 domain: builtins.str,
                 domain_aliases: Sequence[builtins.str],
                 enable_script_context: builtins.bool,
                 enabled_database_customization: builtins.bool,
                 entity_id: builtins.str,
                 fed_metadata_xml: builtins.str,
                 fields_map: builtins.str,
                 forward_request_info: builtins.bool,
                 from_: builtins.str,
                 gateway_authentications: Sequence['outputs.GetConnectionOptionGatewayAuthenticationResult'],
                 gateway_url: builtins.str,
                 global_token_revocation_jwt_iss: builtins.str,
                 global_token_revocation_jwt_sub: builtins.str,
                 icon_url: builtins.str,
                 identity_api: builtins.str,
                 idp_initiateds: Sequence['outputs.GetConnectionOptionIdpInitiatedResult'],
                 import_mode: builtins.bool,
                 ips: Sequence[builtins.str],
                 issuer: builtins.str,
                 jwks_uri: builtins.str,
                 key_id: builtins.str,
                 map_user_id_to_id: builtins.bool,
                 max_groups_to_retrieve: builtins.str,
                 messaging_service_sid: builtins.str,
                 metadata_url: builtins.str,
                 metadata_xml: builtins.str,
                 mfas: Sequence['outputs.GetConnectionOptionMfaResult'],
                 name: builtins.str,
                 non_persistent_attrs: Sequence[builtins.str],
                 ...
                 ping_federate_base_url: builtins.str,
                 pkce_enabled: builtins.bool,
                 ...
                 scopes: Sequence[builtins.str],
                 scripts: Mapping[str, builtins.str],
                 set_user_root_attributes: builtins.str,
                 should_trust_email_verified_connection: builtins.str,
                 sign_in_endpoint: builtins.str,
                 sign_out_endpoint: builtins.str,
                 sign_saml_request: builtins.bool,
                 signature_algorithm: builtins.str,
                 signing_cert: builtins.str,
                 ...
                 type: builtins.str,
                 upstream_params: builtins.str,
                 use_cert_auth: builtins.bool,
                 use_kerberos: builtins.bool,
                 use_wsfed: builtins.bool,
                 user_id_attribute: builtins.str,
                 userinfo_endpoint: builtins.str,
                 validations: Sequence['outputs.GetConnectionOptionValidationResult'],
                 waad_common_endpoint: builtins.bool,
                 waad_protocol: builtins.str):
        """
        :param builtins.str adfs_server: ADFS URL where to fetch the metadata source.
        :param Sequence[builtins.str] allowed_audiences: List of allowed audiences.
        :param builtins.bool api_enable_users: Enable API Access to users.
    ...
    @property
    @pulumi.getter(name="adfsServer")
    def adfs_server(self) -> builtins.str:
        """
        ADFS URL where to fetch the metadata source.
        """
        return pulumi.get(self, "adfs_server")
    ...
    @property
    @pulumi.getter(name="apiEnableUsers")
    def api_enable_users(self) -> builtins.bool:
        """
        Enable API Access to users.
        """
        return pulumi.get(self, "api_enable_users")
    ...
    @property
    @pulumi.getter(name="authParams")
    def auth_params(self) -> Mapping[str, builtins.str]:
        """
        Query string parameters to be included as part of the generated passwordless email link.
        """
        return pulumi.get(self, "auth_params")
    ...
    @property
    @pulumi.getter(name="bruteForceProtection")
    def brute_force_protection(self) -> builtins.bool:
        """
        Indicates whether to enable brute force protection, which will limit the number of signups and failed logins from a suspicious IP address.
        """
        return pulumi.get(self, "brute_force_protection")
    ...
    @property
    @pulumi.getter(name="communityBaseUrl")
    def community_base_url(self) -> builtins.str:
        """
        Salesforce community base URL.
        """
        return pulumi.get(self, "community_base_url")
    ...
    @property
    @pulumi.getter(name="customScripts")
    def custom_scripts(self) -> Mapping[str, builtins.str]:
        """
        A map of scripts used to integrate with a custom database.
        """
        return pulumi.get(self, "custom_scripts")
    ...
    @property
    @pulumi.getter(name="disableCache")
    def disable_cache(self) -> builtins.bool:
        """
        Indicates whether to disable the cache or not.
        """
        return pulumi.get(self, "disable_cache")
    ...
    @property
    @pulumi.getter(name="disableSelfServiceChangePassword")
    def disable_self_service_change_password(self) -> builtins.bool:
        """
        Indicates whether to remove the forgot password link within the New Universal Login.
        """
        return pulumi.get(self, "disable_self_service_change_password")
    ...
    @property
    @pulumi.getter(name="disableSignOut")
    def disable_sign_out(self) -> builtins.bool:
        """
        When enabled, will disable sign out.
        """
        return pulumi.get(self, "disable_sign_out")
    ...
    @property
    @pulumi.getter(name="disableSignup")
    def disable_signup(self) -> builtins.bool:
        """
        Indicates whether to allow user sign-ups to your application.
        """
        return pulumi.get(self, "disable_signup")
    ...
    @property
    @pulumi.getter(name="domainAliases")
    def domain_aliases(self) -> Sequence[builtins.str]:
        """
        List of the domains that can be authenticated using the identity provider. Only needed for Identifier First authentication flows.
        """
        return pulumi.get(self, "domain_aliases")
    ...
    @property
    @pulumi.getter(name="enableScriptContext")
    def enable_script_context(self) -> builtins.bool:
        """
        Set to `true` to inject context into custom DB scripts (warning: cannot be disabled once enabled).
        """
        return pulumi.get(self, "enable_script_context")
    ...
    @property
    @pulumi.getter(name="enabledDatabaseCustomization")
    def enabled_database_customization(self) -> builtins.bool:
        """
        Set to `true` to use a legacy user store.
        """
        return pulumi.get(self, "enabled_database_customization")
    ...
    @property
    @pulumi.getter(name="fedMetadataXml")
    def fed_metadata_xml(self) -> builtins.str:
        """
        Federation Metadata for the ADFS connection.
        """
        return pulumi.get(self, "fed_metadata_xml")
    ...
    @property
    @pulumi.getter(name="fieldsMap")
    def fields_map(self) -> builtins.str:
        """
        If you're configuring a SAML enterprise connection for a non-standard PingFederate Server, you must update the attribute mappings.
        """
        return pulumi.get(self, "fields_map")
    ...
    @property
    @pulumi.getter(name="forwardRequestInfo")
    def forward_request_info(self) -> builtins.bool:
        """
        Specifies whether or not request info should be forwarded to sms gateway.
        """
        return pulumi.get(self, "forward_request_info")
    ...
    @property
    @pulumi.getter(name="globalTokenRevocationJwtIss")
    def global_token_revocation_jwt_iss(self) -> builtins.str:
        """
        Specifies the issuer of the JWT used for global token revocation for the SAML connection.
        """
        return pulumi.get(self, "global_token_revocation_jwt_iss")
    ...
    @property
    @pulumi.getter(name="globalTokenRevocationJwtSub")
    def global_token_revocation_jwt_sub(self) -> builtins.str:
        """
        Specifies the subject of the JWT used for global token revocation for the SAML connection.
        """
        return pulumi.get(self, "global_token_revocation_jwt_sub")
    ...
    @property
    @pulumi.getter(name="identityApi")
    def identity_api(self) -> builtins.str:
        """
        Azure AD Identity API. Available options are: `microsoft-identity-platform-v2.0` or `azure-active-directory-v1.0`.
        """
        return pulumi.get(self, "identity_api")
    ...
    @property
    @pulumi.getter(name="importMode")
    def import_mode(self) -> builtins.bool:
        """
        Indicates whether you have a legacy user store and want to gradually migrate those users to the Auth0 user store.
        """
        return pulumi.get(self, "import_mode")
    ...
    @property
    @pulumi.getter(name="mapUserIdToId")
    def map_user_id_to_id(self) -> builtins.bool:
        """
        By default Auth0 maps `user_id` to `email`. Enabling this setting changes the behavior to map `user_id` to 'id' instead. This can only be defined on a new Google Workspace connection and can not be changed once set.
        """
        return pulumi.get(self, "map_user_id_to_id")
    ...
    @property
    @pulumi.getter(name="maxGroupsToRetrieve")
    def max_groups_to_retrieve(self) -> builtins.str:
        """
        Maximum number of groups to retrieve.
        """
        return pulumi.get(self, "max_groups_to_retrieve")
    ...
    @property
    @pulumi.getter(name="messagingServiceSid")
    def messaging_service_sid(self) -> builtins.str:
        """
        SID for Copilot. Used when SMS Source is Copilot.
        """
        return pulumi.get(self, "messaging_service_sid")
    ...
    @property
    @pulumi.getter(name="metadataXml")
    def metadata_xml(self) -> builtins.str:
        """
        The XML content for the SAML metadata document. Values within the xml will take precedence over other attributes set on the options block.
        """
        return pulumi.get(self, "metadata_xml")
    ...
    @property
    @pulumi.getter(name="nonPersistentAttrs")
    def non_persistent_attrs(self) -> Sequence[builtins.str]:
        """
        If there are user fields that should not be stored in Auth0 databases due to privacy reasons, you can add them to the DenyList here.
        """
        return pulumi.get(self, "non_persistent_attrs")
    ...
    @property
    @pulumi.getter(name="pingFederateBaseUrl")
    def ping_federate_base_url(self) -> builtins.str:
        """
        Ping Federate Server URL.
        """
        return pulumi.get(self, "ping_federate_base_url")
    ...
    @property
    @pulumi.getter(name="pkceEnabled")
    def pkce_enabled(self) -> builtins.bool:
        """
        Enables Proof Key for Code Exchange (PKCE) functionality for OAuth2 connections.
        """
        return pulumi.get(self, "pkce_enabled")
    ...
    @property
    @pulumi.getter
    def precedences(self) -> Sequence[builtins.str]:
        """
        Order of attributes for precedence in identification.Valid values: email, phone_number, username. If Precedence is set, it must contain all values (email, phone_number, username) in specific order
        """
        return pulumi.get(self, "precedences")
    ...
    @property
    @pulumi.getter(name="protocolBinding")
    def protocol_binding(self) -> builtins.str:
        """
        The SAML Response Binding: how the SAML token is received by Auth0 from the IdP.
        """
        return pulumi.get(self, "protocol_binding")
    ...
    @property
    @pulumi.getter(name="requiresUsername")
    def requires_username(self) -> builtins.bool:
        """
        Indicates whether the user is required to provide a username in addition to an email address.
        """
        return pulumi.get(self, "requires_username")
    ...
    @property
    @pulumi.getter
    def scripts(self) -> Mapping[str, builtins.str]:
        """
        A map of scripts used for an OAuth connection. Only accepts a `fetchUserProfile` script.
        """
        return pulumi.get(self, "scripts")
    ...
    @property
    @pulumi.getter(name="setUserRootAttributes")
    def set_user_root_attributes(self) -> builtins.str:
        """
        Determines whether to sync user profile attributes (`name`, `given_name`, `family_name`, `nickname`, `picture`) at each login or only on the first login. Options include: `on_each_login`, `on_first_login`, `never_on_login`. Default value: `on_each_login`.
        """
        return pulumi.get(self, "set_user_root_attributes")
    ...
    @property
    @pulumi.getter(name="shouldTrustEmailVerifiedConnection")
    def should_trust_email_verified_connection(self) -> builtins.str:
        """
        Choose how Auth0 sets the email_verified field in the user profile.
        """
        return pulumi.get(self, "should_trust_email_verified_connection")
    ...
    @property
    @pulumi.getter(name="signInEndpoint")
    def sign_in_endpoint(self) -> builtins.str:
        """
        SAML single login URL for the connection.
        """
        return pulumi.get(self, "sign_in_endpoint")
    ...
    @property
    @pulumi.getter(name="signOutEndpoint")
    def sign_out_endpoint(self) -> builtins.str:
        """
        SAML single logout URL for the connection.
        """
        return pulumi.get(self, "sign_out_endpoint")
    ...
    @property
    @pulumi.getter(name="signSamlRequest")
    def sign_saml_request(self) -> builtins.bool:
        """
        When enabled, the SAML authentication request will be signed.
        """
        return pulumi.get(self, "sign_saml_request")
    ...
    @property
    @pulumi.getter(name="strategyVersion")
    def strategy_version(self) -> builtins.int:
        """
        Version 1 is deprecated, use version 2.
        """
        return pulumi.get(self, "strategy_version")
    ...
    @property
    @pulumi.getter(name="twilioSid")
    def twilio_sid(self) -> builtins.str:
        """
        SID for your Twilio account.
        """
        return pulumi.get(self, "twilio_sid")
    ...
    @property
    @pulumi.getter(name="twilioToken")
    def twilio_token(self) -> builtins.str:
        """
        AuthToken for your Twilio account.
        """
        return pulumi.get(self, "twilio_token")
    ...
    @property
    @pulumi.getter(name="upstreamParams")
    def upstream_params(self) -> builtins.str:
        """
        You can pass provider-specific parameters to an identity provider during authentication. The values can either be static per connection or dynamic per user.
        """
        return pulumi.get(self, "upstream_params")
    ...
    @property
    @pulumi.getter(name="useCertAuth")
    def use_cert_auth(self) -> builtins.bool:
        """
        Indicates whether to use cert auth or not.
        """
        return pulumi.get(self, "use_cert_auth")
    ...
    @property
    @pulumi.getter(name="useKerberos")
    def use_kerberos(self) -> builtins.bool:
        """
        Indicates whether to use Kerberos or not.
        """
        return pulumi.get(self, "use_kerberos")
    ...
    @property
    @pulumi.getter(name="useWsfed")
    def use_wsfed(self) -> builtins.bool:
        """
        Whether to use WS-Fed.
        """
        return pulumi.get(self, "use_wsfed")
    ...
    @property
    @pulumi.getter(name="userIdAttribute")
    def user_id_attribute(self) -> builtins.str:
        """
        Attribute in the token that will be mapped to the user_id property in Auth0.
        """
        return pulumi.get(self, "user_id_attribute")
    ...
    @property
    @pulumi.getter(name="waadCommonEndpoint")
    def waad_common_endpoint(self) -> builtins.bool:
        """
        Indicates whether to use the common endpoint rather than the default endpoint. Typically enabled if you're using this for a multi-tenant application in Azure AD.
        """
        return pulumi.get(self, "waad_common_endpoint")
    ...
    @property
    @pulumi.getter(name="waadProtocol")
    def waad_protocol(self) -> builtins.str:
        """
        Protocol to use.
        """
        return pulumi.get(self, "waad_protocol")
...
class GetConnectionOptionAttributeEmailResult(dict):
    def __init__(__self__, *,
                 ...
                 profile_required: builtins.bool,
    ...
    @property
    @pulumi.getter(name="profileRequired")
    def profile_required(self) -> builtins.bool:
        """
        Defines whether Profile is required
        """
        return pulumi.get(self, "profile_required")
...
class GetConnectionOptionAttributeMapResult(dict):
    ...
    @property
    @pulumi.getter(name="userinfoScope")
    def userinfo_scope(self) -> builtins.str:
        """
        This property defines the scopes that Auth0 sends to the IdP’s UserInfo endpoint when requested.
        """
        return pulumi.get(self, "userinfo_scope")
...
class GetConnectionOptionGatewayAuthenticationResult(dict):
    def __init__(__self__, *,
                 ...
                 method: builtins.str,
                 secret: builtins.str,
                 secret_base64_encoded: builtins.bool,
                 subject: builtins.str):
        """
        :param builtins.str audience: Audience claim for the HS256 token sent to `gateway_url`.
        :param builtins.str method: Authentication method (default is `bearer` token).
    ...
    @property
    @pulumi.getter(name="secretBase64Encoded")
    def secret_base64_encoded(self) -> builtins.bool:
        """
        Specifies whether or not the secret is Base64-encoded.
        """
        return pulumi.get(self, "secret_base64_encoded")
...
class GetConnectionOptionIdpInitiatedResult(dict):
    def __init__(__self__, *,
                 client_authorize_query: builtins.str,
                 client_id: builtins.str,
    ...
    @property
    @pulumi.getter(name="clientAuthorizeQuery")
    def client_authorize_query(self) -> builtins.str:
        return pulumi.get(self, "client_authorize_query")
...
class GetConnectionOptionMfaResult(dict):
    def __init__(__self__, *,
                 active: builtins.bool,
                 return_enroll_settings: builtins.bool):
        """
        :param builtins.bool active: Indicates whether multifactor authentication is enabled for this connection.
        :param builtins.bool return_enroll_settings: Indicates whether multifactor authentication enrollment settings will be returned.
        """
    ...
    @property
    @pulumi.getter(name="returnEnrollSettings")
    def return_enroll_settings(self) -> builtins.bool:
        """
        Indicates whether multifactor authentication enrollment settings will be returned.
        """
        return pulumi.get(self, "return_enroll_settings")
...
class GetConnectionOptionPasskeyOptionResult(dict):
    def __init__(__self__, *,
                 challenge_ui: builtins.str,
                 local_enrollment_enabled: builtins.bool,
                 progressive_enrollment_enabled: builtins.bool):
        """
        :param builtins.str challenge_ui: Controls the UI used to challenge the user for their passkey
        :param builtins.bool local_enrollment_enabled: Enables or disables enrollment prompt for local passkey when user authenticates using a cross-device passkey for the connection
        :param builtins.bool progressive_enrollment_enabled: Enables or disables progressive enrollment of passkeys for the connection
    ...
    @property
    @pulumi.getter(name="challengeUi")
    def challenge_ui(self) -> builtins.str:
        """
        Controls the UI used to challenge the user for their passkey
        """
        return pulumi.get(self, "challenge_ui")
    ...
    @property
    @pulumi.getter(name="localEnrollmentEnabled")
    def local_enrollment_enabled(self) -> builtins.bool:
        """
        Enables or disables enrollment prompt for local passkey when user authenticates using a cross-device passkey for the connection
        """
        return pulumi.get(self, "local_enrollment_enabled")
    ...
    @property
    @pulumi.getter(name="progressiveEnrollmentEnabled")
    def progressive_enrollment_enabled(self) -> builtins.bool:
        """
        Enables or disables progressive enrollment of passkeys for the connection
        """
        return pulumi.get(self, "progressive_enrollment_enabled")
...
class GetConnectionOptionPasswordDictionaryResult(dict):
    def __init__(__self__, *,
                 dictionaries: Sequence[builtins.str],
    ...
    @property
    @pulumi.getter
    def dictionaries(self) -> Sequence[builtins.str]:
        """
        Customized contents of the password dictionary. By default, the password dictionary contains a list of the [10,000 most common passwords](https://github.com/danielmiessler/SecLists/blob/master/Passwords/Common-Credentials/10k-most-common.txt); your customized content is used in addition to the default password dictionary. Matching is not case-sensitive.
        """
        return pulumi.get(self, "dictionaries")
...
class GetConnectionOptionTotpResult(dict):
    ...
    @property
    @pulumi.getter(name="timeStep")
    def time_step(self) -> builtins.int:
        """
        Seconds between allowed generation of new passwords.
        """
        return pulumi.get(self, "time_step")
...
class GetCustomDomainCertificateResult(dict):
    ...
    @property
    @pulumi.getter(name="renewsBefore")
    def renews_before(self) -> builtins.str:
        """
        Specifies the date by which the certificate should be renewed.
        """
        return pulumi.get(self, "renews_before")
...
class GetCustomDomainVerificationResult(dict):
    ...
    @property
    @pulumi.getter(name="lastVerifiedAt")
    def last_verified_at(self) -> builtins.str:
        """
        Indicates the last time the domain was successfully verified.
        """
        return pulumi.get(self, "last_verified_at")
...
class GetOrganizationBrandingResult(dict):
    def __init__(__self__, *,
                 colors: Mapping[str, builtins.str],
                 logo_url: builtins.str):
        """
        :param Mapping[str, builtins.str] colors: Color scheme used to customize the login pages.
        :param builtins.str logo_url: URL of logo to display on login page.
    ...
    @property
    @pulumi.getter
    def colors(self) -> Mapping[str, builtins.str]:
        """
        Color scheme used to customize the login pages.
        """
        return pulumi.get(self, "colors")
...
class GetOrganizationConnectionResult(dict):
    def __init__(__self__, *,
                 assign_membership_on_login: builtins.bool,
                 connection_id: builtins.str,
                 is_signup_enabled: builtins.bool,
                 show_as_button: builtins.bool):
        """
        :param builtins.bool assign_membership_on_login: When `true`, all users that log in with this connection will be automatically granted membership in the organization. When `false`, users must be granted membership in the organization before logging in with this connection.
        :param builtins.str connection_id: The ID of the enabled connection on the organization.
        :param builtins.bool is_signup_enabled: Determines whether organization sign-up should be enabled for this organization connection. Only applicable for database connections. Note: `is_signup_enabled` can only be `true` if `assign_membership_on_login` is `true`.
        :param builtins.bool show_as_button: Determines whether a connection should be displayed on this organization’s login prompt. Only applicable for enterprise connections.
        """
        pulumi.set(__self__, "assign_membership_on_login", assign_membership_on_login)
    ...
    @property
    @pulumi.getter(name="assignMembershipOnLogin")
    def assign_membership_on_login(self) -> builtins.bool:
        """
        When `true`, all users that log in with this connection will be automatically granted membership in the organization. When `false`, users must be granted membership in the organization before logging in with this connection.
        """
        return pulumi.get(self, "assign_membership_on_login")
    ...
    @property
    @pulumi.getter(name="isSignupEnabled")
    def is_signup_enabled(self) -> builtins.bool:
        """
        Determines whether organization sign-up should be enabled for this organization connection. Only applicable for database connections. Note: `is_signup_enabled` can only be `true` if `assign_membership_on_login` is `true`.
        """
        return pulumi.get(self, "is_signup_enabled")
...
class GetPhoneProviderConfigurationResult(dict):
    ...
    @property
    @pulumi.getter(name="defaultFrom")
    def default_from(self) -> builtins.str:
        """
        Default sender subject as "from" when no other value is specified.
        """
        return pulumi.get(self, "default_from")
...
class GetPromptScreenRendererFilterResult(dict):
    def __init__(__self__, *,
                 ...
                 domains: builtins.str,
                 match_type: builtins.str,
                 organizations: builtins.str):
        """
        :param builtins.str clients: An array of clients (applications) identified by id or a metadata key/value pair. Entity Limit: 25.
        :param builtins.str domains: An array of domains identified by id or a metadata key/value pair. Entity Limit: 25.
        :param builtins.str match_type: Type of match to apply. Options: `includes_any`, `excludes_any`.
...
class GetResourceServerScopeResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str description: Description of the permission (scope).
        :param builtins.str name: Name of the permission (scope). Examples include `read:appointments` or `delete:appointments`.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "name", name)
...
class GetRolePermissionResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 resource_server_identifier: builtins.str,
                 resource_server_name: builtins.str):
        """
        :param builtins.str description: Description of the permission.
        :param builtins.str name: Name of the permission (scope) configured on the resource server (API).
        :param builtins.str resource_server_identifier: Unique identifier for the resource server (API).
        :param builtins.str resource_server_name: Name of resource server (API) that the permission is associated with.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "resource_server_identifier", resource_server_identifier)
    ...
    @property
    @pulumi.getter(name="resourceServerName")
    def resource_server_name(self) -> builtins.str:
        """
...
class GetSigningKeysSigningKeyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cert: The public certificate of the signing key.
        :param builtins.bool current: True if the key is the the current key.
        :param builtins.str fingerprint: The cert fingerprint.
        :param builtins.str kid: The key ID of the signing key.
        :param builtins.bool next: True if the key is the the next key.
        :param builtins.str pkcs7: The public certificate of the signing key in PKCS7 format.
        :param builtins.bool previous: True if the key is the the previous key.
        :param builtins.bool revoked: True if the key is revoked.
        :param builtins.str thumbprint: The cert thumbprint.
        """
        pulumi.set(__self__, "cert", cert)
        pulumi.set(__self__, "current", current)
        pulumi.set(__self__, "fingerprint", fingerprint)
...
class GetTenantFlagResult(dict):
    def __init__(__self__, *,
                 ...
                 allow_legacy_ro_grant_types: builtins.bool,
                 allow_legacy_tokeninfo_endpoint: builtins.bool,
                 dashboard_insights_view: builtins.bool,
                 dashboard_log_streams_next: builtins.bool,
                 disable_clickjack_protection_headers: builtins.bool,
                 disable_fields_map_fix: builtins.bool,
                 disable_management_api_sms_obfuscation: builtins.bool,
                 enable_adfs_waad_email_verification: builtins.bool,
                 enable_apis_section: builtins.bool,
                 enable_client_connections: builtins.bool,
                 enable_custom_domain_in_emails: builtins.bool,
                 enable_dynamic_client_registration: builtins.bool,
                 enable_idtoken_api2: builtins.bool,
                 enable_legacy_logs_search_v2: builtins.bool,
                 enable_legacy_profile: builtins.bool,
                 enable_pipeline2: builtins.bool,
                 enable_public_signup_user_exists_error: builtins.bool,
                 enable_sso: builtins.bool,
                 mfa_show_factor_list_on_enrollment: builtins.bool,
                 no_disclose_enterprise_connections: builtins.bool,
                 remove_alg_from_jwks: builtins.bool,
                 require_pushed_authorization_requests: builtins.bool,
                 revoke_refresh_token_grant: builtins.bool,
                 use_scope_descriptions_for_consent: builtins.bool):
        """
        :param builtins.bool allow_legacy_delegation_grant_types: Whether the legacy delegation endpoint will be enabled for your account (true) or not available (false).
        :param builtins.bool allow_legacy_ro_grant_types: Whether the legacy `auth/ro` endpoint (used with resource owner password and passwordless features) will be enabled for your account (true) or not available (false).
        :param builtins.bool allow_legacy_tokeninfo_endpoint: If enabled, customers can use Tokeninfo Endpoint, otherwise they can not use it.
    ...
    @property
    @pulumi.getter(name="allowLegacyDelegationGrantTypes")
    def allow_legacy_delegation_grant_types(self) -> builtins.bool:
        """
        Whether the legacy delegation endpoint will be enabled for your account (true) or not available (false).
        """
        return pulumi.get(self, "allow_legacy_delegation_grant_types")
    ...
    @property
    @pulumi.getter(name="allowLegacyRoGrantTypes")
    def allow_legacy_ro_grant_types(self) -> builtins.bool:
        """
        Whether the legacy `auth/ro` endpoint (used with resource owner password and passwordless features) will be enabled for your account (true) or not available (false).
        """
        return pulumi.get(self, "allow_legacy_ro_grant_types")
    ...
    @property
    @pulumi.getter(name="allowLegacyTokeninfoEndpoint")
    def allow_legacy_tokeninfo_endpoint(self) -> builtins.bool:
        """
        If enabled, customers can use Tokeninfo Endpoint, otherwise they can not use it.
        """
        return pulumi.get(self, "allow_legacy_tokeninfo_endpoint")
    ...
    @property
    @pulumi.getter(name="dashboardInsightsView")
    def dashboard_insights_view(self) -> builtins.bool:
        """
        Enables new insights activity page view.
        """
        return pulumi.get(self, "dashboard_insights_view")
    ...
    @property
    @pulumi.getter(name="dashboardLogStreamsNext")
    def dashboard_log_streams_next(self) -> builtins.bool:
        """
        Enables beta access to log streaming changes.
        """
        return pulumi.get(self, "dashboard_log_streams_next")
    ...
    @property
    @pulumi.getter(name="disableClickjackProtectionHeaders")
    def disable_clickjack_protection_headers(self) -> builtins.bool:
        """
        Indicates whether classic Universal Login prompts include additional security headers to prevent clickjacking.
        """
        return pulumi.get(self, "disable_clickjack_protection_headers")
    ...
    @property
    @pulumi.getter(name="disableFieldsMapFix")
    def disable_fields_map_fix(self) -> builtins.bool:
        """
        Disables SAML fields map fix for bad mappings with repeated attributes.
        """
        return pulumi.get(self, "disable_fields_map_fix")
    ...
    @property
    @pulumi.getter(name="disableManagementApiSmsObfuscation")
    def disable_management_api_sms_obfuscation(self) -> builtins.bool:
        """
        If true, SMS phone numbers will not be obfuscated in Management API GET calls.
        """
        return pulumi.get(self, "disable_management_api_sms_obfuscation")
    ...
    @property
    @pulumi.getter(name="enableAdfsWaadEmailVerification")
    def enable_adfs_waad_email_verification(self) -> builtins.bool:
        """
        If enabled, users will be presented with an email verification prompt during their first login when using Azure AD or ADFS connections.
        """
        return pulumi.get(self, "enable_adfs_waad_email_verification")
    ...
    @property
    @pulumi.getter(name="enableApisSection")
    def enable_apis_section(self) -> builtins.bool:
        """
        Indicates whether the APIs section is enabled for the tenant.
        """
        return pulumi.get(self, "enable_apis_section")
    ...
    @property
    @pulumi.getter(name="enableClientConnections")
    def enable_client_connections(self) -> builtins.bool:
        """
        Indicates whether all current connections should be enabled when a new client is created.
        """
        return pulumi.get(self, "enable_client_connections")
    ...
    @property
    @pulumi.getter(name="enableCustomDomainInEmails")
    def enable_custom_domain_in_emails(self) -> builtins.bool:
        """
        Indicates whether the tenant allows custom domains in emails. Before enabling this flag, you must have a custom domain with status: `ready`.
        """
        return pulumi.get(self, "enable_custom_domain_in_emails")
    ...
    @property
    @pulumi.getter(name="enableDynamicClientRegistration")
    def enable_dynamic_client_registration(self) -> builtins.bool:
        """
        Indicates whether the tenant allows dynamic client registration.
        """
        return pulumi.get(self, "enable_dynamic_client_registration")
    ...
    @property
    @pulumi.getter(name="enableIdtokenApi2")
    def enable_idtoken_api2(self) -> builtins.bool:
        """
        Whether ID tokens can be used to authorize some types of requests to API v2 (true) or not (false).
        """
        return pulumi.get(self, "enable_idtoken_api2")
    ...
    @property
    @pulumi.getter(name="enableLegacyLogsSearchV2")
    def enable_legacy_logs_search_v2(self) -> builtins.bool:
        """
        Indicates whether to use the older v2 legacy logs search.
        """
        return pulumi.get(self, "enable_legacy_logs_search_v2")
    ...
    @property
    @pulumi.getter(name="enableLegacyProfile")
    def enable_legacy_profile(self) -> builtins.bool:
        """
        Whether ID tokens and the userinfo endpoint includes a complete user profile (true) or only OpenID Connect claims (false).
        """
        return pulumi.get(self, "enable_legacy_profile")
    ...
    @property
    @pulumi.getter(name="enablePipeline2")
    def enable_pipeline2(self) -> builtins.bool:
        """
        Indicates whether advanced API Authorization scenarios are enabled.
        """
        return pulumi.get(self, "enable_pipeline2")
    ...
    @property
    @pulumi.getter(name="enablePublicSignupUserExistsError")
    def enable_public_signup_user_exists_error(self) -> builtins.bool:
        """
        Indicates whether the public sign up process shows a `user_exists` error if the user already exists.
        """
        return pulumi.get(self, "enable_public_signup_user_exists_error")
    ...
    @property
    @pulumi.getter(name="mfaShowFactorListOnEnrollment")
    def mfa_show_factor_list_on_enrollment(self) -> builtins.bool:
        """
        Used to allow users to pick which factor to enroll with from the list of available MFA factors.
        """
        return pulumi.get(self, "mfa_show_factor_list_on_enrollment")
    ...
    @property
    @pulumi.getter(name="noDiscloseEnterpriseConnections")
    def no_disclose_enterprise_connections(self) -> builtins.bool:
        """
        Do not Publish Enterprise Connections Information with IdP domains on the lock configuration file.
        """
        return pulumi.get(self, "no_disclose_enterprise_connections")
    ...
    @property
    @pulumi.getter(name="removeAlgFromJwks")
    def remove_alg_from_jwks(self) -> builtins.bool:
        """
        Remove `alg` from jwks(JSON Web Key Sets).
        """
        return pulumi.get(self, "remove_alg_from_jwks")
    ...
    @property
    @pulumi.getter(name="requirePushedAuthorizationRequests")
    def require_pushed_authorization_requests(self) -> builtins.bool:
        """
        This Flag is not supported by the Auth0 Management API and will be removed in the next major release.
        """
        return pulumi.get(self, "require_pushed_authorization_requests")
    ...
    @property
    @pulumi.getter(name="revokeRefreshTokenGrant")
    def revoke_refresh_token_grant(self) -> builtins.bool:
        """
        Delete underlying grant when a refresh token is revoked via the Authentication API.
        """
        return pulumi.get(self, "revoke_refresh_token_grant")
    ...
    @property
    @pulumi.getter(name="useScopeDescriptionsForConsent")
    def use_scope_descriptions_for_consent(self) -> builtins.bool:
        """
        Indicates whether to use scope descriptions for consent.
        """
        return pulumi.get(self, "use_scope_descriptions_for_consent")
...
class GetTenantMtlResult(dict):
    def __init__(__self__, *,
                 disable: builtins.bool,
                 enable_endpoint_aliases: builtins.bool):
        """
        :param builtins.bool disable: Disable mTLS settings.
        :param builtins.bool enable_endpoint_aliases: Enable mTLS endpoint aliases.
        """
    ...
    @property
    @pulumi.getter(name="enableEndpointAliases")
    def enable_endpoint_aliases(self) -> builtins.bool:
        """
        Enable mTLS endpoint aliases.
        """
        return pulumi.get(self, "enable_endpoint_aliases")
