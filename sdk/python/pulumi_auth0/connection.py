...
class ConnectionArgs:
    def __init__(__self__, *,
                 ...
                 is_domain_connection: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] strategy: Type of the connection, which indicates the identity provider.
        :param pulumi.Input[builtins.str] display_name: Name used in login screen.
        :param pulumi.Input[builtins.bool] is_domain_connection: Indicates whether the connection is domain level.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Metadata associated with the connection, in the form of a map of string values (max 255 chars).
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] realms: Defines the realms for which the connection will be used (e.g., email domains). If not specified, the connection name is added as the realm.
        :param pulumi.Input[builtins.bool] show_as_button: Display connection as a button. Only available on enterprise connections.
        """
    ...
    def is_domain_connection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_domain_connection(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Connection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            realms: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            show_as_button: Optional[pulumi.Input[builtins.bool]] = None,
            strategy: Optional[pulumi.Input[builtins.str]] = None) -> 'Connection':
        """
    ...
    @property
    @pulumi.getter(name="isDomainConnection")
    def is_domain_connection(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the connection is domain level.
        """
        return pulumi.get(self, "is_domain_connection")
