...
class ResourceServerArgs:
    ...
    def authorization_policy(self) -> pulumi.Input[Optional['ResourceServerAuthorizationPolicyArgs']]:
        """
    ...
    def authorization_policy(self, value: pulumi.Input[Optional['ResourceServerAuthorizationPolicyArgs']]):
