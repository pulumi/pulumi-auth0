...
class EmailProviderArgs:
    def __init__(__self__, *,
                 ...
                 default_from_address: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] default_from_address: Email address to use as the sender when no other "from" address is specified.
        :param pulumi.Input[builtins.bool] enabled: Indicates whether the email provider is enabled.
        :param pulumi.Input[builtins.str] name: Name of the email provider. Options include `azure_cs`, `custom`, `mailgun`, `mandrill`, `ms365`, `sendgrid`, `ses`, `smtp` and `sparkpost`.
    ...
    def default_from_address(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def default_from_address(self, value: pulumi.Input[builtins.str]):
...
class _EmailProviderState:
    def __init__(__self__, *,
                 ...
                 default_from_address: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 settings: Optional[pulumi.Input['EmailProviderSettingsArgs']] = None):
        """
    ...
    @property
    @pulumi.getter(name="defaultFromAddress")
    def default_from_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Email address to use as the sender when no other "from" address is specified.
        """
        return pulumi.get(self, "default_from_address")
    ...
    @default_from_address.setter
    def default_from_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_from_address", value)
...
class EmailProvider(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultFromAddress")
    def default_from_address(self) -> pulumi.Output[builtins.str]:
        """
        Email address to use as the sender when no other "from" address is specified.
        """
        return pulumi.get(self, "default_from_address")
