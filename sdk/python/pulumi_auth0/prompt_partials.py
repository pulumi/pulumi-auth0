...
class PromptPartialsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] prompt: The prompt that you are adding partials for. Options are: `login-id`, `login`, `login-password`, `signup`, `signup-id`, `signup-password`, `login-passwordless`, `customized-consent`, `passkeys`, `confirmation`.
