...
class OrganizationMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] organization_id: The ID of the organization to assign the member to.
        :param pulumi.Input[builtins.str] user_id: ID of the user to add as an organization member.
        """
...
@pulumi.type_token("auth0:index/organizationMember:OrganizationMember")
class OrganizationMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            organization_id: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationMember':
        """
