...
class GetUserResult:
    ...
    def app_metadata(self) -> _builtins.str:
        """
    ...
    def phone_verified(self) -> _builtins.bool:
        """
...
def get_user(query: Optional[_builtins.str] = None,
...
def get_user_output(query: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
